...
func (o *WirelessLink) GetAuthType() CableStatus {
...
// and a boolean to check if the value has been set.
func (o *WirelessLink) GetAuthTypeOk() (*CableStatus, bool) {
	if o == nil || IsNil(o.AuthType) {
		return nil, false
	}
...
func (o *WirelessLink) SetAuthType(v CableStatus) {
	o.AuthType = &v
}

// GetAuthCipher returns the AuthCipher field value if set, zero value otherwise.
func (o *WirelessLink) GetAuthCipher() CableStatus {
...
// and a boolean to check if the value has been set.
func (o *WirelessLink) GetAuthCipherOk() (*CableStatus, bool) {
	if o == nil || IsNil(o.AuthCipher) {
		return nil, false
	}
...
func (o *WirelessLink) SetAuthCipher(v CableStatus) {
	o.AuthCipher = &v
}
