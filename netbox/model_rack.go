...
type Rack struct {
	...
	Width    *CableStatus            `json:"width,omitempty"`
	...
	OuterUnit  NullableCableLengthUnit `json:"outer_unit,omitempty"`
...
func (o *Rack) SetStatus(v CableStatus) {
	o.Status = &v
}
...
// SetWidth gets a reference to the given CableStatus and assigns it to the Width field.
...
// SetOuterUnit gets a reference to the given NullableCableLengthUnit and assigns it to the OuterUnit field.
