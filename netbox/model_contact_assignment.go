...
type ContactAssignment struct {
	...
	Priority    *CableStatus              `json:"priority,omitempty"`
...
// SetPriority gets a reference to the given CableStatus and assigns it to the Priority field.
func (o *ContactAssignment) SetPriority(v CableStatus) {
	o.Priority = &v
}
