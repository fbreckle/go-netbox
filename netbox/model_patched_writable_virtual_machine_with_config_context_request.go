...
func (o *PatchedWritableVirtualMachineWithConfigContextRequest) GetLocalContextData() map[string]interface{} {
	if o == nil {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *PatchedWritableVirtualMachineWithConfigContextRequest) GetLocalContextDataOk() (map[string]interface{}, bool) {
...
func (o *PatchedWritableVirtualMachineWithConfigContextRequest) SetLocalContextData(v map[string]interface{}) {
