...
type InterfaceRequest struct {
	...
	RfChannel NullableString `json:"rf_channel,omitempty"`
	// * `pd` - PD * `pse` - PSE
...
func (o *InterfaceRequest) SetModeNil() {
	o.Mode.Set(nil)
}
...
func (o *InterfaceRequest) SetRfRoleNil() {
	o.RfRole.Set(nil)
}
...
// SetRfChannel gets a reference to the given NullableString and assigns it to the RfChannel field.
func (o *InterfaceRequest) SetRfChannel(v string) {
	o.RfChannel.Set(&v)
}

// SetRfChannelNil sets the value for RfChannel to be an explicit nil
func (o *InterfaceRequest) SetRfChannelNil() {
	o.RfChannel.Set(nil)
}
...
func (o *InterfaceRequest) SetPoeModeNil() {
	o.PoeMode.Set(nil)
}
...
func (o *InterfaceRequest) SetPoeTypeNil() {
	o.PoeType.Set(nil)
}
