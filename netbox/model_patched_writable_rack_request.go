...
func (o *PatchedWritableRackRequest) GetType() string {
...
// and a boolean to check if the value has been set.
func (o *PatchedWritableRackRequest) GetTypeOk() (*string, bool) {
	if o == nil || IsNil(o.Type) {
		return nil, false
	}
	return o.Type, true
...
func (o *PatchedWritableRackRequest) SetType(v string) {
	o.Type = &v
}
...
func (o *PatchedWritableRackRequest) SetWeightUnit(v string) {
	o.WeightUnit = &v
}
...
// and a boolean to check if the value has been set.
func (o *PatchedWritableRackRequest) GetOuterUnitOk() (*string, bool) {
	if o == nil || IsNil(o.OuterUnit) {
		return nil, false
	}
