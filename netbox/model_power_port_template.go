...
func (o *PowerPortTemplate) GetType() CableLengthUnit {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *PowerPortTemplate) GetTypeOk() (*CableLengthUnit, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *PowerPortTemplate) SetType(v CableLengthUnit) {
	o.Type.Set(&v)
}
