...
func (r ApiExtrasConfigTemplatesListRequest) DescriptionEmpty(descriptionEmpty []string) ApiExtrasConfigTemplatesListRequest {
...
func (r ApiExtrasConfigTemplatesListRequest) NameEmpty(nameEmpty []string) ApiExtrasConfigTemplatesListRequest {
	r.nameEmpty = &nameEmpty
	return r
}
...
func (r ApiExtrasCustomFieldsListRequest) DescriptionEmpty(descriptionEmpty []string) ApiExtrasCustomFieldsListRequest {
	r.descriptionEmpty = &descriptionEmpty
	return r
}
...
func (r ApiExtrasCustomFieldsListRequest) GroupNameEmpty(groupNameEmpty []string) ApiExtrasCustomFieldsListRequest {
...
func (r ApiExtrasCustomFieldsListRequest) NameEmpty(nameEmpty []string) ApiExtrasCustomFieldsListRequest {
	r.nameEmpty = &nameEmpty
	return r
}
...
func (r ApiExtrasCustomFieldsListRequest) UiVisibility(uiVisibility string) ApiExtrasCustomFieldsListRequest {
	r.uiVisibility = &uiVisibility
	return r
}

// Specifies the visibility of custom field in the UI
func (r ApiExtrasCustomFieldsListRequest) UiVisibilityN(uiVisibilityN string) ApiExtrasCustomFieldsListRequest {
	r.uiVisibilityN = &uiVisibilityN
	return r
}
...
func (a *ExtrasApiService) ExtrasCustomFieldsListExecute(r ApiExtrasCustomFieldsListRequest) (*PaginatedCustomFieldList, *http.Response, error) {
	...
	if r.groupNameEmpty != nil {
		...
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "group_name__empty", s.Index(i), "multi")
			}
		} else {
			parameterAddToHeaderOrQuery(localVarQueryParams, "group_name__empty", t, "multi")
		}
	}
	...
	if r.uiVisibility != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "ui_visibility", r.uiVisibility, "")
	}
	if r.uiVisibilityN != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "ui_visibility__n", r.uiVisibilityN, "")
	}
	if r.weight != nil {
		t := *r.weight
		if reflect.TypeOf(t).Kind() == reflect.Slice {
...
func (r ApiExtrasExportTemplatesListRequest) DescriptionEmpty(descriptionEmpty []string) ApiExtrasExportTemplatesListRequest {
	r.descriptionEmpty = &descriptionEmpty
	return r
}
...
func (a *ExtrasApiService) ExtrasObjectChangesListExecute(r ApiExtrasObjectChangesListRequest) (*PaginatedObjectChangeList, *http.Response, error) {
	...
	if r.objectReprEmpty != nil {
		...
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "object_repr__empty", s.Index(i), "multi")
			}
		} else {
			parameterAddToHeaderOrQuery(localVarQueryParams, "object_repr__empty", t, "multi")
		}
	}
	...
	if r.userNameEmpty != nil {
		...
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "user_name__empty", s.Index(i), "multi")
			}
		} else {
			parameterAddToHeaderOrQuery(localVarQueryParams, "user_name__empty", t, "multi")
		}
	}
	if r.userNameIc != nil {
		t := *r.userNameIc
...
func (r ApiExtrasSavedFiltersListRequest) DescriptionEmpty(descriptionEmpty []string) ApiExtrasSavedFiltersListRequest {
	r.descriptionEmpty = &descriptionEmpty
	return r
}
...
func (r ApiExtrasSavedFiltersListRequest) NameEmpty(nameEmpty []string) ApiExtrasSavedFiltersListRequest {
	r.nameEmpty = &nameEmpty
	return r
}
...
func (r ApiExtrasSavedFiltersListRequest) SlugEmpty(slugEmpty []string) ApiExtrasSavedFiltersListRequest {
...
func (r ApiExtrasTagsListRequest) DescriptionEmpty(descriptionEmpty []string) ApiExtrasTagsListRequest {
	r.descriptionEmpty = &descriptionEmpty
	return r
}
...
func (a *ExtrasApiService) ExtrasTagsListExecute(r ApiExtrasTagsListRequest) (*PaginatedTagList, *http.Response, error) {
	...
	if r.colorEmpty != nil {
		...
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "color__empty", s.Index(i), "multi")
			}
		} else {
			parameterAddToHeaderOrQuery(localVarQueryParams, "color__empty", t, "multi")
		}
	}
	if r.colorIc != nil {
		t := *r.colorIc
...
func (r ApiExtrasWebhooksListRequest) ContentTypeId(contentTypeId []int32) ApiExtrasWebhooksListRequest {
	r.contentTypeId = &contentTypeId
	return r
}

func (r ApiExtrasWebhooksListRequest) ContentTypeIdGt(contentTypeIdGt []int32) ApiExtrasWebhooksListRequest {
	r.contentTypeIdGt = &contentTypeIdGt
	return r
}

func (r ApiExtrasWebhooksListRequest) ContentTypeIdGte(contentTypeIdGte []int32) ApiExtrasWebhooksListRequest {
	r.contentTypeIdGte = &contentTypeIdGte
	return r
}

func (r ApiExtrasWebhooksListRequest) ContentTypeIdLt(contentTypeIdLt []int32) ApiExtrasWebhooksListRequest {
	r.contentTypeIdLt = &contentTypeIdLt
	return r
}

func (r ApiExtrasWebhooksListRequest) ContentTypeIdLte(contentTypeIdLte []int32) ApiExtrasWebhooksListRequest {
	r.contentTypeIdLte = &contentTypeIdLte
	return r
}

func (r ApiExtrasWebhooksListRequest) ContentTypeIdN(contentTypeIdN []int32) ApiExtrasWebhooksListRequest {
	r.contentTypeIdN = &contentTypeIdN
	return r
}
...
func (r ApiExtrasWebhooksListRequest) TypeJobEnd(typeJobEnd bool) ApiExtrasWebhooksListRequest {
	r.typeJobEnd = &typeJobEnd
	return r
}

func (r ApiExtrasWebhooksListRequest) TypeJobStart(typeJobStart bool) ApiExtrasWebhooksListRequest {
...
func (a *ExtrasApiService) ExtrasWebhooksListExecute(r ApiExtrasWebhooksListRequest) (*PaginatedWebhookList, *http.Response, error) {
	...
	if r.caFilePathEmpty != nil {
		...
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "ca_file_path__empty", s.Index(i), "multi")
			}
		} else {
			parameterAddToHeaderOrQuery(localVarQueryParams, "ca_file_path__empty", t, "multi")
		}
	}
	...
	if r.httpContentTypeEmpty != nil {
		t := *r.httpContentTypeEmpty
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "http_content_type__empty", s.Index(i), "multi")
			}
		} else {
			parameterAddToHeaderOrQuery(localVarQueryParams, "http_content_type__empty", t, "multi")
		}
	}
	...
	if r.payloadUrlEmpty != nil {
		...
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "payload_url__empty", s.Index(i), "multi")
			}
		} else {
			parameterAddToHeaderOrQuery(localVarQueryParams, "payload_url__empty", t, "multi")
		}
	}
	...
	if r.secretEmpty != nil {
		...
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "secret__empty", s.Index(i), "multi")
			}
		} else {
			parameterAddToHeaderOrQuery(localVarQueryParams, "secret__empty", t, "multi")
		}
	}
	if r.secretIc != nil {
		t := *r.secretIc
