...
func (o *ConsoleServerPortTemplate) GetType() CableStatus {
...
// and a boolean to check if the value has been set.
func (o *ConsoleServerPortTemplate) GetTypeOk() (*CableStatus, bool) {
	if o == nil || IsNil(o.Type) {
		return nil, false
	}
	return o.Type, true
...
func (o *ConsoleServerPortTemplate) SetType(v CableStatus) {
	o.Type = &v
}
