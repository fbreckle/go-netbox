...
type IPAddress struct {
	...
	Role               *CableStatus            `json:"role,omitempty"`
...
func (o *IPAddress) GetStatus() CableStatus {
...
// and a boolean to check if the value has been set.
func (o *IPAddress) GetStatusOk() (*CableStatus, bool) {
	if o == nil || IsNil(o.Status) {
		return nil, false
	}
...
func (o *IPAddress) SetStatus(v CableStatus) {
	o.Status = &v
}

// GetRole returns the Role field value if set, zero value otherwise.
func (o *IPAddress) GetRole() CableStatus {
...
// and a boolean to check if the value has been set.
func (o *IPAddress) GetRoleOk() (*CableStatus, bool) {
	if o == nil || IsNil(o.Role) {
		return nil, false
	}
	return o.Role, true
...
// SetRole gets a reference to the given CableStatus and assigns it to the Role field.
func (o *IPAddress) SetRole(v CableStatus) {
	o.Role = &v
}
