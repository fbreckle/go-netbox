...
func (r ApiWirelessWirelessLanGroupsListRequest) DescriptionEmpty(descriptionEmpty []string) ApiWirelessWirelessLanGroupsListRequest {
...
func (r ApiWirelessWirelessLanGroupsListRequest) NameEmpty(nameEmpty []string) ApiWirelessWirelessLanGroupsListRequest {
...
func (r ApiWirelessWirelessLanGroupsListRequest) SlugEmpty(slugEmpty []string) ApiWirelessWirelessLanGroupsListRequest {
...
func (r ApiWirelessWirelessLansListRequest) AuthPskEmpty(authPskEmpty []string) ApiWirelessWirelessLansListRequest {
...
func (r ApiWirelessWirelessLansListRequest) DescriptionEmpty(descriptionEmpty []string) ApiWirelessWirelessLansListRequest {
	r.descriptionEmpty = &descriptionEmpty
	return r
}
...
func (r ApiWirelessWirelessLansListRequest) SsidEmpty(ssidEmpty []string) ApiWirelessWirelessLansListRequest {
...
func (a *WirelessApiService) WirelessWirelessLansListExecute(r ApiWirelessWirelessLansListRequest) (*PaginatedWirelessLANList, *http.Response, error) {
	...
	if r.authCipher != nil {
		...
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "auth_cipher", s.Index(i), "multi")
			}
		} else {
	...
	if r.authCipherN != nil {
		...
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "auth_cipher__n", s.Index(i), "multi")
			}
		} else {
	...
	if r.authPsk != nil {
		...
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "auth_psk", s.Index(i), "multi")
			}
		} else {
	...
	if r.authPskEmpty != nil {
		...
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "auth_psk__empty", s.Index(i), "multi")
			}
		} else {
			parameterAddToHeaderOrQuery(localVarQueryParams, "auth_psk__empty", t, "multi")
		}
	}
	if r.authPskIc != nil {
		t := *r.authPskIc
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "auth_psk__ic", s.Index(i), "multi")
			}
		} else {
	...
	if r.authPskIe != nil {
		...
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "auth_psk__ie", s.Index(i), "multi")
			}
		} else {
	...
	if r.authPskIew != nil {
		...
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "auth_psk__iew", s.Index(i), "multi")
			}
		} else {
	...
	if r.authPskIsw != nil {
		...
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "auth_psk__isw", s.Index(i), "multi")
			}
		} else {
	...
	if r.authPskN != nil {
		...
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "auth_psk__n", s.Index(i), "multi")
			}
		} else {
	...
	if r.authPskNic != nil {
		...
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "auth_psk__nic", s.Index(i), "multi")
			}
		} else {
	...
	if r.authPskNie != nil {
		...
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "auth_psk__nie", s.Index(i), "multi")
			}
		} else {
	...
	if r.authPskNiew != nil {
		...
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "auth_psk__niew", s.Index(i), "multi")
			}
		} else {
	...
	if r.authPskNisw != nil {
		...
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "auth_psk__nisw", s.Index(i), "multi")
			}
		} else {
	...
	if r.ssid != nil {
		...
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "ssid", s.Index(i), "multi")
			}
		} else {
	...
	if r.ssidEmpty != nil {
		...
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "ssid__empty", s.Index(i), "multi")
			}
		} else {
			parameterAddToHeaderOrQuery(localVarQueryParams, "ssid__empty", t, "multi")
		}
	}
	if r.ssidIc != nil {
		t := *r.ssidIc
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "ssid__ic", s.Index(i), "multi")
			}
		} else {
	...
	if r.ssidIe != nil {
		...
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "ssid__ie", s.Index(i), "multi")
			}
		} else {
	...
	if r.ssidIew != nil {
		...
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "ssid__iew", s.Index(i), "multi")
			}
		} else {
	...
	if r.ssidIsw != nil {
		...
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "ssid__isw", s.Index(i), "multi")
			}
		} else {
	...
	if r.ssidN != nil {
		...
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "ssid__n", s.Index(i), "multi")
			}
		} else {
	...
	if r.ssidNic != nil {
		...
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "ssid__nic", s.Index(i), "multi")
			}
		} else {
	...
	if r.ssidNie != nil {
		...
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "ssid__nie", s.Index(i), "multi")
			}
		} else {
	...
	if r.ssidNiew != nil {
		...
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "ssid__niew", s.Index(i), "multi")
			}
		} else {
	...
	if r.ssidNisw != nil {
		...
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "ssid__nisw", s.Index(i), "multi")
			}
		} else {
...
func (r ApiWirelessWirelessLinksListRequest) AuthPskEmpty(authPskEmpty []string) ApiWirelessWirelessLinksListRequest {
	r.authPskEmpty = &authPskEmpty
	return r
}
...
func (r ApiWirelessWirelessLinksListRequest) DescriptionEmpty(descriptionEmpty []string) ApiWirelessWirelessLinksListRequest {
	r.descriptionEmpty = &descriptionEmpty
	return r
}
...
func (r ApiWirelessWirelessLinksListRequest) SsidEmpty(ssidEmpty []string) ApiWirelessWirelessLinksListRequest {
	r.ssidEmpty = &ssidEmpty
	return r
}
...
func (a *WirelessApiService) WirelessWirelessLinksListExecute(r ApiWirelessWirelessLinksListRequest) (*PaginatedWirelessLinkList, *http.Response, error) {
	...
	if r.interfaceAId != nil {
		...
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "interface_a_id", s.Index(i), "multi")
			}
		} else {
	...
	if r.interfaceAIdGt != nil {
		...
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "interface_a_id__gt", s.Index(i), "multi")
			}
		} else {
	...
	if r.interfaceAIdGte != nil {
		...
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "interface_a_id__gte", s.Index(i), "multi")
			}
		} else {
	...
	if r.interfaceAIdLt != nil {
		...
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "interface_a_id__lt", s.Index(i), "multi")
			}
		} else {
	...
	if r.interfaceAIdLte != nil {
		...
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "interface_a_id__lte", s.Index(i), "multi")
			}
		} else {
	...
	if r.interfaceAIdN != nil {
		...
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "interface_a_id__n", s.Index(i), "multi")
			}
		} else {
	...
	if r.interfaceBId != nil {
		...
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "interface_b_id", s.Index(i), "multi")
			}
		} else {
	...
	if r.interfaceBIdGt != nil {
		...
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "interface_b_id__gt", s.Index(i), "multi")
			}
		} else {
	...
	if r.interfaceBIdGte != nil {
		...
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "interface_b_id__gte", s.Index(i), "multi")
			}
		} else {
	...
	if r.interfaceBIdLt != nil {
		...
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "interface_b_id__lt", s.Index(i), "multi")
			}
		} else {
	...
	if r.interfaceBIdLte != nil {
		...
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "interface_b_id__lte", s.Index(i), "multi")
			}
		} else {
	...
	if r.interfaceBIdN != nil {
		...
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "interface_b_id__n", s.Index(i), "multi")
			}
		} else {
