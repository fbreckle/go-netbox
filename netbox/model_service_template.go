...
type ServiceTemplate struct {
	...
	Protocol     *CableStatus           `json:"protocol,omitempty"`
...
func (o *ServiceTemplate) GetProtocol() CableStatus {
...
// and a boolean to check if the value has been set.
func (o *ServiceTemplate) GetProtocolOk() (*CableStatus, bool) {
	if o == nil || IsNil(o.Protocol) {
		return nil, false
	}
...
// SetProtocol gets a reference to the given CableStatus and assigns it to the Protocol field.
func (o *ServiceTemplate) SetProtocol(v CableStatus) {
	o.Protocol = &v
}
