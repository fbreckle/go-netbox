...
func (o *ConsolePort) GetType() CableStatus {
...
// and a boolean to check if the value has been set.
func (o *ConsolePort) GetTypeOk() (*CableStatus, bool) {
	if o == nil || IsNil(o.Type) {
		return nil, false
	}
	return o.Type, true
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *ConsolePort) GetSpeedOk() (*CableLengthUnit, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ConsolePort) SetSpeed(v CableLengthUnit) {
	o.Speed.Set(&v)
}
