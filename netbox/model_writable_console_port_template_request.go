...
func (o *WritableConsolePortTemplateRequest) GetType() string {
...
// and a boolean to check if the value has been set.
func (o *WritableConsolePortTemplateRequest) GetTypeOk() (*string, bool) {
	if o == nil || IsNil(o.Type) {
		return nil, false
	}
	return o.Type, true
...
func (o *WritableConsolePortTemplateRequest) SetType(v string) {
	o.Type = &v
}
