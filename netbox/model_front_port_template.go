...
func NewFrontPortTemplate(id int32, url string, display string, name string, type_ CableStatus, rearPort NestedRearPortTemplate, created NullableTime, lastUpdated NullableTime) *FrontPortTemplate {
...
func (o *FrontPortTemplate) GetType() CableStatus {
	if o == nil {
		var ret CableStatus
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *FrontPortTemplate) GetTypeOk() (*CableStatus, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Type, true
...
func (o *FrontPortTemplate) SetType(v CableStatus) {
	o.Type = v
}
