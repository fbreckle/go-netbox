...
func (m *WritableRackGroup) validateTags(formats strfmt.Registry) error {
...
func (m *WritableRackGroup) contextValidateTags(ctx context.Context, formats strfmt.Registry) error {
