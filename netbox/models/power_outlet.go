...
type PowerOutlet struct {
	...
	// power port
	PowerPort *BriefPowerPort `json:"power_port,omitempty"`
...
var powerOutletTypeCableEndPropEnum []any
...
func init() {
	...
	for _, v := range res {
		powerOutletTypeCableEndPropEnum = append(powerOutletTypeCableEndPropEnum, v)
	}
}

const (

	// PowerOutletCableEndA captures enum value "A"
	PowerOutletCableEndA string = "A"

	// PowerOutletCableEndB captures enum value "B"
	PowerOutletCableEndB string = "B"
)

// prop value enum
func (m *PowerOutlet) validateCableEndEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, powerOutletTypeCableEndPropEnum, true); err != nil {
		return err
	}
	return nil
}
...
func (m *PowerOutlet) validateColor(formats strfmt.Registry) error {
...
func (m *PowerOutlet) validateDisplayURL(formats strfmt.Registry) error {
...
func (m *PowerOutlet) validateOwner(formats strfmt.Registry) error {
...
func (m *PowerOutlet) validateStatus(formats strfmt.Registry) error {
...
func (m *PowerOutlet) contextValidateDisplayURL(ctx context.Context, formats strfmt.Registry) error {
...
func (m *PowerOutlet) contextValidateOwner(ctx context.Context, formats strfmt.Registry) error {
...
func (m *PowerOutlet) contextValidateStatus(ctx context.Context, formats strfmt.Registry) error {
...
// PowerOutletFeedLeg power outlet feed leg
//
...
var powerOutletFeedLegTypeLabelPropEnum []any
...
var powerOutletFeedLegTypeValuePropEnum []any
...
const (
	...
	// PowerOutletFeedLegValueEmpty captures enum value ""
	PowerOutletFeedLegValueEmpty string = ""
)
...
func (m *PowerOutletFeedLeg) ContextValidate(_ context.Context, _ strfmt.Registry) error {
	return nil
}
...
// PowerOutletStatus power outlet status
//
// swagger:model PowerOutletStatus
...
// Validate validates this power outlet status
func (m *PowerOutletStatus) Validate(formats strfmt.Registry) error {
	var res []error
...
var powerOutletStatusTypeLabelPropEnum []any
...
func init() {
	...
	for _, v := range res {
		powerOutletStatusTypeLabelPropEnum = append(powerOutletStatusTypeLabelPropEnum, v)
	}
}

const (

	// PowerOutletStatusLabelEnabled captures enum value "Enabled"
	PowerOutletStatusLabelEnabled string = "Enabled"

	// PowerOutletStatusLabelDisabled captures enum value "Disabled"
	PowerOutletStatusLabelDisabled string = "Disabled"

	// PowerOutletStatusLabelFaulty captures enum value "Faulty"
	PowerOutletStatusLabelFaulty string = "Faulty"
)

// prop value enum
func (m *PowerOutletStatus) validateLabelEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, powerOutletStatusTypeLabelPropEnum, true); err != nil {
		return err
	}
	return nil
}

func (m *PowerOutletStatus) validateLabel(formats strfmt.Registry) error {
	if typeutils.IsZero(m.Label) { // not required
		return nil
	}
...
var powerOutletStatusTypeValuePropEnum []any
...
func init() {
	...
	for _, v := range res {
		powerOutletStatusTypeValuePropEnum = append(powerOutletStatusTypeValuePropEnum, v)
	}
}

const (

	// PowerOutletStatusValueEnabled captures enum value "enabled"
	PowerOutletStatusValueEnabled string = "enabled"

	// PowerOutletStatusValueDisabled captures enum value "disabled"
	PowerOutletStatusValueDisabled string = "disabled"

	// PowerOutletStatusValueFaulty captures enum value "faulty"
	PowerOutletStatusValueFaulty string = "faulty"
)

// prop value enum
func (m *PowerOutletStatus) validateValueEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, powerOutletStatusTypeValuePropEnum, true); err != nil {
		return err
	}
	return nil
}

func (m *PowerOutletStatus) validateValue(formats strfmt.Registry) error {
	if typeutils.IsZero(m.Value) { // not required
		return nil
	}
...
// ContextValidate validates this power outlet status based on context it is used
func (m *PowerOutletStatus) ContextValidate(_ context.Context, _ strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *PowerOutletStatus) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
	return jsonutils.WriteJSON(m)
...
// UnmarshalBinary interface implementation
func (m *PowerOutletStatus) UnmarshalBinary(b []byte) error {
	var res PowerOutletStatus
	if err := jsonutils.ReadJSON(b, &res); err != nil {
		return err
	}
	*m = res
...
// PowerOutletType power outlet type
//
...
var powerOutletTypeTypeLabelPropEnum []any
...
const (
	...
	// PowerOutletTypeLabelC17 captures enum value "C17"
	PowerOutletTypeLabelC17 string = "C17"
	...
	// PowerOutletTypeLabelIEC60906Dash1 captures enum value "IEC 60906-1"
	PowerOutletTypeLabelIEC60906Dash1 string = "IEC 60906-1"

	// PowerOutletTypeLabelNr2PPlusT10ANBR14136 captures enum value "2P+T 10A (NBR 14136)"
	PowerOutletTypeLabelNr2PPlusT10ANBR14136 string = "2P+T 10A (NBR 14136)"

	// PowerOutletTypeLabelNr2PPlusT20ANBR14136 captures enum value "2P+T 20A (NBR 14136)"
	PowerOutletTypeLabelNr2PPlusT20ANBR14136 string = "2P+T 20A (NBR 14136)"
	...
	// PowerOutletTypeLabelNEMAL22Dash20R captures enum value "NEMA L22-20R"
	PowerOutletTypeLabelNEMAL22Dash20R string = "NEMA L22-20R"
	...
	// PowerOutletTypeLabelITATypeECEE7Slash5 captures enum value "ITA Type E (CEE 7/5)"
	PowerOutletTypeLabelITATypeECEE7Slash5 string = "ITA Type E (CEE 7/5)"

	// PowerOutletTypeLabelITATypeFCEE7Slash3 captures enum value "ITA Type F (CEE 7/3)"
	PowerOutletTypeLabelITATypeFCEE7Slash3 string = "ITA Type F (CEE 7/3)"
	...
	// PowerOutletTypeLabelMolexMicroDashFit1x2 captures enum value "Molex Micro-Fit 1x2"
	PowerOutletTypeLabelMolexMicroDashFit1x2 string = "Molex Micro-Fit 1x2"

	// PowerOutletTypeLabelMolexMicroDashFit2x2 captures enum value "Molex Micro-Fit 2x2"
	PowerOutletTypeLabelMolexMicroDashFit2x2 string = "Molex Micro-Fit 2x2"

	// PowerOutletTypeLabelMolexMicroDashFit2x3 captures enum value "Molex Micro-Fit 2x3"
	PowerOutletTypeLabelMolexMicroDashFit2x3 string = "Molex Micro-Fit 2x3"

	// PowerOutletTypeLabelMolexMicroDashFit2x4 captures enum value "Molex Micro-Fit 2x4"
	PowerOutletTypeLabelMolexMicroDashFit2x4 string = "Molex Micro-Fit 2x4"

	// PowerOutletTypeLabelDCTerminal captures enum value "DC Terminal"
	PowerOutletTypeLabelDCTerminal string = "DC Terminal"

	// PowerOutletTypeLabelEatonC39 captures enum value "Eaton C39"
	PowerOutletTypeLabelEatonC39 string = "Eaton C39"
...
var powerOutletTypeTypeValuePropEnum []any
...
const (
	...
	// PowerOutletTypeValueIecDash60320DashC17 captures enum value "iec-60320-c17"
	PowerOutletTypeValueIecDash60320DashC17 string = "iec-60320-c17"
	...
	// PowerOutletTypeValueIecDash60906Dash1 captures enum value "iec-60906-1"
	PowerOutletTypeValueIecDash60906Dash1 string = "iec-60906-1"

	// PowerOutletTypeValueNbrDash14136Dash10a captures enum value "nbr-14136-10a"
	PowerOutletTypeValueNbrDash14136Dash10a string = "nbr-14136-10a"

	// PowerOutletTypeValueNbrDash14136Dash20a captures enum value "nbr-14136-20a"
	PowerOutletTypeValueNbrDash14136Dash20a string = "nbr-14136-20a"
	...
	// PowerOutletTypeValueNemaDashL22Dash20r captures enum value "nema-l22-20r"
	PowerOutletTypeValueNemaDashL22Dash20r string = "nema-l22-20r"
	...
	// PowerOutletTypeValueMolexDashMicroDashFitDash1x2 captures enum value "molex-micro-fit-1x2"
	PowerOutletTypeValueMolexDashMicroDashFitDash1x2 string = "molex-micro-fit-1x2"

	// PowerOutletTypeValueMolexDashMicroDashFitDash2x2 captures enum value "molex-micro-fit-2x2"
	PowerOutletTypeValueMolexDashMicroDashFitDash2x2 string = "molex-micro-fit-2x2"

	// PowerOutletTypeValueMolexDashMicroDashFitDash2x3 captures enum value "molex-micro-fit-2x3"
	PowerOutletTypeValueMolexDashMicroDashFitDash2x3 string = "molex-micro-fit-2x3"

	// PowerOutletTypeValueMolexDashMicroDashFitDash2x4 captures enum value "molex-micro-fit-2x4"
	PowerOutletTypeValueMolexDashMicroDashFitDash2x4 string = "molex-micro-fit-2x4"

	// PowerOutletTypeValueDcDashTerminal captures enum value "dc-terminal"
	PowerOutletTypeValueDcDashTerminal string = "dc-terminal"

	// PowerOutletTypeValueEatonDashC39 captures enum value "eaton-c39"
	PowerOutletTypeValueEatonDashC39 string = "eaton-c39"
	...
	// PowerOutletTypeValueEmpty captures enum value ""
	PowerOutletTypeValueEmpty string = ""
)
...
func (m *PowerOutletType) ContextValidate(_ context.Context, _ strfmt.Registry) error {
	return nil
}
