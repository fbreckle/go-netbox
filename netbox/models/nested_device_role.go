...
func (m *NestedDeviceRole) validateDisplayURL(formats strfmt.Registry) error {
...
func (m *NestedDeviceRole) contextValidateDisplayURL(ctx context.Context, formats strfmt.Registry) error {
