...
type WirelessLink struct {
	...
	// distance unit
	DistanceUnit *WirelessLinkDistanceUnit `json:"distance_unit,omitempty"`
...
func (m *WirelessLink) validateDisplayURL(formats strfmt.Registry) error {
...
func (m *WirelessLink) validateDistance(formats strfmt.Registry) error {
...
func (m *WirelessLink) validateDistanceUnit(formats strfmt.Registry) error {
...
func (m *WirelessLink) validateOwner(formats strfmt.Registry) error {
...
func (m *WirelessLink) contextValidateDisplayURL(ctx context.Context, formats strfmt.Registry) error {
...
func (m *WirelessLink) contextValidateDistanceUnit(ctx context.Context, formats strfmt.Registry) error {
...
func (m *WirelessLink) contextValidateOwner(ctx context.Context, formats strfmt.Registry) error {
...
// WirelessLinkAuthCipher wireless link auth cipher
//
...
var wirelessLinkAuthCipherTypeLabelPropEnum []any
...
var wirelessLinkAuthCipherTypeValuePropEnum []any
...
const (
	...
	// WirelessLinkAuthCipherValueEmpty captures enum value ""
	WirelessLinkAuthCipherValueEmpty string = ""
)
...
func (m *WirelessLinkAuthCipher) ContextValidate(_ context.Context, _ strfmt.Registry) error {
	return nil
}
...
// WirelessLinkAuthType wireless link auth type
//
...
var wirelessLinkAuthTypeTypeLabelPropEnum []any
...
var wirelessLinkAuthTypeTypeValuePropEnum []any
...
const (
	...
	// WirelessLinkAuthTypeValueEmpty captures enum value ""
	WirelessLinkAuthTypeValueEmpty string = ""
)
...
func (m *WirelessLinkAuthType) ContextValidate(_ context.Context, _ strfmt.Registry) error {
	return nil
}
...
// WirelessLinkDistanceUnit wireless link distance unit
//
// swagger:model WirelessLinkDistanceUnit
...
// Validate validates this wireless link distance unit
func (m *WirelessLinkDistanceUnit) Validate(formats strfmt.Registry) error {
	var res []error
...
var wirelessLinkDistanceUnitTypeLabelPropEnum []any
...
func init() {
	...
	for _, v := range res {
		wirelessLinkDistanceUnitTypeLabelPropEnum = append(wirelessLinkDistanceUnitTypeLabelPropEnum, v)
	}
}

const (

	// WirelessLinkDistanceUnitLabelKilometers captures enum value "Kilometers"
	WirelessLinkDistanceUnitLabelKilometers string = "Kilometers"

	// WirelessLinkDistanceUnitLabelMeters captures enum value "Meters"
	WirelessLinkDistanceUnitLabelMeters string = "Meters"

	// WirelessLinkDistanceUnitLabelMiles captures enum value "Miles"
	WirelessLinkDistanceUnitLabelMiles string = "Miles"

	// WirelessLinkDistanceUnitLabelFeet captures enum value "Feet"
	WirelessLinkDistanceUnitLabelFeet string = "Feet"
)

// prop value enum
func (m *WirelessLinkDistanceUnit) validateLabelEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, wirelessLinkDistanceUnitTypeLabelPropEnum, true); err != nil {
		return err
	}
	return nil
}

func (m *WirelessLinkDistanceUnit) validateLabel(formats strfmt.Registry) error {
	if typeutils.IsZero(m.Label) { // not required
		return nil
	}
...
var wirelessLinkDistanceUnitTypeValuePropEnum []any
...
func init() {
	...
	for _, v := range res {
		wirelessLinkDistanceUnitTypeValuePropEnum = append(wirelessLinkDistanceUnitTypeValuePropEnum, v)
	}
}

const (

	// WirelessLinkDistanceUnitValueKm captures enum value "km"
	WirelessLinkDistanceUnitValueKm string = "km"

	// WirelessLinkDistanceUnitValueM captures enum value "m"
	WirelessLinkDistanceUnitValueM string = "m"

	// WirelessLinkDistanceUnitValueMi captures enum value "mi"
	WirelessLinkDistanceUnitValueMi string = "mi"

	// WirelessLinkDistanceUnitValueFt captures enum value "ft"
	WirelessLinkDistanceUnitValueFt string = "ft"

	// WirelessLinkDistanceUnitValueEmpty captures enum value ""
	WirelessLinkDistanceUnitValueEmpty string = ""
)

// prop value enum
func (m *WirelessLinkDistanceUnit) validateValueEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, wirelessLinkDistanceUnitTypeValuePropEnum, true); err != nil {
		return err
	}
	return nil
}

func (m *WirelessLinkDistanceUnit) validateValue(formats strfmt.Registry) error {
	if typeutils.IsZero(m.Value) { // not required
		return nil
	}
...
// ContextValidate validates this wireless link distance unit based on context it is used
func (m *WirelessLinkDistanceUnit) ContextValidate(_ context.Context, _ strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *WirelessLinkDistanceUnit) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
	return jsonutils.WriteJSON(m)
...
// UnmarshalBinary interface implementation
func (m *WirelessLinkDistanceUnit) UnmarshalBinary(b []byte) error {
	var res WirelessLinkDistanceUnit
	if err := jsonutils.ReadJSON(b, &res); err != nil {
		return err
	}
	*m = res
...
// WirelessLinkStatus wireless link status
//
...
var wirelessLinkStatusTypeLabelPropEnum []any
...
var wirelessLinkStatusTypeValuePropEnum []any
...
func (m *WirelessLinkStatus) ContextValidate(_ context.Context, _ strfmt.Registry) error {
	return nil
}
