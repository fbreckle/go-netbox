...
var consoleServerPortTypeCableEndPropEnum []any
...
func init() {
	...
	for _, v := range res {
		consoleServerPortTypeCableEndPropEnum = append(consoleServerPortTypeCableEndPropEnum, v)
	}
}

const (

	// ConsoleServerPortCableEndA captures enum value "A"
	ConsoleServerPortCableEndA string = "A"

	// ConsoleServerPortCableEndB captures enum value "B"
	ConsoleServerPortCableEndB string = "B"
)

// prop value enum
func (m *ConsoleServerPort) validateCableEndEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, consoleServerPortTypeCableEndPropEnum, true); err != nil {
		return err
	}
	return nil
}
...
func (m *ConsoleServerPort) validateDisplayURL(formats strfmt.Registry) error {
...
func (m *ConsoleServerPort) validateOwner(formats strfmt.Registry) error {
...
func (m *ConsoleServerPort) contextValidateDisplayURL(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ConsoleServerPort) contextValidateOwner(ctx context.Context, formats strfmt.Registry) error {
...
// ConsoleServerPortSpeed console server port speed
//
...
var consoleServerPortSpeedTypeLabelPropEnum []any
...
var consoleServerPortSpeedTypeValuePropEnum []any
...
func (m *ConsoleServerPortSpeed) ContextValidate(_ context.Context, _ strfmt.Registry) error {
	return nil
}
...
// ConsoleServerPortType console server port type
//
...
var consoleServerPortTypeTypeLabelPropEnum []any
...
var consoleServerPortTypeTypeValuePropEnum []any
...
const (
	...
	// ConsoleServerPortTypeValueEmpty captures enum value ""
	ConsoleServerPortTypeValueEmpty string = ""
)
...
func (m *ConsoleServerPortType) ContextValidate(_ context.Context, _ strfmt.Registry) error {
	return nil
}
