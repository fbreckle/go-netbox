...
func (m *NestedInterface) validateDisplayURL(formats strfmt.Registry) error {
...
func (m *NestedInterface) contextValidateDisplayURL(ctx context.Context, formats strfmt.Registry) error {
