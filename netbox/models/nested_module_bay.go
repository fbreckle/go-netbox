...
func (m *NestedModuleBay) validateDisplayURL(formats strfmt.Registry) error {
...
func (m *NestedModuleBay) contextValidateDisplayURL(ctx context.Context, formats strfmt.Registry) error {
