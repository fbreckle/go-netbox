...
func (m *Prefix) validateDisplayURL(formats strfmt.Registry) error {
...
func (m *Prefix) validateOwner(formats strfmt.Registry) error {
...
func (m *Prefix) contextValidateChildren(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := validate.ReadOnly(ctx, "children", "body", m.Children); err != nil {
		return err
	}
...
func (m *Prefix) contextValidateDisplayURL(ctx context.Context, formats strfmt.Registry) error {
...
func (m *Prefix) contextValidateOwner(ctx context.Context, formats strfmt.Registry) error {
...
var prefixFamilyTypeLabelPropEnum []any
...
var prefixFamilyTypeValuePropEnum []any
...
var prefixStatusTypeLabelPropEnum []any
...
var prefixStatusTypeValuePropEnum []any
...
func (m *PrefixStatus) ContextValidate(_ context.Context, _ strfmt.Registry) error {
	return nil
}
