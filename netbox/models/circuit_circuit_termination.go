...
func (m *CircuitCircuitTermination) validateDisplayURL(formats strfmt.Registry) error {
...
func (m *CircuitCircuitTermination) contextValidateDisplayURL(ctx context.Context, formats strfmt.Registry) error {
