...
func (m *NestedVMInterface) validateDisplayURL(formats strfmt.Registry) error {
...
func (m *NestedVMInterface) validateVirtualMachine(formats strfmt.Registry) error {
	if typeutils.IsZero(m.VirtualMachine) { // not required
		return nil
	}
...
func (m *NestedVMInterface) contextValidateDisplayURL(ctx context.Context, formats strfmt.Registry) error {
