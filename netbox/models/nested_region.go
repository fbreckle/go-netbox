...
func (m *NestedRegion) validateDisplayURL(formats strfmt.Registry) error {
...
func (m *NestedRegion) contextValidateDisplayURL(ctx context.Context, formats strfmt.Registry) error {
