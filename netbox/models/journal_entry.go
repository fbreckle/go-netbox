...
func (m *JournalEntry) validateDisplayURL(formats strfmt.Registry) error {
...
func (m *JournalEntry) contextValidateDisplayURL(ctx context.Context, formats strfmt.Registry) error {
...
// JournalEntryKind journal entry kind
//
...
var journalEntryKindTypeLabelPropEnum []any
...
var journalEntryKindTypeValuePropEnum []any
...
func (m *JournalEntryKind) ContextValidate(_ context.Context, _ strfmt.Registry) error {
	return nil
}
