...
var powerPortTypeCableEndPropEnum []any
...
func init() {
	...
	for _, v := range res {
		powerPortTypeCableEndPropEnum = append(powerPortTypeCableEndPropEnum, v)
	}
}

const (

	// PowerPortCableEndA captures enum value "A"
	PowerPortCableEndA string = "A"

	// PowerPortCableEndB captures enum value "B"
	PowerPortCableEndB string = "B"
)

// prop value enum
func (m *PowerPort) validateCableEndEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, powerPortTypeCableEndPropEnum, true); err != nil {
		return err
	}
	return nil
}
...
func (m *PowerPort) validateDisplayURL(formats strfmt.Registry) error {
...
func (m *PowerPort) validateOwner(formats strfmt.Registry) error {
...
func (m *PowerPort) contextValidateDisplayURL(ctx context.Context, formats strfmt.Registry) error {
...
func (m *PowerPort) contextValidateOwner(ctx context.Context, formats strfmt.Registry) error {
...
var powerPortTypeTypeLabelPropEnum []any

func init() {
	var res []string
	if err := json.Unmarshal([]byte(`["C6","C8","C14","C16","C18","C20","C22","P+N+E 4H","P+N+E 6H","P+N+E 9H","2P+E 4H","2P+E 6H","2P+E 9H","3P+E 4H","3P+E 6H","3P+E 9H","3P+N+E 4H","3P+N+E 6H","3P+N+E 9H","IEC 60906-1","2P+T 10A (NBR 14136)","2P+T 20A (NBR 14136)","NEMA 1-15P","NEMA 5-15P","NEMA 5-20P","NEMA 5-30P","NEMA 5-50P","NEMA 6-15P","NEMA 6-20P","NEMA 6-30P","NEMA 6-50P","NEMA 10-30P","NEMA 10-50P","NEMA 14-20P","NEMA 14-30P","NEMA 14-50P","NEMA 14-60P","NEMA 15-15P","NEMA 15-20P","NEMA 15-30P","NEMA 15-50P","NEMA 15-60P","NEMA L1-15P","NEMA L5-15P","NEMA L5-20P","NEMA L5-30P","NEMA L5-50P","NEMA L6-15P","NEMA L6-20P","NEMA L6-30P","NEMA L6-50P","NEMA L10-30P","NEMA L14-20P","NEMA L14-30P","NEMA L14-50P","NEMA L14-60P","NEMA L15-20P","NEMA L15-30P","NEMA L15-50P","NEMA L15-60P","NEMA L21-20P","NEMA L21-30P","NEMA L22-20P","NEMA L22-30P","CS6361C","CS6365C","CS8165C","CS8265C","CS8365C","CS8465C","ITA Type C (CEE 7/16)","ITA Type E (CEE 7/6)","ITA Type F (CEE 7/4)","ITA Type E/F (CEE 7/7)","ITA Type G (BS 1363)","ITA Type H","ITA Type I","ITA Type J","ITA Type K","ITA Type L (CEI 23-50)","ITA Type M (BS 546)","ITA Type N","ITA Type O","USB Type A","USB Type B","USB Type C","USB Mini A","USB Mini B","USB Micro A","USB Micro B","USB Micro AB","USB 3.0 Type B","USB 3.0 Micro B","Molex Micro-Fit 1x2","Molex Micro-Fit 2x2","Molex Micro-Fit 2x3","Molex Micro-Fit 2x4","DC Terminal","Saf-D-Grid","Neutrik powerCON (20A)","Neutrik powerCON (32A)","Neutrik powerCON TRUE1","Neutrik powerCON TRUE1 TOP","Ubiquiti SmartPower","Hardwired","Other"]`), &res); err != nil {
		panic(err)
	}
	for _, v := range res {
...
const (
	...
	// PowerPortTypeLabelC18 captures enum value "C18"
	PowerPortTypeLabelC18 string = "C18"
	...
	// PowerPortTypeLabelIEC60906Dash1 captures enum value "IEC 60906-1"
	PowerPortTypeLabelIEC60906Dash1 string = "IEC 60906-1"

	// PowerPortTypeLabelNr2PPlusT10ANBR14136 captures enum value "2P+T 10A (NBR 14136)"
	PowerPortTypeLabelNr2PPlusT10ANBR14136 string = "2P+T 10A (NBR 14136)"

	// PowerPortTypeLabelNr2PPlusT20ANBR14136 captures enum value "2P+T 20A (NBR 14136)"
	PowerPortTypeLabelNr2PPlusT20ANBR14136 string = "2P+T 20A (NBR 14136)"
	...
	// PowerPortTypeLabelNEMAL22Dash20P captures enum value "NEMA L22-20P"
	PowerPortTypeLabelNEMAL22Dash20P string = "NEMA L22-20P"
	...
	// PowerPortTypeLabelITATypeCCEE7Slash16 captures enum value "ITA Type C (CEE 7/16)"
	PowerPortTypeLabelITATypeCCEE7Slash16 string = "ITA Type C (CEE 7/16)"

	// PowerPortTypeLabelITATypeECEE7Slash6 captures enum value "ITA Type E (CEE 7/6)"
	PowerPortTypeLabelITATypeECEE7Slash6 string = "ITA Type E (CEE 7/6)"

	// PowerPortTypeLabelITATypeFCEE7Slash4 captures enum value "ITA Type F (CEE 7/4)"
	PowerPortTypeLabelITATypeFCEE7Slash4 string = "ITA Type F (CEE 7/4)"

	// PowerPortTypeLabelITATypeESlashFCEE7Slash7 captures enum value "ITA Type E/F (CEE 7/7)"
	PowerPortTypeLabelITATypeESlashFCEE7Slash7 string = "ITA Type E/F (CEE 7/7)"
	...
	// PowerPortTypeLabelMolexMicroDashFit1x2 captures enum value "Molex Micro-Fit 1x2"
	PowerPortTypeLabelMolexMicroDashFit1x2 string = "Molex Micro-Fit 1x2"

	// PowerPortTypeLabelMolexMicroDashFit2x2 captures enum value "Molex Micro-Fit 2x2"
	PowerPortTypeLabelMolexMicroDashFit2x2 string = "Molex Micro-Fit 2x2"

	// PowerPortTypeLabelMolexMicroDashFit2x3 captures enum value "Molex Micro-Fit 2x3"
	PowerPortTypeLabelMolexMicroDashFit2x3 string = "Molex Micro-Fit 2x3"

	// PowerPortTypeLabelMolexMicroDashFit2x4 captures enum value "Molex Micro-Fit 2x4"
	PowerPortTypeLabelMolexMicroDashFit2x4 string = "Molex Micro-Fit 2x4"
...
var powerPortTypeTypeValuePropEnum []any
...
const (
	...
	// PowerPortTypeValueIecDash60320DashC18 captures enum value "iec-60320-c18"
	PowerPortTypeValueIecDash60320DashC18 string = "iec-60320-c18"
	...
	// PowerPortTypeValueIecDash60906Dash1 captures enum value "iec-60906-1"
	PowerPortTypeValueIecDash60906Dash1 string = "iec-60906-1"

	// PowerPortTypeValueNbrDash14136Dash10a captures enum value "nbr-14136-10a"
	PowerPortTypeValueNbrDash14136Dash10a string = "nbr-14136-10a"

	// PowerPortTypeValueNbrDash14136Dash20a captures enum value "nbr-14136-20a"
	PowerPortTypeValueNbrDash14136Dash20a string = "nbr-14136-20a"
	...
	// PowerPortTypeValueNemaDashL22Dash20p captures enum value "nema-l22-20p"
	PowerPortTypeValueNemaDashL22Dash20p string = "nema-l22-20p"
	...
	// PowerPortTypeValueMolexDashMicroDashFitDash1x2 captures enum value "molex-micro-fit-1x2"
	PowerPortTypeValueMolexDashMicroDashFitDash1x2 string = "molex-micro-fit-1x2"

	// PowerPortTypeValueMolexDashMicroDashFitDash2x2 captures enum value "molex-micro-fit-2x2"
	PowerPortTypeValueMolexDashMicroDashFitDash2x2 string = "molex-micro-fit-2x2"

	// PowerPortTypeValueMolexDashMicroDashFitDash2x3 captures enum value "molex-micro-fit-2x3"
	PowerPortTypeValueMolexDashMicroDashFitDash2x3 string = "molex-micro-fit-2x3"

	// PowerPortTypeValueMolexDashMicroDashFitDash2x4 captures enum value "molex-micro-fit-2x4"
	PowerPortTypeValueMolexDashMicroDashFitDash2x4 string = "molex-micro-fit-2x4"
	...
	// PowerPortTypeValueEmpty captures enum value ""
	PowerPortTypeValueEmpty string = ""
)
...
func (m *PowerPortType) ContextValidate(_ context.Context, _ strfmt.Registry) error {
	return nil
}
