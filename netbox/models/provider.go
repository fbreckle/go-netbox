...
func (m *Provider) validateAccounts(formats strfmt.Registry) error {
	if typeutils.IsZero(m.Accounts) { // not required
		return nil
	}

	for i := 0; i < len(m.Accounts); i++ {
		if typeutils.IsZero(m.Accounts[i]) { // not required
			continue
		}
...
func (m *Provider) validateDisplayURL(formats strfmt.Registry) error {
...
func (m *Provider) validateOwner(formats strfmt.Registry) error {
...
func (m *Provider) contextValidateDisplayURL(ctx context.Context, formats strfmt.Registry) error {
...
func (m *Provider) contextValidateOwner(ctx context.Context, formats strfmt.Registry) error {
