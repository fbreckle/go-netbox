...
type ContactAssignment struct {
	...
	// role
	Role *BriefContactRole `json:"role,omitempty"`
...
func (m *ContactAssignment) validateObjectType(formats strfmt.Registry) error {
...
func (m *ContactAssignment) validateTags(formats strfmt.Registry) error {
...
func (m *ContactAssignment) contextValidateTags(ctx context.Context, formats strfmt.Registry) error {
...
// ContactAssignmentPriority contact assignment priority
//
...
var contactAssignmentPriorityTypeLabelPropEnum []any
...
var contactAssignmentPriorityTypeValuePropEnum []any
...
const (
	...
	// ContactAssignmentPriorityValueEmpty captures enum value ""
	ContactAssignmentPriorityValueEmpty string = ""
)
...
func (m *ContactAssignmentPriority) ContextValidate(_ context.Context, _ strfmt.Registry) error {
	return nil
}
