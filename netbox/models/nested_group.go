...
func (m *NestedGroup) validateDisplayURL(formats strfmt.Registry) error {
...
func (m *NestedGroup) contextValidateDisplayURL(ctx context.Context, formats strfmt.Registry) error {
