...
func (m *WritableImageAttachment) validateDescription(formats strfmt.Registry) error {
...
func (m *WritableImageAttachment) validateObjectType(formats strfmt.Registry) error {
...
// ContextValidate validates this writable image attachment based on context it is used
func (m *WritableImageAttachment) ContextValidate(_ context.Context, _ strfmt.Registry) error {
	return nil
}
