...
func (m *ProviderNetwork) validateDisplayURL(formats strfmt.Registry) error {
...
func (m *ProviderNetwork) validateOwner(formats strfmt.Registry) error {
...
func (m *ProviderNetwork) validateServiceID(formats strfmt.Registry) error {
	if typeutils.IsZero(m.ServiceID) { // not required
		return nil
	}
...
func (m *ProviderNetwork) contextValidateDisplayURL(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ProviderNetwork) contextValidateOwner(ctx context.Context, formats strfmt.Registry) error {
