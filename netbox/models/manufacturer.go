...
type Manufacturer struct {
	...
	// moduletype count
	// Read Only: true
	ModuletypeCount int64 `json:"moduletype_count,omitempty"`
...
func (m *Manufacturer) validateDisplayURL(formats strfmt.Registry) error {
...
func (m *Manufacturer) validateOwner(formats strfmt.Registry) error {
...
func (m *Manufacturer) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := m.contextValidateModuletypeCount(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (m *Manufacturer) contextValidateDevicetypeCount(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := validate.ReadOnly(ctx, "devicetype_count", "body", m.DevicetypeCount); err != nil {
		return err
	}
...
func (m *Manufacturer) contextValidateDisplayURL(ctx context.Context, formats strfmt.Registry) error {
...
func (m *Manufacturer) contextValidateInventoryitemCount(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := validate.ReadOnly(ctx, "inventoryitem_count", "body", m.InventoryitemCount); err != nil {
		return err
	}
...
func (m *Manufacturer) contextValidateModuletypeCount(ctx context.Context, formats strfmt.Registry) error {

	if err := validate.ReadOnly(ctx, "moduletype_count", "body", m.ModuletypeCount); err != nil {
		return err
	}
...
func (m *Manufacturer) contextValidateOwner(ctx context.Context, formats strfmt.Registry) error {
...
func (m *Manufacturer) contextValidatePlatformCount(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := validate.ReadOnly(ctx, "platform_count", "body", m.PlatformCount); err != nil {
		return err
	}
