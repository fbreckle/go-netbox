...
func (m *NestedPlatform) validateDisplayURL(formats strfmt.Registry) error {
...
func (m *NestedPlatform) contextValidateDisplayURL(ctx context.Context, formats strfmt.Registry) error {
