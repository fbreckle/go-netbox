...
func (m *VirtualMachineType) validateDisplayURL(formats strfmt.Registry) error {
...
func (m *VirtualMachineType) validateOwner(formats strfmt.Registry) error {
...
func (m *VirtualMachineType) contextValidateDisplayURL(ctx context.Context, formats strfmt.Registry) error {
...
func (m *VirtualMachineType) contextValidateOwner(ctx context.Context, formats strfmt.Registry) error {
...
func (m *VirtualMachineType) contextValidateVirtualMachineCount(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := validate.ReadOnly(ctx, "virtual_machine_count", "body", m.VirtualMachineCount); err != nil {
		return err
	}
