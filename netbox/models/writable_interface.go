...
type WritableInterface struct {
	...
	// primary mac address
	PrimaryMacAddress *WritableInterfacePrimaryMacAddress `json:"primary_mac_address,omitempty"`
...
func (m *WritableInterface) validatePrimaryMacAddress(formats strfmt.Registry) error {
...
func (m *WritableInterface) contextValidatePrimaryMacAddress(ctx context.Context, formats strfmt.Registry) error {
...
// WritableInterfacePrimaryMacAddress writable interface primary mac address
//
// swagger:model WritableInterfacePrimaryMacAddress
type WritableInterfacePrimaryMacAddress struct {

	// mac address
	MacAddress string `json:"mac_address,omitempty"`
}

// Validate validates this writable interface primary mac address
func (m *WritableInterfacePrimaryMacAddress) Validate(formats strfmt.Registry) error {
	return nil
}

// ContextValidate validates this writable interface primary mac address based on context it is used
func (m *WritableInterfacePrimaryMacAddress) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *WritableInterfacePrimaryMacAddress) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
	return swag.WriteJSON(m)
...
// UnmarshalBinary interface implementation
func (m *WritableInterfacePrimaryMacAddress) UnmarshalBinary(b []byte) error {
	var res WritableInterfacePrimaryMacAddress
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*m = res
