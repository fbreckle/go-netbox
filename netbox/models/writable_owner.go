...
func (m *WritableOwner) validateUserGroups(formats strfmt.Registry) error {
	if swag.IsZero(m.UserGroups) { // not required
		return nil
	}

	if err := validate.UniqueItems("user_groups", "body", m.UserGroups); err != nil {
		return err
	}
...
func (m *WritableOwner) validateUsers(formats strfmt.Registry) error {
