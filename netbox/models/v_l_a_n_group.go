...
type VLANGroup struct {
	...
	// total vlan ids
	// Read Only: true
	TotalVlanIds int64 `json:"total_vlan_ids,omitempty"`
...
func (m *VLANGroup) validateDisplayURL(formats strfmt.Registry) error {
...
func (m *VLANGroup) validateOwner(formats strfmt.Registry) error {
...
func (m *VLANGroup) validateTenant(formats strfmt.Registry) error {
...
func (m *VLANGroup) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := m.contextValidateTotalVlanIds(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (m *VLANGroup) contextValidateDisplayURL(ctx context.Context, formats strfmt.Registry) error {
...
func (m *VLANGroup) contextValidateOwner(ctx context.Context, formats strfmt.Registry) error {
...
func (m *VLANGroup) contextValidateTenant(ctx context.Context, formats strfmt.Registry) error {
...
func (m *VLANGroup) contextValidateTotalVlanIds(ctx context.Context, formats strfmt.Registry) error {

	if err := validate.ReadOnly(ctx, "total_vlan_ids", "body", m.TotalVlanIds); err != nil {
		return err
	}
...
func (m *VLANGroup) contextValidateUtilization(ctx context.Context, formats strfmt.Registry) error {

	if err := validate.ReadOnly(ctx, "utilization", "body", m.Utilization); err != nil {
		return err
	}
