...
type Tenant struct {
	...
	// group
	Group *BriefTenantGroup `json:"group,omitempty"`
...
func (m *Tenant) validateDisplayURL(formats strfmt.Registry) error {
...
func (m *Tenant) validateOwner(formats strfmt.Registry) error {
...
func (m *Tenant) contextValidateClusterCount(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := validate.ReadOnly(ctx, "cluster_count", "body", m.ClusterCount); err != nil {
		return err
	}
...
func (m *Tenant) contextValidateDisplayURL(ctx context.Context, formats strfmt.Registry) error {
...
func (m *Tenant) contextValidateOwner(ctx context.Context, formats strfmt.Registry) error {
...
func (m *Tenant) contextValidateVrfCount(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := validate.ReadOnly(ctx, "vrf_count", "body", m.VrfCount); err != nil {
		return err
	}
