...
func NewFrontPort(id int32, url string, display string, device NestedDevice, name string, type_ CableStatus, rearPort FrontPortRearPort, cable NullableNestedCable, cableEnd string, linkPeers []interface{}, linkPeersType string, created NullableTime, lastUpdated NullableTime, occupied bool) *FrontPort {
	this := FrontPort{}
	this.Id = id
	this.Url = url
...
func (o *FrontPort) GetType() CableStatus {
	if o == nil {
		var ret CableStatus
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *FrontPort) GetTypeOk() (*CableStatus, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Type, true
...
func (o *FrontPort) SetType(v CableStatus) {
	o.Type = v
}
