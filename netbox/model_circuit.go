...
// GetProviderAccount returns the ProviderAccount field value
...
// GetProviderAccountOk returns a tuple with the ProviderAccount field value
// and a boolean to check if the value has been set.
func (o *Circuit) GetProviderAccountOk() (*NestedProviderAccount, bool) {
	if o == nil {
		return nil, false
	}
	return &o.ProviderAccount, true
}

// SetProviderAccount sets field value
...
func (o Circuit) ToMap() (map[string]interface{}, error) {
	...
	toSerialize["provider_account"] = o.ProviderAccount
