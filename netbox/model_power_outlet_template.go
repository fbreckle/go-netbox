...
type PowerOutletTemplate struct {
	...
	Type        NullableCableLengthUnit         `json:"type,omitempty"`
	PowerPort   NullableNestedPowerPortTemplate `json:"power_port,omitempty"`
	FeedLeg     NullableCableLengthUnit         `json:"feed_leg,omitempty"`
...
func (o *PowerOutletTemplate) GetType() CableLengthUnit {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *PowerOutletTemplate) GetTypeOk() (*CableLengthUnit, bool) {
	if o == nil {
		return nil, false
	}
...
// SetType gets a reference to the given NullableCableLengthUnit and assigns it to the Type field.
func (o *PowerOutletTemplate) SetType(v CableLengthUnit) {
	o.Type.Set(&v)
}
...
func (o *PowerOutletTemplate) GetFeedLeg() CableLengthUnit {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *PowerOutletTemplate) GetFeedLegOk() (*CableLengthUnit, bool) {
	if o == nil {
		return nil, false
	}
...
// SetFeedLeg gets a reference to the given NullableCableLengthUnit and assigns it to the FeedLeg field.
func (o *PowerOutletTemplate) SetFeedLeg(v CableLengthUnit) {
	o.FeedLeg.Set(&v)
}
