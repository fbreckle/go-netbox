...
func (r ApiUsersPermissionsListRequest) DescriptionEmpty(descriptionEmpty []string) ApiUsersPermissionsListRequest {
...
func (r ApiUsersTokensListRequest) DescriptionEmpty(descriptionEmpty []string) ApiUsersTokensListRequest {
	r.descriptionEmpty = &descriptionEmpty
	return r
}
...
func (r ApiUsersTokensListRequest) KeyEmpty(keyEmpty []string) ApiUsersTokensListRequest {
	r.keyEmpty = &keyEmpty
	return r
}
...
func (a *UsersApiService) UsersTokensListExecute(r ApiUsersTokensListRequest) (*PaginatedTokenList, *http.Response, error) {
	...
	if r.keyEmpty != nil {
		...
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "key__empty", s.Index(i), "multi")
			}
		} else {
			parameterAddToHeaderOrQuery(localVarQueryParams, "key__empty", t, "multi")
		}
	}
	if r.keyIc != nil {
		t := *r.keyIc
...
func (r ApiUsersTokensProvisionCreateRequest) WritableTokenRequest(writableTokenRequest WritableTokenRequest) ApiUsersTokensProvisionCreateRequest {
	r.writableTokenRequest = &writableTokenRequest
	return r
}

func (r ApiUsersTokensProvisionCreateRequest) Execute() (*Token, *http.Response, error) {
...
//
//	@return Token
func (a *UsersApiService) UsersTokensProvisionCreateExecute(r ApiUsersTokensProvisionCreateRequest) (*Token, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPost
		localVarPostBody    interface{}
		formFiles           []formFile
...
func (a *UsersApiService) UsersUsersListExecute(r ApiUsersUsersListRequest) (*PaginatedUserList, *http.Response, error) {
	...
	if r.firstNameEmpty != nil {
		...
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "first_name__empty", s.Index(i), "multi")
			}
		} else {
			parameterAddToHeaderOrQuery(localVarQueryParams, "first_name__empty", t, "multi")
		}
	}
	...
	if r.lastNameEmpty != nil {
		...
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "last_name__empty", s.Index(i), "multi")
			}
		} else {
			parameterAddToHeaderOrQuery(localVarQueryParams, "last_name__empty", t, "multi")
		}
	}
	if r.lastNameIc != nil {
		t := *r.lastNameIc
	...
	if r.usernameEmpty != nil {
		...
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "username__empty", s.Index(i), "multi")
			}
		} else {
			parameterAddToHeaderOrQuery(localVarQueryParams, "username__empty", t, "multi")
		}
	}
	if r.usernameIc != nil {
		t := *r.usernameIc
