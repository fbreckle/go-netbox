...
func main() {
    authCipher := []string{"Inner_example"} // []string | * `auto` - Auto * `tkip` - TKIP * `aes` - AES (optional)
    authCipherN := []string{"Inner_example"} // []string | * `auto` - Auto * `tkip` - TKIP * `aes` - AES (optional)
    authPsk := []string{"Inner_example"} // []string |  (optional)
    authPskEmpty := []string{"Inner_example"} // []string |  (optional)
    ...
    authType := []string{"Inner_example"} // []string | * `open` - Open * `wep` - WEP * `wpa-personal` - WPA Personal (PSK) * `wpa-enterprise` - WPA Enterprise (optional)
    authTypeN := []string{"Inner_example"} // []string | * `open` - Open * `wep` - WEP * `wpa-personal` - WPA Personal (PSK) * `wpa-enterprise` - WPA Enterprise (optional)
    created := []time.Time{time.Now()} // []time.Time |  (optional)
    createdGt := []time.Time{time.Now()} // []time.Time |  (optional)
    createdGte := []time.Time{time.Now()} // []time.Time |  (optional)
    createdLt := []time.Time{time.Now()} // []time.Time |  (optional)
    ...
    ssidEmpty := []string{"Inner_example"} // []string |  (optional)
    ...
    status := []string{"Inner_example"} // []string | * `active` - Active * `reserved` - Reserved * `disabled` - Disabled * `deprecated` - Deprecated (optional)
    statusN := []string{"Inner_example"} // []string | * `active` - Active * `reserved` - Reserved * `disabled` - Disabled * `deprecated` - Deprecated (optional)
    tag := []string{"Inner_example"} // []string |  (optional)
    tagN := []string{"Inner_example"} // []string |  (optional)
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **authCipher** | **[]string** | * &#x60;auto&#x60; - Auto * &#x60;tkip&#x60; - TKIP * &#x60;aes&#x60; - AES | 
 **authCipherN** | **[]string** | * &#x60;auto&#x60; - Auto * &#x60;tkip&#x60; - TKIP * &#x60;aes&#x60; - AES | 
 **authPsk** | **[]string** |  | 
 **authPskEmpty** | **[]string** |  | 
 **authPskIc** | **[]string** |  | 
 **authPskIe** | **[]string** |  | 
 ...
 **authPskNiew** | **[]string** |  | 
 **authPskNisw** | **[]string** |  | 
 **authType** | **[]string** | * &#x60;open&#x60; - Open * &#x60;wep&#x60; - WEP * &#x60;wpa-personal&#x60; - WPA Personal (PSK) * &#x60;wpa-enterprise&#x60; - WPA Enterprise | 
 **authTypeN** | **[]string** | * &#x60;open&#x60; - Open * &#x60;wep&#x60; - WEP * &#x60;wpa-personal&#x60; - WPA Personal (PSK) * &#x60;wpa-enterprise&#x60; - WPA Enterprise | 
 **created** | [**[]time.Time**](time.Time.md) |  | 
 **createdGt** | [**[]time.Time**](time.Time.md) |  | 
 **createdGte** | [**[]time.Time**](time.Time.md) |  | 
 **createdLt** | [**[]time.Time**](time.Time.md) |  | 
 ...
 **ssidNiew** | **[]string** |  | 
 **ssidNisw** | **[]string** |  | 
 **status** | **[]string** | * &#x60;active&#x60; - Active * &#x60;reserved&#x60; - Reserved * &#x60;disabled&#x60; - Disabled * &#x60;deprecated&#x60; - Deprecated | 
 **statusN** | **[]string** | * &#x60;active&#x60; - Active * &#x60;reserved&#x60; - Reserved * &#x60;disabled&#x60; - Disabled * &#x60;deprecated&#x60; - Deprecated | 
 **tag** | **[]string** |  | 
 **tagN** | **[]string** |  | 
...
func main() {
    ...
    ssidNiew := []string{"Inner_example"} // []string |  (optional)
    ssidNisw := []string{"Inner_example"} // []string |  (optional)
    status := []string{"Inner_example"} // []string | * `connected` - Connected * `planned` - Planned * `decommissioning` - Decommissioning (optional)
    statusN := []string{"Inner_example"} // []string | * `connected` - Connected * `planned` - Planned * `decommissioning` - Decommissioning (optional)
    tag := []string{"Inner_example"} // []string |  (optional)
    tagN := []string{"Inner_example"} // []string |  (optional)
    tenant := []string{"Inner_example"} // []string | Tenant (slug) (optional)
    tenantN := []string{"Inner_example"} // []string | Tenant (slug) (optional)
 ...
 **ssidNiew** | **[]string** |  | 
 **ssidNisw** | **[]string** |  | 
 **status** | **[]string** | * &#x60;connected&#x60; - Connected * &#x60;planned&#x60; - Planned * &#x60;decommissioning&#x60; - Decommissioning | 
 **statusN** | **[]string** | * &#x60;connected&#x60; - Connected * &#x60;planned&#x60; - Planned * &#x60;decommissioning&#x60; - Decommissioning | 
 **tag** | **[]string** |  | 
 **tagN** | **[]string** |  | 
 **tenant** | **[]string** | Tenant (slug) | 
 **tenantN** | **[]string** | Tenant (slug) | 
