...
**ProviderAccount** | [**NestedProviderAccountRequest**](NestedProviderAccountRequest.md) |  | 
...
`func NewCircuitRequest(cid string, provider NestedProviderRequest, providerAccount NestedProviderAccountRequest, type_ NestedCircuitTypeRequest, ) *CircuitRequest`
