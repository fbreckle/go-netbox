...
**ProviderAccount** | [**NestedProviderAccount**](NestedProviderAccount.md) |  | 
...
`func NewCircuit(id int32, url string, display string, cid string, provider NestedProvider, providerAccount NestedProviderAccount, type_ NestedCircuitType, terminationA NullableCircuitCircuitTermination, terminationZ NullableCircuitCircuitTermination, created NullableTime, lastUpdated NullableTime, ) *Circuit`
...
`func (o *Circuit) GetStatus() CableStatus`

GetStatus returns the Status field if non-nil, zero value otherwise.

### GetStatusOk

`func (o *Circuit) GetStatusOk() (*CableStatus, bool)`
...
`func (o *Circuit) SetStatus(v CableStatus)`
