...
func (r ApiTenancyContactGroupsListRequest) DescriptionEmpty(descriptionEmpty []string) ApiTenancyContactGroupsListRequest {
...
func (r ApiTenancyContactGroupsListRequest) NameEmpty(nameEmpty []string) ApiTenancyContactGroupsListRequest {
...
func (r ApiTenancyContactGroupsListRequest) SlugEmpty(slugEmpty []string) ApiTenancyContactGroupsListRequest {
...
func (r ApiTenancyContactRolesListRequest) DescriptionEmpty(descriptionEmpty []string) ApiTenancyContactRolesListRequest {
	r.descriptionEmpty = &descriptionEmpty
	return r
}
...
func (r ApiTenancyContactRolesListRequest) NameEmpty(nameEmpty []string) ApiTenancyContactRolesListRequest {
	r.nameEmpty = &nameEmpty
	return r
}
...
func (r ApiTenancyContactRolesListRequest) SlugEmpty(slugEmpty []string) ApiTenancyContactRolesListRequest {
	r.slugEmpty = &slugEmpty
	return r
}
...
func (r ApiTenancyContactsListRequest) AddressEmpty(addressEmpty []string) ApiTenancyContactsListRequest {
...
func (r ApiTenancyContactsListRequest) EmailEmpty(emailEmpty []string) ApiTenancyContactsListRequest {
...
func (r ApiTenancyContactsListRequest) LinkEmpty(linkEmpty []string) ApiTenancyContactsListRequest {
...
func (r ApiTenancyContactsListRequest) NameEmpty(nameEmpty []string) ApiTenancyContactsListRequest {
	r.nameEmpty = &nameEmpty
	return r
}
...
func (r ApiTenancyContactsListRequest) PhoneEmpty(phoneEmpty []string) ApiTenancyContactsListRequest {
...
func (r ApiTenancyContactsListRequest) TitleEmpty(titleEmpty []string) ApiTenancyContactsListRequest {
...
func (a *TenancyApiService) TenancyContactsListExecute(r ApiTenancyContactsListRequest) (*PaginatedContactList, *http.Response, error) {
	...
	if r.addressEmpty != nil {
		...
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "address__empty", s.Index(i), "multi")
			}
		} else {
			parameterAddToHeaderOrQuery(localVarQueryParams, "address__empty", t, "multi")
		}
	}
	if r.addressIc != nil {
		t := *r.addressIc
	...
	if r.emailEmpty != nil {
		...
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "email__empty", s.Index(i), "multi")
			}
		} else {
			parameterAddToHeaderOrQuery(localVarQueryParams, "email__empty", t, "multi")
		}
	}
	if r.emailIc != nil {
		t := *r.emailIc
	...
	if r.linkEmpty != nil {
		...
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "link__empty", s.Index(i), "multi")
			}
		} else {
			parameterAddToHeaderOrQuery(localVarQueryParams, "link__empty", t, "multi")
		}
	}
	if r.linkIc != nil {
		t := *r.linkIc
	...
	if r.phoneEmpty != nil {
		...
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "phone__empty", s.Index(i), "multi")
			}
		} else {
			parameterAddToHeaderOrQuery(localVarQueryParams, "phone__empty", t, "multi")
		}
	}
	if r.phoneIc != nil {
		t := *r.phoneIc
	...
	if r.titleEmpty != nil {
		...
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "title__empty", s.Index(i), "multi")
			}
		} else {
			parameterAddToHeaderOrQuery(localVarQueryParams, "title__empty", t, "multi")
		}
	}
	if r.titleIc != nil {
		t := *r.titleIc
...
func (r ApiTenancyTenantsListRequest) DescriptionEmpty(descriptionEmpty []string) ApiTenancyTenantsListRequest {
	r.descriptionEmpty = &descriptionEmpty
	return r
}
