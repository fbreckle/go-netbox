...
func (r ApiCircuitsCircuitTerminationsListRequest) DescriptionEmpty(descriptionEmpty []string) ApiCircuitsCircuitTerminationsListRequest {
...
func (a *CircuitsApiService) CircuitsCircuitTerminationsListExecute(r ApiCircuitsCircuitTerminationsListRequest) (*PaginatedCircuitTerminationList, *http.Response, error) {
	...
	if r.circuitId != nil {
		...
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "circuit_id", s.Index(i), "multi")
			}
		} else {
	...
	if r.circuitIdN != nil {
		...
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "circuit_id__n", s.Index(i), "multi")
			}
		} else {
	...
	if r.descriptionEmpty != nil {
		t := *r.descriptionEmpty
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "description__empty", s.Index(i), "multi")
			}
		} else {
			parameterAddToHeaderOrQuery(localVarQueryParams, "description__empty", t, "multi")
		}
	}
	...
	if r.portSpeed != nil {
		...
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "port_speed", s.Index(i), "multi")
			}
		} else {
	...
	if r.portSpeedGt != nil {
		...
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "port_speed__gt", s.Index(i), "multi")
			}
		} else {
	...
	if r.portSpeedGte != nil {
		...
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "port_speed__gte", s.Index(i), "multi")
			}
		} else {
	...
	if r.portSpeedLt != nil {
		...
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "port_speed__lt", s.Index(i), "multi")
			}
		} else {
	...
	if r.portSpeedLte != nil {
		...
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "port_speed__lte", s.Index(i), "multi")
			}
		} else {
	...
	if r.portSpeedN != nil {
		...
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "port_speed__n", s.Index(i), "multi")
			}
		} else {
	...
	if r.providerNetworkId != nil {
		...
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "provider_network_id", s.Index(i), "multi")
			}
		} else {
	...
	if r.providerNetworkIdN != nil {
		...
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "provider_network_id__n", s.Index(i), "multi")
			}
		} else {
	...
	if r.upstreamSpeed != nil {
		...
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "upstream_speed", s.Index(i), "multi")
			}
		} else {
	...
	if r.upstreamSpeedGt != nil {
		...
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "upstream_speed__gt", s.Index(i), "multi")
			}
		} else {
	...
	if r.upstreamSpeedGte != nil {
		...
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "upstream_speed__gte", s.Index(i), "multi")
			}
		} else {
	...
	if r.upstreamSpeedLt != nil {
		...
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "upstream_speed__lt", s.Index(i), "multi")
			}
		} else {
	...
	if r.upstreamSpeedLte != nil {
		...
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "upstream_speed__lte", s.Index(i), "multi")
			}
		} else {
	...
	if r.upstreamSpeedN != nil {
		...
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "upstream_speed__n", s.Index(i), "multi")
			}
		} else {
	...
	if r.xconnectId != nil {
		...
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "xconnect_id", s.Index(i), "multi")
			}
		} else {
	...
	if r.xconnectIdEmpty != nil {
		...
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "xconnect_id__empty", s.Index(i), "multi")
			}
		} else {
			parameterAddToHeaderOrQuery(localVarQueryParams, "xconnect_id__empty", t, "multi")
		}
	}
	if r.xconnectIdIc != nil {
		...
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "xconnect_id__ic", s.Index(i), "multi")
			}
		} else {
	...
	if r.xconnectIdIe != nil {
		...
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "xconnect_id__ie", s.Index(i), "multi")
			}
		} else {
	...
	if r.xconnectIdIew != nil {
		...
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "xconnect_id__iew", s.Index(i), "multi")
			}
		} else {
	...
	if r.xconnectIdIsw != nil {
		...
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "xconnect_id__isw", s.Index(i), "multi")
			}
		} else {
	...
	if r.xconnectIdN != nil {
		...
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "xconnect_id__n", s.Index(i), "multi")
			}
		} else {
	...
	if r.xconnectIdNic != nil {
		...
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "xconnect_id__nic", s.Index(i), "multi")
			}
		} else {
	...
	if r.xconnectIdNie != nil {
		...
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "xconnect_id__nie", s.Index(i), "multi")
			}
		} else {
	...
	if r.xconnectIdNiew != nil {
		...
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "xconnect_id__niew", s.Index(i), "multi")
			}
		} else {
	...
	if r.xconnectIdNisw != nil {
		...
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "xconnect_id__nisw", s.Index(i), "multi")
			}
		} else {
...
func (r ApiCircuitsCircuitTypesListRequest) DescriptionEmpty(descriptionEmpty []string) ApiCircuitsCircuitTypesListRequest {
	r.descriptionEmpty = &descriptionEmpty
	return r
}
...
func (a *CircuitsApiService) CircuitsCircuitTypesListExecute(r ApiCircuitsCircuitTypesListRequest) (*PaginatedCircuitTypeList, *http.Response, error) {
	...
	if r.nameEmpty != nil {
		...
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "name__empty", s.Index(i), "multi")
			}
		} else {
			parameterAddToHeaderOrQuery(localVarQueryParams, "name__empty", t, "multi")
		}
	}
	if r.nameIc != nil {
		t := *r.nameIc
	...
	if r.slugEmpty != nil {
		...
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "slug__empty", s.Index(i), "multi")
			}
		} else {
			parameterAddToHeaderOrQuery(localVarQueryParams, "slug__empty", t, "multi")
		}
	}
	if r.slugIc != nil {
		t := *r.slugIc
...
func (r ApiCircuitsCircuitsListRequest) DescriptionEmpty(descriptionEmpty []string) ApiCircuitsCircuitsListRequest {
	r.descriptionEmpty = &descriptionEmpty
	return r
}
...
func (a *CircuitsApiService) CircuitsCircuitsListExecute(r ApiCircuitsCircuitsListRequest) (*PaginatedCircuitList, *http.Response, error) {
	...
	if r.cid != nil {
		...
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "cid", s.Index(i), "multi")
			}
		} else {
	...
	if r.cidEmpty != nil {
		...
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "cid__empty", s.Index(i), "multi")
			}
		} else {
			parameterAddToHeaderOrQuery(localVarQueryParams, "cid__empty", t, "multi")
		}
	}
	if r.cidIc != nil {
		t := *r.cidIc
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "cid__ic", s.Index(i), "multi")
			}
		} else {
	...
	if r.cidIe != nil {
		...
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "cid__ie", s.Index(i), "multi")
			}
		} else {
	...
	if r.cidIew != nil {
		...
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "cid__iew", s.Index(i), "multi")
			}
		} else {
	...
	if r.cidIsw != nil {
		...
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "cid__isw", s.Index(i), "multi")
			}
		} else {
	...
	if r.cidN != nil {
		...
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "cid__n", s.Index(i), "multi")
			}
		} else {
	...
	if r.cidNic != nil {
		...
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "cid__nic", s.Index(i), "multi")
			}
		} else {
	...
	if r.cidNie != nil {
		...
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "cid__nie", s.Index(i), "multi")
			}
		} else {
	...
	if r.cidNiew != nil {
		...
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "cid__niew", s.Index(i), "multi")
			}
		} else {
	...
	if r.cidNisw != nil {
		...
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "cid__nisw", s.Index(i), "multi")
			}
		} else {
	...
	if r.commitRate != nil {
		...
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "commit_rate", s.Index(i), "multi")
			}
		} else {
	...
	if r.commitRateGt != nil {
		...
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "commit_rate__gt", s.Index(i), "multi")
			}
		} else {
	...
	if r.commitRateGte != nil {
		...
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "commit_rate__gte", s.Index(i), "multi")
			}
		} else {
	...
	if r.commitRateLt != nil {
		...
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "commit_rate__lt", s.Index(i), "multi")
			}
		} else {
	...
	if r.commitRateLte != nil {
		...
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "commit_rate__lte", s.Index(i), "multi")
			}
		} else {
	...
	if r.commitRateN != nil {
		...
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "commit_rate__n", s.Index(i), "multi")
			}
		} else {
	...
	if r.installDate != nil {
		...
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "install_date", s.Index(i), "multi")
			}
		} else {
	...
	if r.installDateGt != nil {
		...
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "install_date__gt", s.Index(i), "multi")
			}
		} else {
	...
	if r.installDateGte != nil {
		...
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "install_date__gte", s.Index(i), "multi")
			}
		} else {
	...
	if r.installDateLt != nil {
		...
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "install_date__lt", s.Index(i), "multi")
			}
		} else {
	...
	if r.installDateLte != nil {
		...
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "install_date__lte", s.Index(i), "multi")
			}
		} else {
	...
	if r.installDateN != nil {
		...
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "install_date__n", s.Index(i), "multi")
			}
		} else {
	...
	if r.providerN != nil {
		...
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "provider__n", s.Index(i), "multi")
			}
		} else {
	...
	if r.providerAccountId != nil {
		...
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "provider_account_id", s.Index(i), "multi")
			}
		} else {
	...
	if r.providerAccountIdN != nil {
		...
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "provider_account_id__n", s.Index(i), "multi")
			}
		} else {
	...
	if r.providerId != nil {
		...
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "provider_id", s.Index(i), "multi")
			}
		} else {
	...
	if r.providerIdN != nil {
		...
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "provider_id__n", s.Index(i), "multi")
			}
		} else {
	...
	if r.terminationDate != nil {
		...
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "termination_date", s.Index(i), "multi")
			}
		} else {
	...
	if r.terminationDateGt != nil {
		...
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "termination_date__gt", s.Index(i), "multi")
			}
		} else {
	...
	if r.terminationDateGte != nil {
		...
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "termination_date__gte", s.Index(i), "multi")
			}
		} else {
	...
	if r.terminationDateLt != nil {
		...
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "termination_date__lt", s.Index(i), "multi")
			}
		} else {
	...
	if r.terminationDateLte != nil {
		...
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "termination_date__lte", s.Index(i), "multi")
			}
		} else {
	...
	if r.terminationDateN != nil {
		...
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "termination_date__n", s.Index(i), "multi")
			}
		} else {
...
func (r ApiCircuitsProviderAccountsListRequest) AccountEmpty(accountEmpty []string) ApiCircuitsProviderAccountsListRequest {
...
func (r ApiCircuitsProviderAccountsListRequest) DescriptionEmpty(descriptionEmpty []string) ApiCircuitsProviderAccountsListRequest {
	r.descriptionEmpty = &descriptionEmpty
	return r
}
...
func (r ApiCircuitsProviderAccountsListRequest) NameEmpty(nameEmpty []string) ApiCircuitsProviderAccountsListRequest {
	r.nameEmpty = &nameEmpty
	return r
}
...
func (a *CircuitsApiService) CircuitsProviderAccountsListExecute(r ApiCircuitsProviderAccountsListRequest) (*PaginatedProviderAccountList, *http.Response, error) {
	...
	if r.account != nil {
		...
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "account", s.Index(i), "multi")
			}
		} else {
	...
	if r.accountEmpty != nil {
		...
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "account__empty", s.Index(i), "multi")
			}
		} else {
			parameterAddToHeaderOrQuery(localVarQueryParams, "account__empty", t, "multi")
		}
	}
	if r.accountIc != nil {
		t := *r.accountIc
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "account__ic", s.Index(i), "multi")
			}
		} else {
	...
	if r.accountIe != nil {
		...
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "account__ie", s.Index(i), "multi")
			}
		} else {
	...
	if r.accountIew != nil {
		...
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "account__iew", s.Index(i), "multi")
			}
		} else {
	...
	if r.accountIsw != nil {
		...
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "account__isw", s.Index(i), "multi")
			}
		} else {
	...
	if r.accountN != nil {
		...
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "account__n", s.Index(i), "multi")
			}
		} else {
	...
	if r.accountNic != nil {
		...
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "account__nic", s.Index(i), "multi")
			}
		} else {
	...
	if r.accountNie != nil {
		...
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "account__nie", s.Index(i), "multi")
			}
		} else {
	...
	if r.accountNiew != nil {
		...
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "account__niew", s.Index(i), "multi")
			}
		} else {
	...
	if r.accountNisw != nil {
		...
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "account__nisw", s.Index(i), "multi")
			}
		} else {
...
func (r ApiCircuitsProviderNetworksListRequest) DescriptionEmpty(descriptionEmpty []string) ApiCircuitsProviderNetworksListRequest {
	r.descriptionEmpty = &descriptionEmpty
	return r
}
...
func (r ApiCircuitsProviderNetworksListRequest) ServiceIdEmpty(serviceIdEmpty []string) ApiCircuitsProviderNetworksListRequest {
...
func (a *CircuitsApiService) CircuitsProviderNetworksListExecute(r ApiCircuitsProviderNetworksListRequest) (*PaginatedProviderNetworkList, *http.Response, error) {
	...
	if r.serviceId != nil {
		...
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "service_id", s.Index(i), "multi")
			}
		} else {
	...
	if r.serviceIdEmpty != nil {
		...
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "service_id__empty", s.Index(i), "multi")
			}
		} else {
			parameterAddToHeaderOrQuery(localVarQueryParams, "service_id__empty", t, "multi")
		}
	}
	if r.serviceIdIc != nil {
		...
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "service_id__ic", s.Index(i), "multi")
			}
		} else {
	...
	if r.serviceIdIe != nil {
		...
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "service_id__ie", s.Index(i), "multi")
			}
		} else {
	...
	if r.serviceIdIew != nil {
		...
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "service_id__iew", s.Index(i), "multi")
			}
		} else {
	...
	if r.serviceIdIsw != nil {
		...
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "service_id__isw", s.Index(i), "multi")
			}
		} else {
	...
	if r.serviceIdN != nil {
		...
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "service_id__n", s.Index(i), "multi")
			}
		} else {
	...
	if r.serviceIdNic != nil {
		...
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "service_id__nic", s.Index(i), "multi")
			}
		} else {
	...
	if r.serviceIdNie != nil {
		...
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "service_id__nie", s.Index(i), "multi")
			}
		} else {
	...
	if r.serviceIdNiew != nil {
		...
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "service_id__niew", s.Index(i), "multi")
			}
		} else {
	...
	if r.serviceIdNisw != nil {
		...
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "service_id__nisw", s.Index(i), "multi")
			}
		} else {
...
func (a *CircuitsApiService) CircuitsProvidersListExecute(r ApiCircuitsProvidersListRequest) (*PaginatedProviderList, *http.Response, error) {
	...
	if r.asnId != nil {
		...
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "asn_id", s.Index(i), "multi")
			}
		} else {
	...
	if r.asnIdN != nil {
		...
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "asn_id__n", s.Index(i), "multi")
			}
		} else {
