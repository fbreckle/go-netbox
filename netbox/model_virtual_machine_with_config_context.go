...
func (o *VirtualMachineWithConfigContext) GetStatus() CableStatus {
...
// and a boolean to check if the value has been set.
func (o *VirtualMachineWithConfigContext) GetStatusOk() (*CableStatus, bool) {
	if o == nil || IsNil(o.Status) {
		return nil, false
	}
...
func (o *VirtualMachineWithConfigContext) SetStatus(v CableStatus) {
	o.Status = &v
}
