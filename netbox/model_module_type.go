...
func (o *ModuleType) GetWeightUnit() CableLengthUnit {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *ModuleType) GetWeightUnitOk() (*CableLengthUnit, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ModuleType) SetWeightUnit(v CableLengthUnit) {
	o.WeightUnit.Set(&v)
}
