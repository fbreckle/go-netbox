...
func (o *PowerOutlet) GetType() CableLengthUnit {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *PowerOutlet) GetTypeOk() (*CableLengthUnit, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *PowerOutlet) SetType(v CableLengthUnit) {
	o.Type.Set(&v)
}
...
func (o *PowerOutlet) GetFeedLeg() CableLengthUnit {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *PowerOutlet) GetFeedLegOk() (*CableLengthUnit, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *PowerOutlet) SetFeedLeg(v CableLengthUnit) {
	o.FeedLeg.Set(&v)
}
