...
func (o *WirelessWirelessLansListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *WirelessWirelessLansListOK) Error() string {
	...
	return fmt.Sprintf("[GET /wireless/wireless-lans/][%d] wirelessWirelessLansListOK %s", 200, payload)
}
...
func (o *WirelessWirelessLansListDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /wireless/wireless-lans/][%d] wireless_wireless_lans_list default %s", o._statusCode, payload)
}
...
func (o *WirelessWirelessLansListDefault) GetPayload() any {
	return o.Payload
}
