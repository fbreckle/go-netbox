...
func (o *WirelessWirelessLinksUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *WirelessWirelessLinksUpdateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /wireless/wireless-links/{id}/][%d] wireless_wireless_links_update default %s", o._statusCode, payload)
}
...
func (o *WirelessWirelessLinksUpdateDefault) GetPayload() any {
	return o.Payload
}
