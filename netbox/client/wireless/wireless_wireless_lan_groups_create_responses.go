...
func (o *WirelessWirelessLanGroupsCreateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *WirelessWirelessLanGroupsCreateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /wireless/wireless-lan-groups/][%d] wireless_wireless_lan_groups_create default %s", o._statusCode, payload)
}
...
func (o *WirelessWirelessLanGroupsCreateDefault) GetPayload() any {
	return o.Payload
}
