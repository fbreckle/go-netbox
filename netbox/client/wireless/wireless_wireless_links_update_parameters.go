...
func NewWirelessWirelessLinksUpdateParams() *WirelessWirelessLinksUpdateParams {
	return NewWirelessWirelessLinksUpdateParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [WirelessWirelessLinksUpdateParams].
