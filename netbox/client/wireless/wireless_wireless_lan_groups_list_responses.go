...
func (o *WirelessWirelessLanGroupsListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *WirelessWirelessLanGroupsListDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /wireless/wireless-lan-groups/][%d] wireless_wireless_lan_groups_list default %s", o._statusCode, payload)
}
...
func (o *WirelessWirelessLanGroupsListDefault) GetPayload() any {
	return o.Payload
}
