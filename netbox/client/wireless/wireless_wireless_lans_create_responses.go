...
func (o *WirelessWirelessLansCreateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *WirelessWirelessLansCreateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /wireless/wireless-lans/][%d] wireless_wireless_lans_create default %s", o._statusCode, payload)
}
...
func (o *WirelessWirelessLansCreateDefault) GetPayload() any {
	return o.Payload
}
