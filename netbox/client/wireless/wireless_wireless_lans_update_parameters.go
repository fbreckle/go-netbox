...
func NewWirelessWirelessLansUpdateParams() *WirelessWirelessLansUpdateParams {
	return NewWirelessWirelessLansUpdateParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [WirelessWirelessLansUpdateParams].
