...
func NewWirelessWirelessLinksCreateParams() *WirelessWirelessLinksCreateParams {
	return NewWirelessWirelessLinksCreateParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [WirelessWirelessLinksCreateParams].
