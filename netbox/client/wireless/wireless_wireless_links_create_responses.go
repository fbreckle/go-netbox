...
func (o *WirelessWirelessLinksCreateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *WirelessWirelessLinksCreateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /wireless/wireless-links/][%d] wireless_wireless_links_create default %s", o._statusCode, payload)
}
...
func (o *WirelessWirelessLinksCreateDefault) GetPayload() any {
	return o.Payload
}
