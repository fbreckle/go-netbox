...
func NewWirelessWirelessLanGroupsPartialUpdateParams() *WirelessWirelessLanGroupsPartialUpdateParams {
	return NewWirelessWirelessLanGroupsPartialUpdateParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [WirelessWirelessLanGroupsPartialUpdateParams].
