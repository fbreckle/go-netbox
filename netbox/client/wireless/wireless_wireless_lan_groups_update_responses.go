...
func (o *WirelessWirelessLanGroupsUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *WirelessWirelessLanGroupsUpdateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /wireless/wireless-lan-groups/{id}/][%d] wireless_wireless_lan_groups_update default %s", o._statusCode, payload)
}
...
func (o *WirelessWirelessLanGroupsUpdateDefault) GetPayload() any {
	return o.Payload
}
