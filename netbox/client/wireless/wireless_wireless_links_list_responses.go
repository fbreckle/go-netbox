...
func (o *WirelessWirelessLinksListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *WirelessWirelessLinksListDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /wireless/wireless-links/][%d] wireless_wireless_links_list default %s", o._statusCode, payload)
}
...
func (o *WirelessWirelessLinksListDefault) GetPayload() any {
	return o.Payload
}
