...
func NewWirelessWirelessLanGroupsCreateParams() *WirelessWirelessLanGroupsCreateParams {
	return NewWirelessWirelessLanGroupsCreateParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [WirelessWirelessLanGroupsCreateParams].
