...
func (o *WirelessWirelessLansPartialUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *WirelessWirelessLansPartialUpdateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PATCH /wireless/wireless-lans/{id}/][%d] wireless_wireless_lans_partial_update default %s", o._statusCode, payload)
}
...
func (o *WirelessWirelessLansPartialUpdateDefault) GetPayload() any {
	return o.Payload
}
