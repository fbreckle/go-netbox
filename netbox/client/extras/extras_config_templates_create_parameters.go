...
// NewExtrasConfigTemplatesCreateParams creates a new ExtrasConfigTemplatesCreateParams object,
...
func NewExtrasConfigTemplatesCreateParams() *ExtrasConfigTemplatesCreateParams {
	return NewExtrasConfigTemplatesCreateParamsWithTimeout(cr.DefaultTimeout)
}

// NewExtrasConfigTemplatesCreateParamsWithTimeout creates a new ExtrasConfigTemplatesCreateParams object
// with the ability to set a timeout on a request.
func NewExtrasConfigTemplatesCreateParamsWithTimeout(timeout time.Duration) *ExtrasConfigTemplatesCreateParams {
	return &ExtrasConfigTemplatesCreateParams{
		inner: innerParams{
			timeout: timeout,
		},
	}
...
// NewExtrasConfigTemplatesCreateParamsWithContext creates a new ExtrasConfigTemplatesCreateParams object
// with the ability to set a context for a request.
//
// Deprecated: use the operation call with context to pass the context instead of [ExtrasConfigTemplatesCreateParams].
...
// NewExtrasConfigTemplatesCreateParamsWithHTTPClient creates a new ExtrasConfigTemplatesCreateParams object
...
ExtrasConfigTemplatesCreateParams contains all the parameters to send to the API endpoint
	...
	for the extras config templates create operation.

	Typically these are written to a http.Request.
*/
type ExtrasConfigTemplatesCreateParams struct {
