...
func NewExtrasImageAttachmentsCreateParams() *ExtrasImageAttachmentsCreateParams {
	return NewExtrasImageAttachmentsCreateParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [ExtrasImageAttachmentsCreateParams].
