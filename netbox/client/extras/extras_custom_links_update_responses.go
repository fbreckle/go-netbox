...
func (o *ExtrasCustomLinksUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *ExtrasCustomLinksUpdateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /extras/custom-links/{id}/][%d] extras_custom_links_update default %s", o._statusCode, payload)
}
...
func (o *ExtrasCustomLinksUpdateDefault) GetPayload() any {
	return o.Payload
}
