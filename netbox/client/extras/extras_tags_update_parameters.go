...
func NewExtrasTagsUpdateParams() *ExtrasTagsUpdateParams {
	return NewExtrasTagsUpdateParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [ExtrasTagsUpdateParams].
...
func (o *ExtrasTagsUpdateParams) WithData(data *models.WritableTag) *ExtrasTagsUpdateParams {
	o.SetData(data)
	return o
}

// SetData adds the data to the extras tags update params.
func (o *ExtrasTagsUpdateParams) SetData(data *models.WritableTag) {
	o.Data = data
}
