...
// NewExtrasConfigTemplatesUpdateParams creates a new ExtrasConfigTemplatesUpdateParams object,
...
func NewExtrasConfigTemplatesUpdateParams() *ExtrasConfigTemplatesUpdateParams {
	return NewExtrasConfigTemplatesUpdateParamsWithTimeout(cr.DefaultTimeout)
}

// NewExtrasConfigTemplatesUpdateParamsWithTimeout creates a new ExtrasConfigTemplatesUpdateParams object
// with the ability to set a timeout on a request.
func NewExtrasConfigTemplatesUpdateParamsWithTimeout(timeout time.Duration) *ExtrasConfigTemplatesUpdateParams {
	return &ExtrasConfigTemplatesUpdateParams{
		inner: innerParams{
			timeout: timeout,
		},
	}
...
// NewExtrasConfigTemplatesUpdateParamsWithContext creates a new ExtrasConfigTemplatesUpdateParams object
// with the ability to set a context for a request.
//
// Deprecated: use the operation call with context to pass the context instead of [ExtrasConfigTemplatesUpdateParams].
...
// NewExtrasConfigTemplatesUpdateParamsWithHTTPClient creates a new ExtrasConfigTemplatesUpdateParams object
...
ExtrasConfigTemplatesUpdateParams contains all the parameters to send to the API endpoint
	...
	for the extras config templates update operation.

	Typically these are written to a http.Request.
*/
type ExtrasConfigTemplatesUpdateParams struct {
