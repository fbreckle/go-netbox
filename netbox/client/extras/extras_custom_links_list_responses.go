...
func (o *ExtrasCustomLinksListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *ExtrasCustomLinksListDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /extras/custom-links/][%d] extras_custom_links_list default %s", o._statusCode, payload)
}
...
func (o *ExtrasCustomLinksListDefault) GetPayload() any {
	return o.Payload
}
