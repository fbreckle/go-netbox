...
func (o *ExtrasImageAttachmentsCreateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *ExtrasImageAttachmentsCreateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /extras/image-attachments/][%d] extras_image_attachments_create default %s", o._statusCode, payload)
}
...
func (o *ExtrasImageAttachmentsCreateDefault) GetPayload() any {
	return o.Payload
}
