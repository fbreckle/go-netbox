...
func (o *ExtrasExportTemplatesUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *ExtrasExportTemplatesUpdateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /extras/export-templates/{id}/][%d] extras_export_templates_update default %s", o._statusCode, payload)
}
...
func (o *ExtrasExportTemplatesUpdateDefault) GetPayload() any {
	return o.Payload
}
