...
func NewExtrasEventRulesPartialUpdateParams() *ExtrasEventRulesPartialUpdateParams {
	return NewExtrasEventRulesPartialUpdateParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [ExtrasEventRulesPartialUpdateParams].
...
func (o *ExtrasEventRulesPartialUpdateParams) WithData(data *models.WritableEventRule) *ExtrasEventRulesPartialUpdateParams {
	o.SetData(data)
	return o
}

// SetData adds the data to the extras event rules partial update params.
func (o *ExtrasEventRulesPartialUpdateParams) SetData(data *models.WritableEventRule) {
	o.Data = data
}
