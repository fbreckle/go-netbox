...
func (o *ExtrasJournalEntriesCreateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *ExtrasJournalEntriesCreateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /extras/journal-entries/][%d] extras_journal_entries_create default %s", o._statusCode, payload)
}
...
func (o *ExtrasJournalEntriesCreateDefault) GetPayload() any {
	return o.Payload
}
