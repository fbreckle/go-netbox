...
func (o *ExtrasWebhooksCreateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *ExtrasWebhooksCreateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /extras/webhooks/][%d] extras_webhooks_create default %s", o._statusCode, payload)
}
...
func (o *ExtrasWebhooksCreateDefault) GetPayload() any {
	return o.Payload
}
