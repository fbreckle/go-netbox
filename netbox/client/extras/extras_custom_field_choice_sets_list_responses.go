...
func (o *ExtrasCustomFieldChoiceSetsListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	switch response.Code() {
	case 200:
		result := NewExtrasCustomFieldChoiceSetsListOK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	default:
		result := NewExtrasCustomFieldChoiceSetsListDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewExtrasCustomFieldChoiceSetsListOK() *ExtrasCustomFieldChoiceSetsListOK {
	return &ExtrasCustomFieldChoiceSetsListOK{}
}
...
func (o *ExtrasCustomFieldChoiceSetsListOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(ExtrasCustomFieldChoiceSetsListOKBody)
...
func NewExtrasCustomFieldChoiceSetsListDefault(code int) *ExtrasCustomFieldChoiceSetsListDefault {
	return &ExtrasCustomFieldChoiceSetsListDefault{
		_statusCode: code,
	}
}
...
type ExtrasCustomFieldChoiceSetsListDefault struct {
	_statusCode int
...
func (o *ExtrasCustomFieldChoiceSetsListDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /extras/custom-field-choice-sets/][%d] extras_custom_field_choice_sets_list default %s", o._statusCode, payload)
}
...
func (o *ExtrasCustomFieldChoiceSetsListDefault) GetPayload() any {
	return o.Payload
}

func (o *ExtrasCustomFieldChoiceSetsListDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
// ExtrasCustomFieldChoiceSetsListOKBody extras custom field choice sets list o k body
//
// swagger:model ExtrasCustomFieldChoiceSetsListOKBody
type ExtrasCustomFieldChoiceSetsListOKBody struct {
	...
	// results
	// Required: true
	Results []*models.CustomFieldChoiceSet `json:"results"`
}

// Validate validates this extras custom field choice sets list o k body
...
func (o *ExtrasCustomFieldChoiceSetsListOKBody) validateCount(formats strfmt.Registry) error {

	if err := validate.Required("extrasCustomFieldChoiceSetsListOK"+"."+"count", "body", o.Count); err != nil {
		return err
	}
...
func (o *ExtrasCustomFieldChoiceSetsListOKBody) validateNext(formats strfmt.Registry) error {
	if typeutils.IsZero(o.Next) { // not required
		return nil
	}

	if err := validate.FormatOf("extrasCustomFieldChoiceSetsListOK"+"."+"next", "body", "uri", o.Next.String(), formats); err != nil {
		return err
	}
...
func (o *ExtrasCustomFieldChoiceSetsListOKBody) validatePrevious(formats strfmt.Registry) error {
	if typeutils.IsZero(o.Previous) { // not required
		return nil
	}

	if err := validate.FormatOf("extrasCustomFieldChoiceSetsListOK"+"."+"previous", "body", "uri", o.Previous.String(), formats); err != nil {
		return err
	}
...
func (o *ExtrasCustomFieldChoiceSetsListOKBody) validateResults(formats strfmt.Registry) error {

	if err := validate.Required("extrasCustomFieldChoiceSetsListOK"+"."+"results", "body", o.Results); err != nil {
		return err
	}
		...
		if o.Results[i] != nil {
			if err := o.Results[i].Validate(formats); err != nil {
				...
				if stderrors.As(err, &ve) {
					return ve.ValidateName("extrasCustomFieldChoiceSetsListOK" + "." + "results" + "." + strconv.Itoa(i))
				}
				ce := new(errors.CompositeError)
				if stderrors.As(err, &ce) {
					return ce.ValidateName("extrasCustomFieldChoiceSetsListOK" + "." + "results" + "." + strconv.Itoa(i))
				}
...
func (o *ExtrasCustomFieldChoiceSetsListOKBody) contextValidateResults(ctx context.Context, formats strfmt.Registry) error {
...
func (o *ExtrasCustomFieldChoiceSetsListOKBody) UnmarshalBinary(b []byte) error {
	var res ExtrasCustomFieldChoiceSetsListOKBody
