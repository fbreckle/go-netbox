...
func (o *ExtrasSavedFiltersUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *ExtrasSavedFiltersUpdateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /extras/saved-filters/{id}/][%d] extras_saved_filters_update default %s", o._statusCode, payload)
}
...
func (o *ExtrasSavedFiltersUpdateDefault) GetPayload() any {
	return o.Payload
}
