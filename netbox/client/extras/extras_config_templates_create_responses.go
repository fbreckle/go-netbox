...
func (o *ExtrasConfigTemplatesCreateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *ExtrasConfigTemplatesCreateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /extras/config-templates/][%d] extras_config_templates_create default %s", o._statusCode, payload)
}
...
func (o *ExtrasConfigTemplatesCreateDefault) GetPayload() any {
	return o.Payload
}
