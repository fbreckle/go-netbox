...
func (o *ExtrasEventRulesCreateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 201:
		...
		return result, nil
	default:
		result := NewExtrasEventRulesCreateDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewExtrasEventRulesCreateDefault(code int) *ExtrasEventRulesCreateDefault {
	return &ExtrasEventRulesCreateDefault{
		_statusCode: code,
	}
}
...
type ExtrasEventRulesCreateDefault struct {
	_statusCode int
...
func (o *ExtrasEventRulesCreateDefault) GetPayload() any {
	return o.Payload
}

func (o *ExtrasEventRulesCreateDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
