...
func (o *ExtrasImageAttachmentsUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *ExtrasImageAttachmentsUpdateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /extras/image-attachments/{id}/][%d] extras_image_attachments_update default %s", o._statusCode, payload)
}
...
func (o *ExtrasImageAttachmentsUpdateDefault) GetPayload() any {
	return o.Payload
}
