...
func (o *ExtrasConfigTemplatesPartialUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *ExtrasConfigTemplatesPartialUpdateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PATCH /extras/config-templates/{id}/][%d] extras_config_templates_partial_update default %s", o._statusCode, payload)
}
...
func (o *ExtrasConfigTemplatesPartialUpdateDefault) GetPayload() any {
	return o.Payload
}
