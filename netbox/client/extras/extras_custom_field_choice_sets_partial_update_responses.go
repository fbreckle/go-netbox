...
func (o *ExtrasCustomFieldChoiceSetsPartialUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *ExtrasCustomFieldChoiceSetsPartialUpdateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PATCH /extras/custom-field-choice-sets/{id}/][%d] extras_custom_field_choice_sets_partial_update default %s", o._statusCode, payload)
}
...
func (o *ExtrasCustomFieldChoiceSetsPartialUpdateDefault) GetPayload() any {
	return o.Payload
}
