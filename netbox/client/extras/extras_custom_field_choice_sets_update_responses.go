...
func (o *ExtrasCustomFieldChoiceSetsUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *ExtrasCustomFieldChoiceSetsUpdateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /extras/custom-field-choice-sets/{id}/][%d] extras_custom_field_choice_sets_update default %s", o._statusCode, payload)
}
...
func (o *ExtrasCustomFieldChoiceSetsUpdateDefault) GetPayload() any {
	return o.Payload
}
