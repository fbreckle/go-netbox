...
func (o *ExtrasConfigContextsCreateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *ExtrasConfigContextsCreateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /extras/config-contexts/][%d] extras_config_contexts_create default %s", o._statusCode, payload)
}
...
func (o *ExtrasConfigContextsCreateDefault) GetPayload() any {
	return o.Payload
}
