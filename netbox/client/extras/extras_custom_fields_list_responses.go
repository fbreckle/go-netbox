...
func (o *ExtrasCustomFieldsListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *ExtrasCustomFieldsListOK) Error() string {
	...
	return fmt.Sprintf("[GET /extras/custom-fields/][%d] extrasCustomFieldsListOK %s", 200, payload)
}
...
func (o *ExtrasCustomFieldsListDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /extras/custom-fields/][%d] extras_custom_fields_list default %s", o._statusCode, payload)
}
...
func (o *ExtrasCustomFieldsListDefault) GetPayload() any {
	return o.Payload
}
