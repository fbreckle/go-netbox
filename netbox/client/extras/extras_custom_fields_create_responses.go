...
func (o *ExtrasCustomFieldsCreateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *ExtrasCustomFieldsCreateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /extras/custom-fields/][%d] extras_custom_fields_create default %s", o._statusCode, payload)
}
...
func (o *ExtrasCustomFieldsCreateDefault) GetPayload() any {
	return o.Payload
}
