...
func (o *ExtrasConfigContextsUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *ExtrasConfigContextsUpdateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /extras/config-contexts/{id}/][%d] extras_config_contexts_update default %s", o._statusCode, payload)
}
...
func (o *ExtrasConfigContextsUpdateDefault) GetPayload() any {
	return o.Payload
}
