...
func (o *ExtrasConfigContextsListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *ExtrasConfigContextsListDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /extras/config-contexts/][%d] extras_config_contexts_list default %s", o._statusCode, payload)
}
...
func (o *ExtrasConfigContextsListDefault) GetPayload() any {
	return o.Payload
}
