...
func NewExtrasCustomLinksUpdateParams() *ExtrasCustomLinksUpdateParams {
	return NewExtrasCustomLinksUpdateParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [ExtrasCustomLinksUpdateParams].
...
func (o *ExtrasCustomLinksUpdateParams) WithData(data *models.WritableCustomLink) *ExtrasCustomLinksUpdateParams {
	o.SetData(data)
	return o
}

// SetData adds the data to the extras custom links update params.
func (o *ExtrasCustomLinksUpdateParams) SetData(data *models.WritableCustomLink) {
	o.Data = data
}
