...
func (o *ExtrasCustomFieldsUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *ExtrasCustomFieldsUpdateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /extras/custom-fields/{id}/][%d] extras_custom_fields_update default %s", o._statusCode, payload)
}
...
func (o *ExtrasCustomFieldsUpdateDefault) GetPayload() any {
	return o.Payload
}
