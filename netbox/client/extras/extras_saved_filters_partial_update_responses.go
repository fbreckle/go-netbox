...
func (o *ExtrasSavedFiltersPartialUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *ExtrasSavedFiltersPartialUpdateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PATCH /extras/saved-filters/{id}/][%d] extras_saved_filters_partial_update default %s", o._statusCode, payload)
}
...
func (o *ExtrasSavedFiltersPartialUpdateDefault) GetPayload() any {
	return o.Payload
}
