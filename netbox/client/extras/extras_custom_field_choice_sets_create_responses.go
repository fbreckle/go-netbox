...
func (o *ExtrasCustomFieldChoiceSetsCreateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *ExtrasCustomFieldChoiceSetsCreateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /extras/custom-field-choice-sets/][%d] extras_custom_field_choice_sets_create default %s", o._statusCode, payload)
}
...
func (o *ExtrasCustomFieldChoiceSetsCreateDefault) GetPayload() any {
	return o.Payload
}
