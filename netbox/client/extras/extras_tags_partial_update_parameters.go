...
func NewExtrasTagsPartialUpdateParams() *ExtrasTagsPartialUpdateParams {
	return NewExtrasTagsPartialUpdateParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [ExtrasTagsPartialUpdateParams].
...
func (o *ExtrasTagsPartialUpdateParams) WithData(data *models.WritableTag) *ExtrasTagsPartialUpdateParams {
	o.SetData(data)
	return o
}

// SetData adds the data to the extras tags partial update params.
func (o *ExtrasTagsPartialUpdateParams) SetData(data *models.WritableTag) {
	o.Data = data
}
