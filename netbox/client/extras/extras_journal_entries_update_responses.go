...
func (o *ExtrasJournalEntriesUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *ExtrasJournalEntriesUpdateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /extras/journal-entries/{id}/][%d] extras_journal_entries_update default %s", o._statusCode, payload)
}
...
func (o *ExtrasJournalEntriesUpdateDefault) GetPayload() any {
	return o.Payload
}
