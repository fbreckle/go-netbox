...
func (o *ExtrasWebhooksPartialUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *ExtrasWebhooksPartialUpdateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PATCH /extras/webhooks/{id}/][%d] extras_webhooks_partial_update default %s", o._statusCode, payload)
}
...
func (o *ExtrasWebhooksPartialUpdateDefault) GetPayload() any {
	return o.Payload
}
