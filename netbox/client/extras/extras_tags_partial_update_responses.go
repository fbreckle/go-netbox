...
func (o *ExtrasTagsPartialUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *ExtrasTagsPartialUpdateDefault) GetPayload() any {
	return o.Payload
}
