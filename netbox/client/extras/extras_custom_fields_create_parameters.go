...
func NewExtrasCustomFieldsCreateParams() *ExtrasCustomFieldsCreateParams {
	return NewExtrasCustomFieldsCreateParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [ExtrasCustomFieldsCreateParams].
