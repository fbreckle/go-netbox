...
func (o *ExtrasEventRulesUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *ExtrasEventRulesUpdateDefault) GetPayload() any {
	return o.Payload
}
