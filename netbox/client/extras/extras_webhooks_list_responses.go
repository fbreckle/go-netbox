...
func (o *ExtrasWebhooksListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *ExtrasWebhooksListDefault) GetPayload() any {
	return o.Payload
}
