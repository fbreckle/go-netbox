...
func (o *ExtrasExportTemplatesPartialUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *ExtrasExportTemplatesPartialUpdateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PATCH /extras/export-templates/{id}/][%d] extras_export_templates_partial_update default %s", o._statusCode, payload)
}
...
func (o *ExtrasExportTemplatesPartialUpdateDefault) GetPayload() any {
	return o.Payload
}
