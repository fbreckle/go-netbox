...
func (o *ExtrasSavedFiltersCreateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *ExtrasSavedFiltersCreateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /extras/saved-filters/][%d] extras_saved_filters_create default %s", o._statusCode, payload)
}
...
func (o *ExtrasSavedFiltersCreateDefault) GetPayload() any {
	return o.Payload
}
