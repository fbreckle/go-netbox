...
func (o *ExtrasConfigTemplatesListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *ExtrasConfigTemplatesListDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /extras/config-templates/][%d] extras_config_templates_list default %s", o._statusCode, payload)
}
...
func (o *ExtrasConfigTemplatesListDefault) GetPayload() any {
	return o.Payload
}
