...
func (o *ExtrasTagsUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *ExtrasTagsUpdateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /extras/tags/{id}/][%d] extras_tags_update default %s", o._statusCode, payload)
}
...
func (o *ExtrasTagsUpdateDefault) GetPayload() any {
	return o.Payload
}
