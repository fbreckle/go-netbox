...
// NewExtrasEventRulesCreateParams creates a new ExtrasEventRulesCreateParams object,
...
func NewExtrasEventRulesCreateParams() *ExtrasEventRulesCreateParams {
	return NewExtrasEventRulesCreateParamsWithTimeout(cr.DefaultTimeout)
}

// NewExtrasEventRulesCreateParamsWithTimeout creates a new ExtrasEventRulesCreateParams object
// with the ability to set a timeout on a request.
func NewExtrasEventRulesCreateParamsWithTimeout(timeout time.Duration) *ExtrasEventRulesCreateParams {
	return &ExtrasEventRulesCreateParams{
		inner: innerParams{
			timeout: timeout,
		},
	}
...
// NewExtrasEventRulesCreateParamsWithContext creates a new ExtrasEventRulesCreateParams object
// with the ability to set a context for a request.
//
// Deprecated: use the operation call with context to pass the context instead of [ExtrasEventRulesCreateParams].
...
// NewExtrasEventRulesCreateParamsWithHTTPClient creates a new ExtrasEventRulesCreateParams object
...
ExtrasEventRulesCreateParams contains all the parameters to send to the API endpoint
	...
	for the extras event rules create operation.

	Typically these are written to a http.Request.
*/
type ExtrasEventRulesCreateParams struct {
