...
func (o *ExtrasJournalEntriesPartialUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *ExtrasJournalEntriesPartialUpdateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PATCH /extras/journal-entries/{id}/][%d] extras_journal_entries_partial_update default %s", o._statusCode, payload)
}
...
func (o *ExtrasJournalEntriesPartialUpdateDefault) GetPayload() any {
	return o.Payload
}
