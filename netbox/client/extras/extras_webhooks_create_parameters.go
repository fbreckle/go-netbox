...
func NewExtrasWebhooksCreateParams() *ExtrasWebhooksCreateParams {
	return NewExtrasWebhooksCreateParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [ExtrasWebhooksCreateParams].
...
func (o *ExtrasWebhooksCreateParams) WithData(data *models.WritableWebhook) *ExtrasWebhooksCreateParams {
	o.SetData(data)
	return o
}

// SetData adds the data to the extras webhooks create params.
func (o *ExtrasWebhooksCreateParams) SetData(data *models.WritableWebhook) {
	o.Data = data
}
