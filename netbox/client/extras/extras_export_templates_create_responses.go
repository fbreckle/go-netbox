...
func (o *ExtrasExportTemplatesCreateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *ExtrasExportTemplatesCreateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /extras/export-templates/][%d] extras_export_templates_create default %s", o._statusCode, payload)
}
...
func (o *ExtrasExportTemplatesCreateDefault) GetPayload() any {
	return o.Payload
}
