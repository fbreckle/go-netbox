...
// NewExtrasCustomFieldChoiceSetsUpdateParams creates a new ExtrasCustomFieldChoiceSetsUpdateParams object,
...
func NewExtrasCustomFieldChoiceSetsUpdateParams() *ExtrasCustomFieldChoiceSetsUpdateParams {
	return NewExtrasCustomFieldChoiceSetsUpdateParamsWithTimeout(cr.DefaultTimeout)
}

// NewExtrasCustomFieldChoiceSetsUpdateParamsWithTimeout creates a new ExtrasCustomFieldChoiceSetsUpdateParams object
...
func NewExtrasCustomFieldChoiceSetsUpdateParamsWithTimeout(timeout time.Duration) *ExtrasCustomFieldChoiceSetsUpdateParams {
	return &ExtrasCustomFieldChoiceSetsUpdateParams{
		inner: innerParams{
			timeout: timeout,
		},
	}
...
// NewExtrasCustomFieldChoiceSetsUpdateParamsWithContext creates a new ExtrasCustomFieldChoiceSetsUpdateParams object
// with the ability to set a context for a request.
//
// Deprecated: use the operation call with context to pass the context instead of [ExtrasCustomFieldChoiceSetsUpdateParams].
...
// NewExtrasCustomFieldChoiceSetsUpdateParamsWithHTTPClient creates a new ExtrasCustomFieldChoiceSetsUpdateParams object
...
ExtrasCustomFieldChoiceSetsUpdateParams contains all the parameters to send to the API endpoint
	...
	for the extras custom field choice sets update operation.

	Typically these are written to a http.Request.
*/
type ExtrasCustomFieldChoiceSetsUpdateParams struct {
...
func (o *ExtrasCustomFieldChoiceSetsUpdateParams) WithData(data *models.WritableCustomFieldChoiceSet) *ExtrasCustomFieldChoiceSetsUpdateParams {
	o.SetData(data)
	return o
}

// SetData adds the data to the extras custom field choice sets update params.
func (o *ExtrasCustomFieldChoiceSetsUpdateParams) SetData(data *models.WritableCustomFieldChoiceSet) {
	o.Data = data
}
