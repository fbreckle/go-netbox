...
func (o *ExtrasCustomLinksCreateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *ExtrasCustomLinksCreateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /extras/custom-links/][%d] extras_custom_links_create default %s", o._statusCode, payload)
}
...
func (o *ExtrasCustomLinksCreateDefault) GetPayload() any {
	return o.Payload
}
