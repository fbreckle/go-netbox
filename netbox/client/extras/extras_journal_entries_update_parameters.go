...
func NewExtrasJournalEntriesUpdateParams() *ExtrasJournalEntriesUpdateParams {
	return NewExtrasJournalEntriesUpdateParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [ExtrasJournalEntriesUpdateParams].
