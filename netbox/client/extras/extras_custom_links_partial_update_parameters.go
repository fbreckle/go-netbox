...
func NewExtrasCustomLinksPartialUpdateParams() *ExtrasCustomLinksPartialUpdateParams {
	return NewExtrasCustomLinksPartialUpdateParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [ExtrasCustomLinksPartialUpdateParams].
...
func (o *ExtrasCustomLinksPartialUpdateParams) WithData(data *models.WritableCustomLink) *ExtrasCustomLinksPartialUpdateParams {
	o.SetData(data)
	return o
}

// SetData adds the data to the extras custom links partial update params.
func (o *ExtrasCustomLinksPartialUpdateParams) SetData(data *models.WritableCustomLink) {
	o.Data = data
}
