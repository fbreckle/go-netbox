...
func (o *ExtrasConfigTemplatesUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *ExtrasConfigTemplatesUpdateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /extras/config-templates/{id}/][%d] extras_config_templates_update default %s", o._statusCode, payload)
}
...
func (o *ExtrasConfigTemplatesUpdateDefault) GetPayload() any {
	return o.Payload
}
