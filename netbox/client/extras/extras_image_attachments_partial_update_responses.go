...
func (o *ExtrasImageAttachmentsPartialUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *ExtrasImageAttachmentsPartialUpdateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PATCH /extras/image-attachments/{id}/][%d] extras_image_attachments_partial_update default %s", o._statusCode, payload)
}
...
func (o *ExtrasImageAttachmentsPartialUpdateDefault) GetPayload() any {
	return o.Payload
}
