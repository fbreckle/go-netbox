...
func (o *ExtrasSavedFiltersListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *ExtrasSavedFiltersListOK) Error() string {
	...
	return fmt.Sprintf("[GET /extras/saved-filters/][%d] extrasSavedFiltersListOK %s", 200, payload)
}
...
func (o *ExtrasSavedFiltersListDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /extras/saved-filters/][%d] extras_saved_filters_list default %s", o._statusCode, payload)
}
...
func (o *ExtrasSavedFiltersListDefault) GetPayload() any {
	return o.Payload
}
