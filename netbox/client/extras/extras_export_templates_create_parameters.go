...
func NewExtrasExportTemplatesCreateParams() *ExtrasExportTemplatesCreateParams {
	return NewExtrasExportTemplatesCreateParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [ExtrasExportTemplatesCreateParams].
