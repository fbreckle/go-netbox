...
func (o *ExtrasTagsCreateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *ExtrasTagsCreateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /extras/tags/][%d] extras_tags_create default %s", o._statusCode, payload)
}
...
func (o *ExtrasTagsCreateDefault) GetPayload() any {
	return o.Payload
}
