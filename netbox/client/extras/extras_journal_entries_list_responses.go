...
func (o *ExtrasJournalEntriesListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *ExtrasJournalEntriesListDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /extras/journal-entries/][%d] extras_journal_entries_list default %s", o._statusCode, payload)
}
...
func (o *ExtrasJournalEntriesListDefault) GetPayload() any {
	return o.Payload
}
