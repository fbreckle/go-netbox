...
func NewExtrasJournalEntriesCreateParams() *ExtrasJournalEntriesCreateParams {
	return NewExtrasJournalEntriesCreateParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [ExtrasJournalEntriesCreateParams].
