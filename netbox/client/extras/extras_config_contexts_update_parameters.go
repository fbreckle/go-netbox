...
func NewExtrasConfigContextsUpdateParams() *ExtrasConfigContextsUpdateParams {
	return NewExtrasConfigContextsUpdateParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [ExtrasConfigContextsUpdateParams].
