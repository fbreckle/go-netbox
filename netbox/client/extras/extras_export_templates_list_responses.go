...
func (o *ExtrasExportTemplatesListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *ExtrasExportTemplatesListDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /extras/export-templates/][%d] extras_export_templates_list default %s", o._statusCode, payload)
}
...
func (o *ExtrasExportTemplatesListDefault) GetPayload() any {
	return o.Payload
}
