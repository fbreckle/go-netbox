...
func (o *ExtrasCustomFieldsPartialUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *ExtrasCustomFieldsPartialUpdateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PATCH /extras/custom-fields/{id}/][%d] extras_custom_fields_partial_update default %s", o._statusCode, payload)
}
...
func (o *ExtrasCustomFieldsPartialUpdateDefault) GetPayload() any {
	return o.Payload
}
