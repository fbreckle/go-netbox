...
func (o *ExtrasConfigContextsPartialUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *ExtrasConfigContextsPartialUpdateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PATCH /extras/config-contexts/{id}/][%d] extras_config_contexts_partial_update default %s", o._statusCode, payload)
}
...
func (o *ExtrasConfigContextsPartialUpdateDefault) GetPayload() any {
	return o.Payload
}
