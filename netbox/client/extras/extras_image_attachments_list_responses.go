...
func (o *ExtrasImageAttachmentsListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *ExtrasImageAttachmentsListDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /extras/image-attachments/][%d] extras_image_attachments_list default %s", o._statusCode, payload)
}
...
func (o *ExtrasImageAttachmentsListDefault) GetPayload() any {
	return o.Payload
}
