...
func (o *VirtualizationInterfacesPartialUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *VirtualizationInterfacesPartialUpdateDefault) GetPayload() any {
	return o.Payload
}
