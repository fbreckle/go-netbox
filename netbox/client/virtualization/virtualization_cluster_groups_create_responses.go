...
func (o *VirtualizationClusterGroupsCreateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *VirtualizationClusterGroupsCreateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /virtualization/cluster-groups/][%d] virtualization_cluster_groups_create default %s", o._statusCode, payload)
}
...
func (o *VirtualizationClusterGroupsCreateDefault) GetPayload() any {
	return o.Payload
}
