...
func (o *VirtualizationClusterTypesUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *VirtualizationClusterTypesUpdateOK) Error() string {
	...
	return fmt.Sprintf("[PUT /virtualization/cluster-types/{id}/][%d] virtualizationClusterTypesUpdateOK %s", 200, payload)
}
...
func (o *VirtualizationClusterTypesUpdateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /virtualization/cluster-types/{id}/][%d] virtualization_cluster_types_update default %s", o._statusCode, payload)
}
...
func (o *VirtualizationClusterTypesUpdateDefault) GetPayload() any {
	return o.Payload
}
