...
func (o *VirtualizationVirtualDisksUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *VirtualizationVirtualDisksUpdateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /virtualization/virtual-disks/{id}/][%d] virtualization_virtual_disks_update default %s", o._statusCode, payload)
}
...
func (o *VirtualizationVirtualDisksUpdateDefault) GetPayload() any {
	return o.Payload
}
