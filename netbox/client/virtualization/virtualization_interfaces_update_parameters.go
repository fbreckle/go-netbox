...
func NewVirtualizationInterfacesUpdateParams() *VirtualizationInterfacesUpdateParams {
	return NewVirtualizationInterfacesUpdateParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [VirtualizationInterfacesUpdateParams].
