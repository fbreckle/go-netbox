...
func (o *VirtualizationVirtualMachinesUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *VirtualizationVirtualMachinesUpdateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /virtualization/virtual-machines/{id}/][%d] virtualization_virtual_machines_update default %s", o._statusCode, payload)
}
...
func (o *VirtualizationVirtualMachinesUpdateDefault) GetPayload() any {
	return o.Payload
}
