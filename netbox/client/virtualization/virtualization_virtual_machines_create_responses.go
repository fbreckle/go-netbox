...
func (o *VirtualizationVirtualMachinesCreateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *VirtualizationVirtualMachinesCreateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /virtualization/virtual-machines/][%d] virtualization_virtual_machines_create default %s", o._statusCode, payload)
}
...
func (o *VirtualizationVirtualMachinesCreateDefault) GetPayload() any {
	return o.Payload
}
