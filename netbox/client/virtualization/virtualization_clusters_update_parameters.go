...
func NewVirtualizationClustersUpdateParams() *VirtualizationClustersUpdateParams {
	return NewVirtualizationClustersUpdateParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [VirtualizationClustersUpdateParams].
