...
func (o *VirtualizationVirtualMachinesPartialUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *VirtualizationVirtualMachinesPartialUpdateOK) Error() string {
	...
	return fmt.Sprintf("[PATCH /virtualization/virtual-machines/{id}/][%d] virtualizationVirtualMachinesPartialUpdateOK %s", 200, payload)
}
...
func (o *VirtualizationVirtualMachinesPartialUpdateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PATCH /virtualization/virtual-machines/{id}/][%d] virtualization_virtual_machines_partial_update default %s", o._statusCode, payload)
}
...
func (o *VirtualizationVirtualMachinesPartialUpdateDefault) GetPayload() any {
	return o.Payload
}
