...
func (o *VirtualizationInterfacesListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *VirtualizationInterfacesListDefault) GetPayload() any {
	return o.Payload
}
