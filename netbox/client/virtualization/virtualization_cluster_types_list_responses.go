...
func (o *VirtualizationClusterTypesListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
// Code gets the status code for the virtualization cluster types list o k response
func (o *VirtualizationClusterTypesListOK) Code() int {
	return 200
}
...
func (o *VirtualizationClusterTypesListDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /virtualization/cluster-types/][%d] virtualization_cluster_types_list default %s", o._statusCode, payload)
}
...
func (o *VirtualizationClusterTypesListDefault) GetPayload() any {
	return o.Payload
}
