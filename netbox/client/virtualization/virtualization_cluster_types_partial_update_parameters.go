...
func NewVirtualizationClusterTypesPartialUpdateParams() *VirtualizationClusterTypesPartialUpdateParams {
	return NewVirtualizationClusterTypesPartialUpdateParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [VirtualizationClusterTypesPartialUpdateParams].
...
func (o *VirtualizationClusterTypesPartialUpdateParams) WithData(data *models.WritableClusterType) *VirtualizationClusterTypesPartialUpdateParams {
	o.SetData(data)
	return o
}

// SetData adds the data to the virtualization cluster types partial update params.
func (o *VirtualizationClusterTypesPartialUpdateParams) SetData(data *models.WritableClusterType) {
	o.Data = data
}
