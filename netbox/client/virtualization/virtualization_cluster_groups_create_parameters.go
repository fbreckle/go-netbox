...
func NewVirtualizationClusterGroupsCreateParams() *VirtualizationClusterGroupsCreateParams {
	return NewVirtualizationClusterGroupsCreateParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [VirtualizationClusterGroupsCreateParams].
...
func (o *VirtualizationClusterGroupsCreateParams) WithData(data *models.WritableClusterGroup) *VirtualizationClusterGroupsCreateParams {
	o.SetData(data)
	return o
}

// SetData adds the data to the virtualization cluster groups create params.
func (o *VirtualizationClusterGroupsCreateParams) SetData(data *models.WritableClusterGroup) {
	o.Data = data
}
