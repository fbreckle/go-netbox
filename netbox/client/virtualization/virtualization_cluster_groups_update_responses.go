...
func (o *VirtualizationClusterGroupsUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *VirtualizationClusterGroupsUpdateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /virtualization/cluster-groups/{id}/][%d] virtualization_cluster_groups_update default %s", o._statusCode, payload)
}
...
func (o *VirtualizationClusterGroupsUpdateDefault) GetPayload() any {
	return o.Payload
}
