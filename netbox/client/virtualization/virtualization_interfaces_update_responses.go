...
func (o *VirtualizationInterfacesUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *VirtualizationInterfacesUpdateDefault) GetPayload() any {
	return o.Payload
}
