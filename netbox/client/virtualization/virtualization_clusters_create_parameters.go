...
func NewVirtualizationClustersCreateParams() *VirtualizationClustersCreateParams {
	return NewVirtualizationClustersCreateParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [VirtualizationClustersCreateParams].
