...
func (o *VirtualizationVirtualMachinesListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *VirtualizationVirtualMachinesListOK) Error() string {
	...
	return fmt.Sprintf("[GET /virtualization/virtual-machines/][%d] virtualizationVirtualMachinesListOK %s", 200, payload)
}
...
func (o *VirtualizationVirtualMachinesListDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /virtualization/virtual-machines/][%d] virtualization_virtual_machines_list default %s", o._statusCode, payload)
}
...
func (o *VirtualizationVirtualMachinesListDefault) GetPayload() any {
	return o.Payload
}
