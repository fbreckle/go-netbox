...
func (o *VirtualizationClusterGroupsPartialUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *VirtualizationClusterGroupsPartialUpdateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PATCH /virtualization/cluster-groups/{id}/][%d] virtualization_cluster_groups_partial_update default %s", o._statusCode, payload)
}
...
func (o *VirtualizationClusterGroupsPartialUpdateDefault) GetPayload() any {
	return o.Payload
}
