...
func NewVirtualizationClusterTypesCreateParams() *VirtualizationClusterTypesCreateParams {
	return NewVirtualizationClusterTypesCreateParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [VirtualizationClusterTypesCreateParams].
...
func (o *VirtualizationClusterTypesCreateParams) WithData(data *models.WritableClusterType) *VirtualizationClusterTypesCreateParams {
	o.SetData(data)
	return o
}

// SetData adds the data to the virtualization cluster types create params.
func (o *VirtualizationClusterTypesCreateParams) SetData(data *models.WritableClusterType) {
	o.Data = data
}
