...
func (o *VirtualizationClusterTypesCreateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *VirtualizationClusterTypesCreateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /virtualization/cluster-types/][%d] virtualization_cluster_types_create default %s", o._statusCode, payload)
}
...
func (o *VirtualizationClusterTypesCreateDefault) GetPayload() any {
	return o.Payload
}
