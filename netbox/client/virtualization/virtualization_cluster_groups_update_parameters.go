...
func NewVirtualizationClusterGroupsUpdateParams() *VirtualizationClusterGroupsUpdateParams {
	return NewVirtualizationClusterGroupsUpdateParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [VirtualizationClusterGroupsUpdateParams].
...
func (o *VirtualizationClusterGroupsUpdateParams) WithData(data *models.WritableClusterGroup) *VirtualizationClusterGroupsUpdateParams {
	o.SetData(data)
	return o
}

// SetData adds the data to the virtualization cluster groups update params.
func (o *VirtualizationClusterGroupsUpdateParams) SetData(data *models.WritableClusterGroup) {
	o.Data = data
}
