...
func (o *VirtualizationInterfacesCreateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *VirtualizationInterfacesCreateDefault) GetPayload() any {
	return o.Payload
}
