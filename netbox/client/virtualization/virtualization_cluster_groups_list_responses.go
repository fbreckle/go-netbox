...
func (o *VirtualizationClusterGroupsListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *VirtualizationClusterGroupsListDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /virtualization/cluster-groups/][%d] virtualization_cluster_groups_list default %s", o._statusCode, payload)
}
...
func (o *VirtualizationClusterGroupsListDefault) GetPayload() any {
	return o.Payload
}
