...
func (o *CircuitsCircuitTypesCreateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *CircuitsCircuitTypesCreateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /circuits/circuit-types/][%d] circuits_circuit_types_create default %s", o._statusCode, payload)
}
...
func (o *CircuitsCircuitTypesCreateDefault) GetPayload() any {
	return o.Payload
}
