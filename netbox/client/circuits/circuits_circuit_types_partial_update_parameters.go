...
func NewCircuitsCircuitTypesPartialUpdateParams() *CircuitsCircuitTypesPartialUpdateParams {
	return NewCircuitsCircuitTypesPartialUpdateParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [CircuitsCircuitTypesPartialUpdateParams].
...
func (o *CircuitsCircuitTypesPartialUpdateParams) WithData(data *models.WritableCircuitType) *CircuitsCircuitTypesPartialUpdateParams {
	o.SetData(data)
	return o
}

// SetData adds the data to the circuits circuit types partial update params.
func (o *CircuitsCircuitTypesPartialUpdateParams) SetData(data *models.WritableCircuitType) {
	o.Data = data
}
