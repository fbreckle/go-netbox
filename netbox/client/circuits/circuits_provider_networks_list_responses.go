...
func (o *CircuitsProviderNetworksListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *CircuitsProviderNetworksListOK) Code() int {
	return 200
}

func (o *CircuitsProviderNetworksListOK) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /circuits/provider-networks/][%d] circuitsProviderNetworksListOK %s", 200, payload)
}
...
func (o *CircuitsProviderNetworksListDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /circuits/provider-networks/][%d] circuits_provider_networks_list default %s", o._statusCode, payload)
}
...
func (o *CircuitsProviderNetworksListDefault) GetPayload() any {
	return o.Payload
}
