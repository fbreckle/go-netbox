...
func (o *CircuitsProvidersUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *CircuitsProvidersUpdateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /circuits/providers/{id}/][%d] circuits_providers_update default %s", o._statusCode, payload)
}
...
func (o *CircuitsProvidersUpdateDefault) GetPayload() any {
	return o.Payload
}
