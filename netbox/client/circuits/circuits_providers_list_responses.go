...
func (o *CircuitsProvidersListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *CircuitsProvidersListDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /circuits/providers/][%d] circuits_providers_list default %s", o._statusCode, payload)
}
...
func (o *CircuitsProvidersListDefault) GetPayload() any {
	return o.Payload
}
