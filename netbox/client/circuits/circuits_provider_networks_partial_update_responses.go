...
func (o *CircuitsProviderNetworksPartialUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *CircuitsProviderNetworksPartialUpdateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PATCH /circuits/provider-networks/{id}/][%d] circuits_provider_networks_partial_update default %s", o._statusCode, payload)
}
...
func (o *CircuitsProviderNetworksPartialUpdateDefault) GetPayload() any {
	return o.Payload
}
