...
func NewCircuitsCircuitsCreateParams() *CircuitsCircuitsCreateParams {
	return NewCircuitsCircuitsCreateParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [CircuitsCircuitsCreateParams].
