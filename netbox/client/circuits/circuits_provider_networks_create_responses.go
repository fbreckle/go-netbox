...
func (o *CircuitsProviderNetworksCreateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *CircuitsProviderNetworksCreateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /circuits/provider-networks/][%d] circuits_provider_networks_create default %s", o._statusCode, payload)
}
...
func (o *CircuitsProviderNetworksCreateDefault) GetPayload() any {
	return o.Payload
}
