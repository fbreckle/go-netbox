...
func NewCircuitsProvidersUpdateParams() *CircuitsProvidersUpdateParams {
	return NewCircuitsProvidersUpdateParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [CircuitsProvidersUpdateParams].
