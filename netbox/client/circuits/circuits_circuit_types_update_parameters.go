...
func NewCircuitsCircuitTypesUpdateParams() *CircuitsCircuitTypesUpdateParams {
	return NewCircuitsCircuitTypesUpdateParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [CircuitsCircuitTypesUpdateParams].
...
func (o *CircuitsCircuitTypesUpdateParams) WithData(data *models.WritableCircuitType) *CircuitsCircuitTypesUpdateParams {
	o.SetData(data)
	return o
}

// SetData adds the data to the circuits circuit types update params.
func (o *CircuitsCircuitTypesUpdateParams) SetData(data *models.WritableCircuitType) {
	o.Data = data
}
