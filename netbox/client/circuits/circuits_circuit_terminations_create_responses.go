...
func (o *CircuitsCircuitTerminationsCreateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *CircuitsCircuitTerminationsCreateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /circuits/circuit-terminations/][%d] circuits_circuit_terminations_create default %s", o._statusCode, payload)
}
...
func (o *CircuitsCircuitTerminationsCreateDefault) GetPayload() any {
	return o.Payload
}
