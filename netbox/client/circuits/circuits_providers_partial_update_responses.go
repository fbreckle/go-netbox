...
func (o *CircuitsProvidersPartialUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *CircuitsProvidersPartialUpdateOK) Code() int {
	return 200
}
...
func (o *CircuitsProvidersPartialUpdateDefault) GetPayload() any {
	return o.Payload
}
