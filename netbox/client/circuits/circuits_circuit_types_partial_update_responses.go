...
func (o *CircuitsCircuitTypesPartialUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *CircuitsCircuitTypesPartialUpdateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PATCH /circuits/circuit-types/{id}/][%d] circuits_circuit_types_partial_update default %s", o._statusCode, payload)
}
...
func (o *CircuitsCircuitTypesPartialUpdateDefault) GetPayload() any {
	return o.Payload
}
