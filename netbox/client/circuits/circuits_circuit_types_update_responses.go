...
func (o *CircuitsCircuitTypesUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *CircuitsCircuitTypesUpdateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /circuits/circuit-types/{id}/][%d] circuits_circuit_types_update default %s", o._statusCode, payload)
}
...
func (o *CircuitsCircuitTypesUpdateDefault) GetPayload() any {
	return o.Payload
}
