...
func (o *CircuitsCircuitsCreateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *CircuitsCircuitsCreateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /circuits/circuits/][%d] circuits_circuits_create default %s", o._statusCode, payload)
}
...
func (o *CircuitsCircuitsCreateDefault) GetPayload() any {
	return o.Payload
}
