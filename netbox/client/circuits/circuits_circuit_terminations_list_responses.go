...
func (o *CircuitsCircuitTerminationsListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *CircuitsCircuitTerminationsListDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /circuits/circuit-terminations/][%d] circuits_circuit_terminations_list default %s", o._statusCode, payload)
}
...
func (o *CircuitsCircuitTerminationsListDefault) GetPayload() any {
	return o.Payload
}
