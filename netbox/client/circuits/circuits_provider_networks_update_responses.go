...
func (o *CircuitsProviderNetworksUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *CircuitsProviderNetworksUpdateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /circuits/provider-networks/{id}/][%d] circuits_provider_networks_update default %s", o._statusCode, payload)
}
...
func (o *CircuitsProviderNetworksUpdateDefault) GetPayload() any {
	return o.Payload
}
