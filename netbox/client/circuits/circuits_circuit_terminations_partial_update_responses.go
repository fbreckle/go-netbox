...
func (o *CircuitsCircuitTerminationsPartialUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *CircuitsCircuitTerminationsPartialUpdateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PATCH /circuits/circuit-terminations/{id}/][%d] circuits_circuit_terminations_partial_update default %s", o._statusCode, payload)
}
...
func (o *CircuitsCircuitTerminationsPartialUpdateDefault) GetPayload() any {
	return o.Payload
}
