...
func (o *CircuitsCircuitTerminationsUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *CircuitsCircuitTerminationsUpdateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /circuits/circuit-terminations/{id}/][%d] circuits_circuit_terminations_update default %s", o._statusCode, payload)
}
...
func (o *CircuitsCircuitTerminationsUpdateDefault) GetPayload() any {
	return o.Payload
}
