...
func (o *TenancyTenantsPartialUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *TenancyTenantsPartialUpdateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PATCH /tenancy/tenants/{id}/][%d] tenancy_tenants_partial_update default %s", o._statusCode, payload)
}
...
func (o *TenancyTenantsPartialUpdateDefault) GetPayload() any {
	return o.Payload
}
