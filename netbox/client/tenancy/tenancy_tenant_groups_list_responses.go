...
func (o *TenancyTenantGroupsListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *TenancyTenantGroupsListOK) Error() string {
	...
	return fmt.Sprintf("[GET /tenancy/tenant-groups/][%d] tenancyTenantGroupsListOK %s", 200, payload)
}
...
func (o *TenancyTenantGroupsListDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /tenancy/tenant-groups/][%d] tenancy_tenant_groups_list default %s", o._statusCode, payload)
}
...
func (o *TenancyTenantGroupsListDefault) GetPayload() any {
	return o.Payload
}
