...
func NewTenancyTenantsUpdateParams() *TenancyTenantsUpdateParams {
	return NewTenancyTenantsUpdateParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [TenancyTenantsUpdateParams].
