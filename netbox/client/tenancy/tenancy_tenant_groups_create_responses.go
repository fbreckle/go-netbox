...
func (o *TenancyTenantGroupsCreateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *TenancyTenantGroupsCreateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /tenancy/tenant-groups/][%d] tenancy_tenant_groups_create default %s", o._statusCode, payload)
}
...
func (o *TenancyTenantGroupsCreateDefault) GetPayload() any {
	return o.Payload
}
