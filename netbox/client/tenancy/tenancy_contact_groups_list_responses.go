...
func (o *TenancyContactGroupsListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *TenancyContactGroupsListDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /tenancy/contact-groups/][%d] tenancy_contact_groups_list default %s", o._statusCode, payload)
}
...
func (o *TenancyContactGroupsListDefault) GetPayload() any {
	return o.Payload
}
