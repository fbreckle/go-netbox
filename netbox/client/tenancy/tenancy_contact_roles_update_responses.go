...
func (o *TenancyContactRolesUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *TenancyContactRolesUpdateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /tenancy/contact-roles/{id}/][%d] tenancy_contact_roles_update default %s", o._statusCode, payload)
}
...
func (o *TenancyContactRolesUpdateDefault) GetPayload() any {
	return o.Payload
}
