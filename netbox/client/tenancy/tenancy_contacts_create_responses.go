...
func (o *TenancyContactsCreateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *TenancyContactsCreateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /tenancy/contacts/][%d] tenancy_contacts_create default %s", o._statusCode, payload)
}
...
func (o *TenancyContactsCreateDefault) GetPayload() any {
	return o.Payload
}
