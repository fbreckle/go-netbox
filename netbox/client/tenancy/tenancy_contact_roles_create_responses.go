...
func (o *TenancyContactRolesCreateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *TenancyContactRolesCreateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /tenancy/contact-roles/][%d] tenancy_contact_roles_create default %s", o._statusCode, payload)
}
...
func (o *TenancyContactRolesCreateDefault) GetPayload() any {
	return o.Payload
}
