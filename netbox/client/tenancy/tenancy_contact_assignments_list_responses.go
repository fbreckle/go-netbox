...
func (o *TenancyContactAssignmentsListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *TenancyContactAssignmentsListDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /tenancy/contact-assignments/][%d] tenancy_contact_assignments_list default %s", o._statusCode, payload)
}
...
func (o *TenancyContactAssignmentsListDefault) GetPayload() any {
	return o.Payload
}
