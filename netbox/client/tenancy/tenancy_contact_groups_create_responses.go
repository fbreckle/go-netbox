...
func (o *TenancyContactGroupsCreateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *TenancyContactGroupsCreateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /tenancy/contact-groups/][%d] tenancy_contact_groups_create default %s", o._statusCode, payload)
}
...
func (o *TenancyContactGroupsCreateDefault) GetPayload() any {
	return o.Payload
}
