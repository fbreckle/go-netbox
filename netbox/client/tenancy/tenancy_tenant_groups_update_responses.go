...
func (o *TenancyTenantGroupsUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
// Code gets the status code for the tenancy tenant groups update o k response
func (o *TenancyTenantGroupsUpdateOK) Code() int {
	return 200
}

func (o *TenancyTenantGroupsUpdateOK) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /tenancy/tenant-groups/{id}/][%d] tenancyTenantGroupsUpdateOK %s", 200, payload)
}
...
func (o *TenancyTenantGroupsUpdateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /tenancy/tenant-groups/{id}/][%d] tenancy_tenant_groups_update default %s", o._statusCode, payload)
}
...
func (o *TenancyTenantGroupsUpdateDefault) GetPayload() any {
	return o.Payload
}
