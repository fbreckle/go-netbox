...
func (o *TenancyContactGroupsPartialUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *TenancyContactGroupsPartialUpdateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PATCH /tenancy/contact-groups/{id}/][%d] tenancy_contact_groups_partial_update default %s", o._statusCode, payload)
}
...
func (o *TenancyContactGroupsPartialUpdateDefault) GetPayload() any {
	return o.Payload
}
