...
func (o *TenancyContactAssignmentsUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *TenancyContactAssignmentsUpdateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /tenancy/contact-assignments/{id}/][%d] tenancy_contact_assignments_update default %s", o._statusCode, payload)
}
...
func (o *TenancyContactAssignmentsUpdateDefault) GetPayload() any {
	return o.Payload
}
