...
func (o *TenancyContactAssignmentsPartialUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
// Code gets the status code for the tenancy contact assignments partial update o k response
func (o *TenancyContactAssignmentsPartialUpdateOK) Code() int {
	return 200
}

func (o *TenancyContactAssignmentsPartialUpdateOK) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PATCH /tenancy/contact-assignments/{id}/][%d] tenancyContactAssignmentsPartialUpdateOK %s", 200, payload)
}
...
func (o *TenancyContactAssignmentsPartialUpdateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PATCH /tenancy/contact-assignments/{id}/][%d] tenancy_contact_assignments_partial_update default %s", o._statusCode, payload)
}
...
func (o *TenancyContactAssignmentsPartialUpdateDefault) GetPayload() any {
	return o.Payload
}
