...
func NewTenancyContactAssignmentsCreateParams() *TenancyContactAssignmentsCreateParams {
	return NewTenancyContactAssignmentsCreateParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [TenancyContactAssignmentsCreateParams].
