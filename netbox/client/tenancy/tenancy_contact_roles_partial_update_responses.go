...
func (o *TenancyContactRolesPartialUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *TenancyContactRolesPartialUpdateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PATCH /tenancy/contact-roles/{id}/][%d] tenancy_contact_roles_partial_update default %s", o._statusCode, payload)
}
...
func (o *TenancyContactRolesPartialUpdateDefault) GetPayload() any {
	return o.Payload
}
