...
func (o *TenancyContactsUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
// Code gets the status code for the tenancy contacts update o k response
func (o *TenancyContactsUpdateOK) Code() int {
	return 200
}

func (o *TenancyContactsUpdateOK) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /tenancy/contacts/{id}/][%d] tenancyContactsUpdateOK %s", 200, payload)
}
...
func (o *TenancyContactsUpdateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /tenancy/contacts/{id}/][%d] tenancy_contacts_update default %s", o._statusCode, payload)
}
...
func (o *TenancyContactsUpdateDefault) GetPayload() any {
	return o.Payload
}
