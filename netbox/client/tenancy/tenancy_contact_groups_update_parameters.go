...
func NewTenancyContactGroupsUpdateParams() *TenancyContactGroupsUpdateParams {
	return NewTenancyContactGroupsUpdateParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [TenancyContactGroupsUpdateParams].
