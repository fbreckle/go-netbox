...
func NewTenancyContactAssignmentsUpdateParams() *TenancyContactAssignmentsUpdateParams {
	return NewTenancyContactAssignmentsUpdateParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [TenancyContactAssignmentsUpdateParams].
