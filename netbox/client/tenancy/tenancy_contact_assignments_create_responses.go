...
func (o *TenancyContactAssignmentsCreateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *TenancyContactAssignmentsCreateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /tenancy/contact-assignments/][%d] tenancy_contact_assignments_create default %s", o._statusCode, payload)
}
...
func (o *TenancyContactAssignmentsCreateDefault) GetPayload() any {
	return o.Payload
}
