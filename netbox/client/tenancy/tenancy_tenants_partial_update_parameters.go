...
func NewTenancyTenantsPartialUpdateParams() *TenancyTenantsPartialUpdateParams {
	return NewTenancyTenantsPartialUpdateParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [TenancyTenantsPartialUpdateParams].
