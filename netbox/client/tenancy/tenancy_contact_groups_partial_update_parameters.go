...
func NewTenancyContactGroupsPartialUpdateParams() *TenancyContactGroupsPartialUpdateParams {
	return NewTenancyContactGroupsPartialUpdateParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [TenancyContactGroupsPartialUpdateParams].
