...
func (o *TenancyContactGroupsUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *TenancyContactGroupsUpdateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /tenancy/contact-groups/{id}/][%d] tenancy_contact_groups_update default %s", o._statusCode, payload)
}
...
func (o *TenancyContactGroupsUpdateDefault) GetPayload() any {
	return o.Payload
}
