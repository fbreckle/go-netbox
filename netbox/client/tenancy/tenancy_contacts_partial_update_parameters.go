...
func NewTenancyContactsPartialUpdateParams() *TenancyContactsPartialUpdateParams {
	return NewTenancyContactsPartialUpdateParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [TenancyContactsPartialUpdateParams].
