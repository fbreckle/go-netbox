...
func (o *TenancyTenantGroupsPartialUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *TenancyTenantGroupsPartialUpdateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PATCH /tenancy/tenant-groups/{id}/][%d] tenancy_tenant_groups_partial_update default %s", o._statusCode, payload)
}
...
func (o *TenancyTenantGroupsPartialUpdateDefault) GetPayload() any {
	return o.Payload
}
