...
func (o *TenancyTenantsListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
// Code gets the status code for the tenancy tenants list o k response
func (o *TenancyTenantsListOK) Code() int {
	return 200
}

func (o *TenancyTenantsListOK) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /tenancy/tenants/][%d] tenancyTenantsListOK %s", 200, payload)
}
...
func (o *TenancyTenantsListDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /tenancy/tenants/][%d] tenancy_tenants_list default %s", o._statusCode, payload)
}
...
func (o *TenancyTenantsListDefault) GetPayload() any {
	return o.Payload
}
