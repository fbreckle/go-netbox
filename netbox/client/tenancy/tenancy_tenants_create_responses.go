...
func (o *TenancyTenantsCreateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *TenancyTenantsCreateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /tenancy/tenants/][%d] tenancy_tenants_create default %s", o._statusCode, payload)
}
...
func (o *TenancyTenantsCreateDefault) GetPayload() any {
	return o.Payload
}
