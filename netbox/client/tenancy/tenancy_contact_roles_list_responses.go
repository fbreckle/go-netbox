...
func (o *TenancyContactRolesListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *TenancyContactRolesListDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /tenancy/contact-roles/][%d] tenancy_contact_roles_list default %s", o._statusCode, payload)
}
...
func (o *TenancyContactRolesListDefault) GetPayload() any {
	return o.Payload
}
