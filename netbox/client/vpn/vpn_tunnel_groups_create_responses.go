...
func (o *VpnTunnelGroupsCreateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *VpnTunnelGroupsCreateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /vpn/tunnel-groups/][%d] vpn_tunnel_groups_create default %s", o._statusCode, payload)
}
...
func (o *VpnTunnelGroupsCreateDefault) GetPayload() any {
	return o.Payload
}
