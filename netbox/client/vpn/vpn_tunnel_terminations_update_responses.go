...
func (o *VpnTunnelTerminationsUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *VpnTunnelTerminationsUpdateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /vpn/tunnel-terminations/{id}/][%d] vpn_tunnel_terminations_update default %s", o._statusCode, payload)
}
...
func (o *VpnTunnelTerminationsUpdateDefault) GetPayload() any {
	return o.Payload
}
