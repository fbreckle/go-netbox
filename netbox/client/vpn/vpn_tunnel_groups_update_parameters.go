...
// NewVpnTunnelGroupsUpdateParams creates a new VpnTunnelGroupsUpdateParams object,
...
func NewVpnTunnelGroupsUpdateParams() *VpnTunnelGroupsUpdateParams {
	return NewVpnTunnelGroupsUpdateParamsWithTimeout(cr.DefaultTimeout)
}

// NewVpnTunnelGroupsUpdateParamsWithTimeout creates a new VpnTunnelGroupsUpdateParams object
// with the ability to set a timeout on a request.
func NewVpnTunnelGroupsUpdateParamsWithTimeout(timeout time.Duration) *VpnTunnelGroupsUpdateParams {
	return &VpnTunnelGroupsUpdateParams{
		inner: innerParams{
			timeout: timeout,
		},
	}
...
// NewVpnTunnelGroupsUpdateParamsWithContext creates a new VpnTunnelGroupsUpdateParams object
// with the ability to set a context for a request.
//
// Deprecated: use the operation call with context to pass the context instead of [VpnTunnelGroupsUpdateParams].
...
// NewVpnTunnelGroupsUpdateParamsWithHTTPClient creates a new VpnTunnelGroupsUpdateParams object
...
func (o *VpnTunnelGroupsUpdateParams) WithDefaults() *VpnTunnelGroupsUpdateParams {
	o.SetDefaults()
	return o
}
...
func (o *VpnTunnelGroupsUpdateParams) WithTimeout(timeout time.Duration) *VpnTunnelGroupsUpdateParams {
...
//
// Deprecated: use the operation call with context to pass the context instead of [VpnTunnelGroupsUpdateParams].
func (o *VpnTunnelGroupsUpdateParams) WithContext(ctx context.Context) *VpnTunnelGroupsUpdateParams {
	o.SetContext(ctx)
	return o
}
...
func (o *VpnTunnelGroupsUpdateParams) WithHTTPClient(client *http.Client) *VpnTunnelGroupsUpdateParams {
...
func (o *VpnTunnelGroupsUpdateParams) WithData(data *models.WritableTunnelGroup) *VpnTunnelGroupsUpdateParams {
	o.SetData(data)
	return o
}

// SetData adds the data to the vpn tunnel groups update params.
func (o *VpnTunnelGroupsUpdateParams) SetData(data *models.WritableTunnelGroup) {
	o.Data = data
}

// WithID adds the id to the vpn tunnel groups update params.
func (o *VpnTunnelGroupsUpdateParams) WithID(id int64) *VpnTunnelGroupsUpdateParams {
	o.SetID(id)
	return o
}
...
func (o *VpnTunnelGroupsUpdateParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
