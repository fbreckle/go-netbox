...
func (o *VpnTunnelTerminationsCreateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 201:
		...
		return result, nil
	default:
		result := NewVpnTunnelTerminationsCreateDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewVpnTunnelTerminationsCreateDefault(code int) *VpnTunnelTerminationsCreateDefault {
	return &VpnTunnelTerminationsCreateDefault{
		_statusCode: code,
	}
}
...
func (o *VpnTunnelTerminationsCreateDefault) IsSuccess() bool {
...
func (o *VpnTunnelTerminationsCreateDefault) IsCode(code int) bool {
	return o._statusCode == code
}

// Code gets the status code for the vpn tunnel terminations create default response
func (o *VpnTunnelTerminationsCreateDefault) Code() int {
	return o._statusCode
}

func (o *VpnTunnelTerminationsCreateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /vpn/tunnel-terminations/][%d] vpn_tunnel_terminations_create default %s", o._statusCode, payload)
}

func (o *VpnTunnelTerminationsCreateDefault) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /vpn/tunnel-terminations/][%d] vpn_tunnel_terminations_create default %s", o._statusCode, payload)
}

func (o *VpnTunnelTerminationsCreateDefault) GetPayload() any {
	return o.Payload
}

func (o *VpnTunnelTerminationsCreateDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
