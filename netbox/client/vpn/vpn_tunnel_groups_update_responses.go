...
func (o *VpnTunnelGroupsUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *VpnTunnelGroupsUpdateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /vpn/tunnel-groups/{id}/][%d] vpn_tunnel_groups_update default %s", o._statusCode, payload)
}
...
func (o *VpnTunnelGroupsUpdateDefault) GetPayload() any {
	return o.Payload
}
