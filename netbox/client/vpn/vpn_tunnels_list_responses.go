...
func (o *VpnTunnelsListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *VpnTunnelsListDefault) GetPayload() any {
	return o.Payload
}
