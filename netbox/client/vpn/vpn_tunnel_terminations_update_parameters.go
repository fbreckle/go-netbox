...
func NewVpnTunnelTerminationsUpdateParams() *VpnTunnelTerminationsUpdateParams {
	return NewVpnTunnelTerminationsUpdateParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [VpnTunnelTerminationsUpdateParams].
