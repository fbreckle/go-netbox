...
func (o *VpnTunnelGroupsListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 200:
		...
		return result, nil
	default:
		result := NewVpnTunnelGroupsListDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewVpnTunnelGroupsListDefault(code int) *VpnTunnelGroupsListDefault {
	return &VpnTunnelGroupsListDefault{
		_statusCode: code,
	}
}
...
func (o *VpnTunnelGroupsListDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /vpn/tunnel-groups/][%d] vpn_tunnel_groups_list default %s", o._statusCode, payload)
}
...
func (o *VpnTunnelGroupsListDefault) GetPayload() any {
	return o.Payload
}

func (o *VpnTunnelGroupsListDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
