...
func (o *IpamRouteTargetsUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *IpamRouteTargetsUpdateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /ipam/route-targets/{id}/][%d] ipam_route_targets_update default %s", o._statusCode, payload)
}
...
func (o *IpamRouteTargetsUpdateDefault) GetPayload() any {
	return o.Payload
}
