...
func (o *IpamIPAddressesPartialUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *IpamIPAddressesPartialUpdateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PATCH /ipam/ip-addresses/{id}/][%d] ipam_ip_addresses_partial_update default %s", o._statusCode, payload)
}
...
func (o *IpamIPAddressesPartialUpdateDefault) GetPayload() any {
	return o.Payload
}
