...
func (o *IpamIPRangesPartialUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *IpamIPRangesPartialUpdateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PATCH /ipam/ip-ranges/{id}/][%d] ipam_ip_ranges_partial_update default %s", o._statusCode, payload)
}
...
func (o *IpamIPRangesPartialUpdateDefault) GetPayload() any {
	return o.Payload
}
