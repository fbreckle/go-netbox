...
func (o *IpamVlansUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *IpamVlansUpdateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /ipam/vlans/{id}/][%d] ipam_vlans_update default %s", o._statusCode, payload)
}
...
func (o *IpamVlansUpdateDefault) GetPayload() any {
	return o.Payload
}
