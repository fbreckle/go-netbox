...
func (o *IpamFhrpGroupAssignmentsCreateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *IpamFhrpGroupAssignmentsCreateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /ipam/fhrp-group-assignments/][%d] ipam_fhrp_group_assignments_create default %s", o._statusCode, payload)
}
...
func (o *IpamFhrpGroupAssignmentsCreateDefault) GetPayload() any {
	return o.Payload
}
