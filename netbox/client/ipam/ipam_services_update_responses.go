...
func (o *IpamServicesUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *IpamServicesUpdateDefault) GetPayload() any {
	return o.Payload
}
