...
func NewIpamServiceTemplatesUpdateParams() *IpamServiceTemplatesUpdateParams {
	return NewIpamServiceTemplatesUpdateParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [IpamServiceTemplatesUpdateParams].
