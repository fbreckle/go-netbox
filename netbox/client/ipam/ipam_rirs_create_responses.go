...
func (o *IpamRirsCreateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *IpamRirsCreateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /ipam/rirs/][%d] ipam_rirs_create default %s", o._statusCode, payload)
}
...
func (o *IpamRirsCreateDefault) GetPayload() any {
	return o.Payload
}
