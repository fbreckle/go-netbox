...
func NewIpamVlansCreateParams() *IpamVlansCreateParams {
	return NewIpamVlansCreateParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [IpamVlansCreateParams].
