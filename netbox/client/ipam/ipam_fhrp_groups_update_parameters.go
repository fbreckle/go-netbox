...
func NewIpamFhrpGroupsUpdateParams() *IpamFhrpGroupsUpdateParams {
	return NewIpamFhrpGroupsUpdateParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [IpamFhrpGroupsUpdateParams].
...
func (o *IpamFhrpGroupsUpdateParams) WithData(data *models.WritableFHRPGroup) *IpamFhrpGroupsUpdateParams {
	o.SetData(data)
	return o
}

// SetData adds the data to the ipam fhrp groups update params.
func (o *IpamFhrpGroupsUpdateParams) SetData(data *models.WritableFHRPGroup) {
	o.Data = data
}
