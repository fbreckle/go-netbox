...
func NewIpamRolesCreateParams() *IpamRolesCreateParams {
	return NewIpamRolesCreateParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [IpamRolesCreateParams].
...
func (o *IpamRolesCreateParams) WithData(data *models.WritableRole) *IpamRolesCreateParams {
	o.SetData(data)
	return o
}

// SetData adds the data to the ipam roles create params.
func (o *IpamRolesCreateParams) SetData(data *models.WritableRole) {
	o.Data = data
}
