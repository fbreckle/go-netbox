...
func (o *IpamServicesPartialUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *IpamServicesPartialUpdateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PATCH /ipam/services/{id}/][%d] ipam_services_partial_update default %s", o._statusCode, payload)
}
...
func (o *IpamServicesPartialUpdateDefault) GetPayload() any {
	return o.Payload
}
