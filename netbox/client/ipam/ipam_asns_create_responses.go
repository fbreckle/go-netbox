...
func (o *IpamAsnsCreateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *IpamAsnsCreateDefault) GetPayload() any {
	return o.Payload
}
