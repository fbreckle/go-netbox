...
func (o *IpamRolesPartialUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *IpamRolesPartialUpdateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PATCH /ipam/roles/{id}/][%d] ipam_roles_partial_update default %s", o._statusCode, payload)
}
...
func (o *IpamRolesPartialUpdateDefault) GetPayload() any {
	return o.Payload
}
