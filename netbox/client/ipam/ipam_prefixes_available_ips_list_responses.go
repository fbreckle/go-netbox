...
func (o *IpamPrefixesAvailableIpsListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *IpamPrefixesAvailableIpsListDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /ipam/prefixes/{id}/available-ips/][%d] ipam_prefixes_available_ips_list default %s", o._statusCode, payload)
}
...
func (o *IpamPrefixesAvailableIpsListDefault) GetPayload() any {
	return o.Payload
}
