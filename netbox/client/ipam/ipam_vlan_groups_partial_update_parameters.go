...
func NewIpamVlanGroupsPartialUpdateParams() *IpamVlanGroupsPartialUpdateParams {
	return NewIpamVlanGroupsPartialUpdateParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [IpamVlanGroupsPartialUpdateParams].
