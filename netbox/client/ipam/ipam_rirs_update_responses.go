...
func (o *IpamRirsUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *IpamRirsUpdateDefault) GetPayload() any {
	return o.Payload
}
