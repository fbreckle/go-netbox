...
func (o *IpamVrfsPartialUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *IpamVrfsPartialUpdateDefault) GetPayload() any {
	return o.Payload
}
