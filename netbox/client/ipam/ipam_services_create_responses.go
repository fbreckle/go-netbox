...
func (o *IpamServicesCreateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *IpamServicesCreateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /ipam/services/][%d] ipam_services_create default %s", o._statusCode, payload)
}
...
func (o *IpamServicesCreateDefault) GetPayload() any {
	return o.Payload
}
