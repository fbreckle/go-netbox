...
func NewIpamRouteTargetsPartialUpdateParams() *IpamRouteTargetsPartialUpdateParams {
	return NewIpamRouteTargetsPartialUpdateParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [IpamRouteTargetsPartialUpdateParams].
