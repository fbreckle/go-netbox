...
func (o *IpamRouteTargetsPartialUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *IpamRouteTargetsPartialUpdateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PATCH /ipam/route-targets/{id}/][%d] ipam_route_targets_partial_update default %s", o._statusCode, payload)
}
...
func (o *IpamRouteTargetsPartialUpdateDefault) GetPayload() any {
	return o.Payload
}
