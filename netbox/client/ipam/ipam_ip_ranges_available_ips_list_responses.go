...
func (o *IpamIPRangesAvailableIpsListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *IpamIPRangesAvailableIpsListDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /ipam/ip-ranges/{id}/available-ips/][%d] ipam_ip_ranges_available_ips_list default %s", o._statusCode, payload)
}
...
func (o *IpamIPRangesAvailableIpsListDefault) GetPayload() any {
	return o.Payload
}
