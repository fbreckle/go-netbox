...
func (o *IpamRolesListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *IpamRolesListDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /ipam/roles/][%d] ipam_roles_list default %s", o._statusCode, payload)
}
...
func (o *IpamRolesListDefault) GetPayload() any {
	return o.Payload
}
