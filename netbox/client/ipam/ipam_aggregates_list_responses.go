...
func (o *IpamAggregatesListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *IpamAggregatesListDefault) GetPayload() any {
	return o.Payload
}
