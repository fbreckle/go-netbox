...
func (o *IpamVlanGroupsPartialUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *IpamVlanGroupsPartialUpdateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PATCH /ipam/vlan-groups/{id}/][%d] ipam_vlan_groups_partial_update default %s", o._statusCode, payload)
}
...
func (o *IpamVlanGroupsPartialUpdateDefault) GetPayload() any {
	return o.Payload
}
