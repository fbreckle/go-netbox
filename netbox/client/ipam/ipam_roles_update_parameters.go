...
func NewIpamRolesUpdateParams() *IpamRolesUpdateParams {
	return NewIpamRolesUpdateParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [IpamRolesUpdateParams].
...
func (o *IpamRolesUpdateParams) WithData(data *models.WritableRole) *IpamRolesUpdateParams {
	o.SetData(data)
	return o
}

// SetData adds the data to the ipam roles update params.
func (o *IpamRolesUpdateParams) SetData(data *models.WritableRole) {
	o.Data = data
}
