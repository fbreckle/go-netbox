...
func (o *IpamVrfsCreateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *IpamVrfsCreateDefault) GetPayload() any {
	return o.Payload
}
