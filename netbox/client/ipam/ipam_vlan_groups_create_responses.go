...
func (o *IpamVlanGroupsCreateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *IpamVlanGroupsCreateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /ipam/vlan-groups/][%d] ipam_vlan_groups_create default %s", o._statusCode, payload)
}
...
func (o *IpamVlanGroupsCreateDefault) GetPayload() any {
	return o.Payload
}
