...
func NewIpamVrfsCreateParams() *IpamVrfsCreateParams {
	return NewIpamVrfsCreateParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [IpamVrfsCreateParams].
