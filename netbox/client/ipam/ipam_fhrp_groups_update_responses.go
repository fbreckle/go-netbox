...
func (o *IpamFhrpGroupsUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *IpamFhrpGroupsUpdateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /ipam/fhrp-groups/{id}/][%d] ipam_fhrp_groups_update default %s", o._statusCode, payload)
}
...
func (o *IpamFhrpGroupsUpdateDefault) GetPayload() any {
	return o.Payload
}
