...
func (o *IpamPrefixesPartialUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *IpamPrefixesPartialUpdateDefault) GetPayload() any {
	return o.Payload
}
