...
func (o *IpamAggregatesPartialUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *IpamAggregatesPartialUpdateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PATCH /ipam/aggregates/{id}/][%d] ipam_aggregates_partial_update default %s", o._statusCode, payload)
}
...
func (o *IpamAggregatesPartialUpdateDefault) GetPayload() any {
	return o.Payload
}
