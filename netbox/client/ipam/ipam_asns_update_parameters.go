...
func NewIpamAsnsUpdateParams() *IpamAsnsUpdateParams {
	return NewIpamAsnsUpdateParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [IpamAsnsUpdateParams].
