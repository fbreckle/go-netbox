...
func NewIpamPrefixesCreateParams() *IpamPrefixesCreateParams {
	return NewIpamPrefixesCreateParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [IpamPrefixesCreateParams].
