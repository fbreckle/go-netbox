...
func (o *IpamFhrpGroupsListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *IpamFhrpGroupsListDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /ipam/fhrp-groups/][%d] ipam_fhrp_groups_list default %s", o._statusCode, payload)
}
...
func (o *IpamFhrpGroupsListDefault) GetPayload() any {
	return o.Payload
}
