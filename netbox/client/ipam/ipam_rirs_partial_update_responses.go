...
func (o *IpamRirsPartialUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *IpamRirsPartialUpdateDefault) GetPayload() any {
	return o.Payload
}
