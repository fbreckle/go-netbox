...
func (o *IpamIPAddressesCreateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *IpamIPAddressesCreateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /ipam/ip-addresses/][%d] ipam_ip_addresses_create default %s", o._statusCode, payload)
}
...
func (o *IpamIPAddressesCreateDefault) GetPayload() any {
	return o.Payload
}
