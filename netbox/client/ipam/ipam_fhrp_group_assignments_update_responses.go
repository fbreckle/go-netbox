...
func (o *IpamFhrpGroupAssignmentsUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *IpamFhrpGroupAssignmentsUpdateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /ipam/fhrp-group-assignments/{id}/][%d] ipam_fhrp_group_assignments_update default %s", o._statusCode, payload)
}
...
func (o *IpamFhrpGroupAssignmentsUpdateDefault) GetPayload() any {
	return o.Payload
}
