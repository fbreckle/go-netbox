...
func NewIpamVlanGroupsCreateParams() *IpamVlanGroupsCreateParams {
	return NewIpamVlanGroupsCreateParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [IpamVlanGroupsCreateParams].
