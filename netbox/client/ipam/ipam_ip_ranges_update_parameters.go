...
func NewIpamIPRangesUpdateParams() *IpamIPRangesUpdateParams {
	return NewIpamIPRangesUpdateParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [IpamIPRangesUpdateParams].
