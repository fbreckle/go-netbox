...
func (o *IpamFhrpGroupsPartialUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *IpamFhrpGroupsPartialUpdateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PATCH /ipam/fhrp-groups/{id}/][%d] ipam_fhrp_groups_partial_update default %s", o._statusCode, payload)
}
...
func (o *IpamFhrpGroupsPartialUpdateDefault) GetPayload() any {
	return o.Payload
}
