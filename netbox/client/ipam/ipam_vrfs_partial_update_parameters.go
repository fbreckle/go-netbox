...
func NewIpamVrfsPartialUpdateParams() *IpamVrfsPartialUpdateParams {
	return NewIpamVrfsPartialUpdateParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [IpamVrfsPartialUpdateParams].
