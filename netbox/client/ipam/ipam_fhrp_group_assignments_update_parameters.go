...
func NewIpamFhrpGroupAssignmentsUpdateParams() *IpamFhrpGroupAssignmentsUpdateParams {
	return NewIpamFhrpGroupAssignmentsUpdateParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [IpamFhrpGroupAssignmentsUpdateParams].
