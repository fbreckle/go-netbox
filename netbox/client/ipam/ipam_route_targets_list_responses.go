...
func (o *IpamRouteTargetsListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *IpamRouteTargetsListDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /ipam/route-targets/][%d] ipam_route_targets_list default %s", o._statusCode, payload)
}
...
func (o *IpamRouteTargetsListDefault) GetPayload() any {
	return o.Payload
}
