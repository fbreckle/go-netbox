...
func NewIpamRouteTargetsCreateParams() *IpamRouteTargetsCreateParams {
	return NewIpamRouteTargetsCreateParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [IpamRouteTargetsCreateParams].
