...
func (o *IpamIPAddressesListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *IpamIPAddressesListOK) Error() string {
	...
	return fmt.Sprintf("[GET /ipam/ip-addresses/][%d] ipamIpAddressesListOK %s", 200, payload)
}
...
func (o *IpamIPAddressesListDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /ipam/ip-addresses/][%d] ipam_ip_addresses_list default %s", o._statusCode, payload)
}
...
func (o *IpamIPAddressesListDefault) GetPayload() any {
	return o.Payload
}
