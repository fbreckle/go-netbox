...
func (o *IpamServiceTemplatesListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *IpamServiceTemplatesListDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /ipam/service-templates/][%d] ipam_service_templates_list default %s", o._statusCode, payload)
}
...
func (o *IpamServiceTemplatesListDefault) GetPayload() any {
	return o.Payload
}
