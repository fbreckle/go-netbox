...
func (o *IpamServiceTemplatesCreateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *IpamServiceTemplatesCreateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /ipam/service-templates/][%d] ipam_service_templates_create default %s", o._statusCode, payload)
}
...
func (o *IpamServiceTemplatesCreateDefault) GetPayload() any {
	return o.Payload
}
