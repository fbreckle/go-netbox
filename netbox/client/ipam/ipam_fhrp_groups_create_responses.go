...
func (o *IpamFhrpGroupsCreateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *IpamFhrpGroupsCreateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /ipam/fhrp-groups/][%d] ipam_fhrp_groups_create default %s", o._statusCode, payload)
}
...
func (o *IpamFhrpGroupsCreateDefault) GetPayload() any {
	return o.Payload
}
