...
func (o *IpamServiceTemplatesUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *IpamServiceTemplatesUpdateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /ipam/service-templates/{id}/][%d] ipam_service_templates_update default %s", o._statusCode, payload)
}
...
func (o *IpamServiceTemplatesUpdateDefault) GetPayload() any {
	return o.Payload
}
