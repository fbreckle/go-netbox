...
func NewIpamRouteTargetsUpdateParams() *IpamRouteTargetsUpdateParams {
	return NewIpamRouteTargetsUpdateParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [IpamRouteTargetsUpdateParams].
