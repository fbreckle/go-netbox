...
func (o *IpamAggregatesUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *IpamAggregatesUpdateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /ipam/aggregates/{id}/][%d] ipam_aggregates_update default %s", o._statusCode, payload)
}
...
func (o *IpamAggregatesUpdateDefault) GetPayload() any {
	return o.Payload
}
