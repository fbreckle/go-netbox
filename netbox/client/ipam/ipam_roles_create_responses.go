...
func (o *IpamRolesCreateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *IpamRolesCreateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /ipam/roles/][%d] ipam_roles_create default %s", o._statusCode, payload)
}
...
func (o *IpamRolesCreateDefault) GetPayload() any {
	return o.Payload
}
