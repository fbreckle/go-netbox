...
func NewIpamPrefixesAvailableIpsListParams() *IpamPrefixesAvailableIpsListParams {
	return NewIpamPrefixesAvailableIpsListParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [IpamPrefixesAvailableIpsListParams].
