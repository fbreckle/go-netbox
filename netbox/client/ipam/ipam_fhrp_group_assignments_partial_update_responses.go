...
func (o *IpamFhrpGroupAssignmentsPartialUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *IpamFhrpGroupAssignmentsPartialUpdateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PATCH /ipam/fhrp-group-assignments/{id}/][%d] ipam_fhrp_group_assignments_partial_update default %s", o._statusCode, payload)
}
...
func (o *IpamFhrpGroupAssignmentsPartialUpdateDefault) GetPayload() any {
	return o.Payload
}
