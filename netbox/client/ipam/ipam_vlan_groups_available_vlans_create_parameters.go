...
func NewIpamVlanGroupsAvailableVlansCreateParams() *IpamVlanGroupsAvailableVlansCreateParams {
	return NewIpamVlanGroupsAvailableVlansCreateParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [IpamVlanGroupsAvailableVlansCreateParams].
...
func (o *IpamVlanGroupsAvailableVlansCreateParams) WithData(data []*models.CreateAvailableVLAN) *IpamVlanGroupsAvailableVlansCreateParams {
	o.SetData(data)
	return o
}

// SetData adds the data to the ipam vlan groups available vlans create params.
func (o *IpamVlanGroupsAvailableVlansCreateParams) SetData(data []*models.CreateAvailableVLAN) {
	o.Data = data
}
