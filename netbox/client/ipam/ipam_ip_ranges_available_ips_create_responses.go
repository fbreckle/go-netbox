...
func (o *IpamIPRangesAvailableIpsCreateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *IpamIPRangesAvailableIpsCreateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /ipam/ip-ranges/{id}/available-ips/][%d] ipam_ip_ranges_available_ips_create default %s", o._statusCode, payload)
}
...
func (o *IpamIPRangesAvailableIpsCreateDefault) GetPayload() any {
	return o.Payload
}
