...
func NewIpamIPAddressesCreateParams() *IpamIPAddressesCreateParams {
	return NewIpamIPAddressesCreateParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [IpamIPAddressesCreateParams].
