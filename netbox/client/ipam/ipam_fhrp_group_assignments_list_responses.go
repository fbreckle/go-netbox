...
func (o *IpamFhrpGroupAssignmentsListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *IpamFhrpGroupAssignmentsListDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /ipam/fhrp-group-assignments/][%d] ipam_fhrp_group_assignments_list default %s", o._statusCode, payload)
}
...
func (o *IpamFhrpGroupAssignmentsListDefault) GetPayload() any {
	return o.Payload
}
