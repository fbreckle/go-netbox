...
func NewIpamIPAddressesUpdateParams() *IpamIPAddressesUpdateParams {
	return NewIpamIPAddressesUpdateParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [IpamIPAddressesUpdateParams].
