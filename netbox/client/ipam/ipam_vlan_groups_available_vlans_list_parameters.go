...
func NewIpamVlanGroupsAvailableVlansListParams() *IpamVlanGroupsAvailableVlansListParams {
	return NewIpamVlanGroupsAvailableVlansListParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [IpamVlanGroupsAvailableVlansListParams].
