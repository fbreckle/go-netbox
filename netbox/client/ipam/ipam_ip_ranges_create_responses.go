...
func (o *IpamIPRangesCreateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *IpamIPRangesCreateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /ipam/ip-ranges/][%d] ipam_ip_ranges_create default %s", o._statusCode, payload)
}
...
func (o *IpamIPRangesCreateDefault) GetPayload() any {
	return o.Payload
}
