...
func (o *IpamIPRangesListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *IpamIPRangesListDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /ipam/ip-ranges/][%d] ipam_ip_ranges_list default %s", o._statusCode, payload)
}
...
func (o *IpamIPRangesListDefault) GetPayload() any {
	return o.Payload
}
