...
func (o *IpamVlanGroupsUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *IpamVlanGroupsUpdateOK) Error() string {
	...
	return fmt.Sprintf("[PUT /ipam/vlan-groups/{id}/][%d] ipamVlanGroupsUpdateOK %s", 200, payload)
}
...
func (o *IpamVlanGroupsUpdateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /ipam/vlan-groups/{id}/][%d] ipam_vlan_groups_update default %s", o._statusCode, payload)
}
...
func (o *IpamVlanGroupsUpdateDefault) GetPayload() any {
	return o.Payload
}
