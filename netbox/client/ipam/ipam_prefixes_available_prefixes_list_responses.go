...
func (o *IpamPrefixesAvailablePrefixesListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *IpamPrefixesAvailablePrefixesListDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /ipam/prefixes/{id}/available-prefixes/][%d] ipam_prefixes_available_prefixes_list default %s", o._statusCode, payload)
}
...
func (o *IpamPrefixesAvailablePrefixesListDefault) GetPayload() any {
	return o.Payload
}
