...
func (o *IpamVlanGroupsAvailableVlansListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *IpamVlanGroupsAvailableVlansListDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /ipam/vlan-groups/{id}/available-vlans/][%d] ipam_vlan_groups_available_vlans_list default %s", o._statusCode, payload)
}
...
func (o *IpamVlanGroupsAvailableVlansListDefault) GetPayload() any {
	return o.Payload
}
