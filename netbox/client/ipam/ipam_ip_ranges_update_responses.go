...
func (o *IpamIPRangesUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *IpamIPRangesUpdateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /ipam/ip-ranges/{id}/][%d] ipam_ip_ranges_update default %s", o._statusCode, payload)
}
...
func (o *IpamIPRangesUpdateDefault) GetPayload() any {
	return o.Payload
}
