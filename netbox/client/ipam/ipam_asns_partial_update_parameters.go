...
func NewIpamAsnsPartialUpdateParams() *IpamAsnsPartialUpdateParams {
	return NewIpamAsnsPartialUpdateParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [IpamAsnsPartialUpdateParams].
