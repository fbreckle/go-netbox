...
func NewIpamAggregatesUpdateParams() *IpamAggregatesUpdateParams {
	return NewIpamAggregatesUpdateParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [IpamAggregatesUpdateParams].
