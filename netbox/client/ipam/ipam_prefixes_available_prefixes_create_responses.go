...
func (o *IpamPrefixesAvailablePrefixesCreateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *IpamPrefixesAvailablePrefixesCreateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /ipam/prefixes/{id}/available-prefixes/][%d] ipam_prefixes_available_prefixes_create default %s", o._statusCode, payload)
}
...
func (o *IpamPrefixesAvailablePrefixesCreateDefault) GetPayload() any {
	return o.Payload
}
