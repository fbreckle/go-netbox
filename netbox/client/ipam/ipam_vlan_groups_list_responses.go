...
func (o *IpamVlanGroupsListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *IpamVlanGroupsListDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /ipam/vlan-groups/][%d] ipam_vlan_groups_list default %s", o._statusCode, payload)
}
...
func (o *IpamVlanGroupsListDefault) GetPayload() any {
	return o.Payload
}
