...
func NewIpamPrefixesAvailableIpsCreateParams() *IpamPrefixesAvailableIpsCreateParams {
	return NewIpamPrefixesAvailableIpsCreateParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [IpamPrefixesAvailableIpsCreateParams].
...
func (o *IpamPrefixesAvailableIpsCreateParams) WithData(data []*models.AvailableIPRequest) *IpamPrefixesAvailableIpsCreateParams {
	o.SetData(data)
	return o
}

// SetData adds the data to the ipam prefixes available ips create params.
func (o *IpamPrefixesAvailableIpsCreateParams) SetData(data []*models.AvailableIPRequest) {
	o.Data = data
}
