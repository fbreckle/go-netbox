...
func NewIpamRolesPartialUpdateParams() *IpamRolesPartialUpdateParams {
	return NewIpamRolesPartialUpdateParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [IpamRolesPartialUpdateParams].
...
func (o *IpamRolesPartialUpdateParams) WithData(data *models.WritableRole) *IpamRolesPartialUpdateParams {
	o.SetData(data)
	return o
}

// SetData adds the data to the ipam roles partial update params.
func (o *IpamRolesPartialUpdateParams) SetData(data *models.WritableRole) {
	o.Data = data
}
