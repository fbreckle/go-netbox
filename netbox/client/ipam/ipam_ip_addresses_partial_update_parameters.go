...
func NewIpamIPAddressesPartialUpdateParams() *IpamIPAddressesPartialUpdateParams {
	return NewIpamIPAddressesPartialUpdateParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [IpamIPAddressesPartialUpdateParams].
