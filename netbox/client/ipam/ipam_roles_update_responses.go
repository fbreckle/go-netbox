...
func (o *IpamRolesUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *IpamRolesUpdateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /ipam/roles/{id}/][%d] ipam_roles_update default %s", o._statusCode, payload)
}
...
func (o *IpamRolesUpdateDefault) GetPayload() any {
	return o.Payload
}
