...
func (o *IpamVlansCreateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *IpamVlansCreateDefault) GetPayload() any {
	return o.Payload
}
