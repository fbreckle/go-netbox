...
func (o *IpamIPAddressesUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *IpamIPAddressesUpdateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /ipam/ip-addresses/{id}/][%d] ipam_ip_addresses_update default %s", o._statusCode, payload)
}
...
func (o *IpamIPAddressesUpdateDefault) GetPayload() any {
	return o.Payload
}
