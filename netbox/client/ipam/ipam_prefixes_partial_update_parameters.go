...
func NewIpamPrefixesPartialUpdateParams() *IpamPrefixesPartialUpdateParams {
	return NewIpamPrefixesPartialUpdateParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [IpamPrefixesPartialUpdateParams].
