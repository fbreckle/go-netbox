...
func (o *IpamVlanGroupsAvailableVlansCreateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *IpamVlanGroupsAvailableVlansCreateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /ipam/vlan-groups/{id}/available-vlans/][%d] ipam_vlan_groups_available_vlans_create default %s", o._statusCode, payload)
}
...
func (o *IpamVlanGroupsAvailableVlansCreateDefault) GetPayload() any {
	return o.Payload
}
