...
func NewIpamServicesPartialUpdateParams() *IpamServicesPartialUpdateParams {
	return NewIpamServicesPartialUpdateParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [IpamServicesPartialUpdateParams].
