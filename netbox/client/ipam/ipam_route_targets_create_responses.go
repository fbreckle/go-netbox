...
func (o *IpamRouteTargetsCreateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *IpamRouteTargetsCreateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /ipam/route-targets/][%d] ipam_route_targets_create default %s", o._statusCode, payload)
}
...
func (o *IpamRouteTargetsCreateDefault) GetPayload() any {
	return o.Payload
}
