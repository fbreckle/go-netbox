...
func (o *IpamPrefixesAvailableIpsCreateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *IpamPrefixesAvailableIpsCreateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /ipam/prefixes/{id}/available-ips/][%d] ipam_prefixes_available_ips_create default %s", o._statusCode, payload)
}
...
func (o *IpamPrefixesAvailableIpsCreateDefault) GetPayload() any {
	return o.Payload
}
