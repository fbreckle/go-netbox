...
func (o *IpamServiceTemplatesPartialUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *IpamServiceTemplatesPartialUpdateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PATCH /ipam/service-templates/{id}/][%d] ipam_service_templates_partial_update default %s", o._statusCode, payload)
}
...
func (o *IpamServiceTemplatesPartialUpdateDefault) GetPayload() any {
	return o.Payload
}
