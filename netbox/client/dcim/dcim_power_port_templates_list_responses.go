...
func (o *DcimPowerPortTemplatesListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *DcimPowerPortTemplatesListDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /dcim/power-port-templates/][%d] dcim_power_port_templates_list default %s", o._statusCode, payload)
}
...
func (o *DcimPowerPortTemplatesListDefault) GetPayload() any {
	return o.Payload
}
