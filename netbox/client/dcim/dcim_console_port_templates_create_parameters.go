...
func NewDcimConsolePortTemplatesCreateParams() *DcimConsolePortTemplatesCreateParams {
	return NewDcimConsolePortTemplatesCreateParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [DcimConsolePortTemplatesCreateParams].
