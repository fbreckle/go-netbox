...
func (o *DcimDeviceRolesUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *DcimDeviceRolesUpdateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /dcim/device-roles/{id}/][%d] dcim_device_roles_update default %s", o._statusCode, payload)
}
...
func (o *DcimDeviceRolesUpdateDefault) GetPayload() any {
	return o.Payload
}
