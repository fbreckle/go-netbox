...
func (o *DcimRacksUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *DcimRacksUpdateDefault) GetPayload() any {
	return o.Payload
}
