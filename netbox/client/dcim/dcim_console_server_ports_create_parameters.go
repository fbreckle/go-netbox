...
func NewDcimConsoleServerPortsCreateParams() *DcimConsoleServerPortsCreateParams {
	return NewDcimConsoleServerPortsCreateParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [DcimConsoleServerPortsCreateParams].
