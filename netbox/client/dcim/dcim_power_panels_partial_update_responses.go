...
func (o *DcimPowerPanelsPartialUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *DcimPowerPanelsPartialUpdateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PATCH /dcim/power-panels/{id}/][%d] dcim_power_panels_partial_update default %s", o._statusCode, payload)
}
...
func (o *DcimPowerPanelsPartialUpdateDefault) GetPayload() any {
	return o.Payload
}
