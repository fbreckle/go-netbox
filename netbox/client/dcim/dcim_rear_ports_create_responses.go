...
func (o *DcimRearPortsCreateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *DcimRearPortsCreateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /dcim/rear-ports/][%d] dcim_rear_ports_create default %s", o._statusCode, payload)
}
...
func (o *DcimRearPortsCreateDefault) GetPayload() any {
	return o.Payload
}
