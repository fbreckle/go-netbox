...
func NewDcimFrontPortTemplatesCreateParams() *DcimFrontPortTemplatesCreateParams {
	return NewDcimFrontPortTemplatesCreateParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [DcimFrontPortTemplatesCreateParams].
