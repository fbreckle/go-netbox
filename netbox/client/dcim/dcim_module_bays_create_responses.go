...
func (o *DcimModuleBaysCreateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *DcimModuleBaysCreateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /dcim/module-bays/][%d] dcim_module_bays_create default %s", o._statusCode, payload)
}
...
func (o *DcimModuleBaysCreateDefault) GetPayload() any {
	return o.Payload
}
