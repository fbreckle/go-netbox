...
func NewDcimConsolePortsCreateParams() *DcimConsolePortsCreateParams {
	return NewDcimConsolePortsCreateParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [DcimConsolePortsCreateParams].
