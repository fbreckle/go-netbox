...
func (o *DcimPowerPortTemplatesUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *DcimPowerPortTemplatesUpdateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /dcim/power-port-templates/{id}/][%d] dcim_power_port_templates_update default %s", o._statusCode, payload)
}
...
func (o *DcimPowerPortTemplatesUpdateDefault) GetPayload() any {
	return o.Payload
}
