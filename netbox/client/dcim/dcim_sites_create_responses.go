...
func (o *DcimSitesCreateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *DcimSitesCreateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /dcim/sites/][%d] dcim_sites_create default %s", o._statusCode, payload)
}
...
func (o *DcimSitesCreateDefault) GetPayload() any {
	return o.Payload
}
