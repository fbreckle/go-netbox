...
func NewDcimRearPortTemplatesUpdateParams() *DcimRearPortTemplatesUpdateParams {
	return NewDcimRearPortTemplatesUpdateParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [DcimRearPortTemplatesUpdateParams].
