...
func (o *DcimInventoryItemTemplatesUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *DcimInventoryItemTemplatesUpdateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /dcim/inventory-item-templates/{id}/][%d] dcim_inventory_item_templates_update default %s", o._statusCode, payload)
}
...
func (o *DcimInventoryItemTemplatesUpdateDefault) GetPayload() any {
	return o.Payload
}
