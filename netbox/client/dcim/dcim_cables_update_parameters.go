...
func NewDcimCablesUpdateParams() *DcimCablesUpdateParams {
	return NewDcimCablesUpdateParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [DcimCablesUpdateParams].
