...
func (o *DcimVirtualDeviceContextsListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *DcimVirtualDeviceContextsListDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /dcim/virtual-device-contexts/][%d] dcim_virtual_device_contexts_list default %s", o._statusCode, payload)
}
...
func (o *DcimVirtualDeviceContextsListDefault) GetPayload() any {
	return o.Payload
}
