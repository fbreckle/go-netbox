...
func (o *DcimInventoryItemsUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *DcimInventoryItemsUpdateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /dcim/inventory-items/{id}/][%d] dcim_inventory_items_update default %s", o._statusCode, payload)
}
...
func (o *DcimInventoryItemsUpdateDefault) GetPayload() any {
	return o.Payload
}
