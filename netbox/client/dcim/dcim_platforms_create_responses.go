...
func (o *DcimPlatformsCreateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *DcimPlatformsCreateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /dcim/platforms/][%d] dcim_platforms_create default %s", o._statusCode, payload)
}
...
func (o *DcimPlatformsCreateDefault) GetPayload() any {
	return o.Payload
}
