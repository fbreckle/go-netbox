...
func (o *DcimPowerOutletsCreateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *DcimPowerOutletsCreateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /dcim/power-outlets/][%d] dcim_power_outlets_create default %s", o._statusCode, payload)
}
...
func (o *DcimPowerOutletsCreateDefault) GetPayload() any {
	return o.Payload
}
