...
func (o *DcimDeviceBaysListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
// Code gets the status code for the dcim device bays list o k response
func (o *DcimDeviceBaysListOK) Code() int {
	return 200
}

func (o *DcimDeviceBaysListOK) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /dcim/device-bays/][%d] dcimDeviceBaysListOK %s", 200, payload)
}
...
func (o *DcimDeviceBaysListDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /dcim/device-bays/][%d] dcim_device_bays_list default %s", o._statusCode, payload)
}
...
func (o *DcimDeviceBaysListDefault) GetPayload() any {
	return o.Payload
}
