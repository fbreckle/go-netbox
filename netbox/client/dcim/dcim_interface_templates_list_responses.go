...
func (o *DcimInterfaceTemplatesListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *DcimInterfaceTemplatesListDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /dcim/interface-templates/][%d] dcim_interface_templates_list default %s", o._statusCode, payload)
}
...
func (o *DcimInterfaceTemplatesListDefault) GetPayload() any {
	return o.Payload
}
