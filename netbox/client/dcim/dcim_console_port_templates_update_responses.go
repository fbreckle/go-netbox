...
func (o *DcimConsolePortTemplatesUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
// Code gets the status code for the dcim console port templates update o k response
func (o *DcimConsolePortTemplatesUpdateOK) Code() int {
	return 200
}

func (o *DcimConsolePortTemplatesUpdateOK) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /dcim/console-port-templates/{id}/][%d] dcimConsolePortTemplatesUpdateOK %s", 200, payload)
}
...
func (o *DcimConsolePortTemplatesUpdateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /dcim/console-port-templates/{id}/][%d] dcim_console_port_templates_update default %s", o._statusCode, payload)
}
...
func (o *DcimConsolePortTemplatesUpdateDefault) GetPayload() any {
	return o.Payload
}
