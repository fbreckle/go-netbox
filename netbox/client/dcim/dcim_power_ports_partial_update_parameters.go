...
func NewDcimPowerPortsPartialUpdateParams() *DcimPowerPortsPartialUpdateParams {
	return NewDcimPowerPortsPartialUpdateParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [DcimPowerPortsPartialUpdateParams].
