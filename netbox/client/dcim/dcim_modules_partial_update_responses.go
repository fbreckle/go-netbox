...
func (o *DcimModulesPartialUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *DcimModulesPartialUpdateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PATCH /dcim/modules/{id}/][%d] dcim_modules_partial_update default %s", o._statusCode, payload)
}
...
func (o *DcimModulesPartialUpdateDefault) GetPayload() any {
	return o.Payload
}
