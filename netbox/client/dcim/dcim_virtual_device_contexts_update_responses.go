...
func (o *DcimVirtualDeviceContextsUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *DcimVirtualDeviceContextsUpdateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /dcim/virtual-device-contexts/{id}/][%d] dcim_virtual_device_contexts_update default %s", o._statusCode, payload)
}
...
func (o *DcimVirtualDeviceContextsUpdateDefault) GetPayload() any {
	return o.Payload
}
