...
func NewDcimDeviceTypesCreateParams() *DcimDeviceTypesCreateParams {
	return NewDcimDeviceTypesCreateParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [DcimDeviceTypesCreateParams].
