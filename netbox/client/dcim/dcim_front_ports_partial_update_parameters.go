...
func NewDcimFrontPortsPartialUpdateParams() *DcimFrontPortsPartialUpdateParams {
	return NewDcimFrontPortsPartialUpdateParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [DcimFrontPortsPartialUpdateParams].
