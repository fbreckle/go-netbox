...
func NewDcimPowerPortsUpdateParams() *DcimPowerPortsUpdateParams {
	return NewDcimPowerPortsUpdateParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [DcimPowerPortsUpdateParams].
