...
func (o *DcimDeviceRolesCreateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *DcimDeviceRolesCreateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /dcim/device-roles/][%d] dcim_device_roles_create default %s", o._statusCode, payload)
}
...
func (o *DcimDeviceRolesCreateDefault) GetPayload() any {
	return o.Payload
}
