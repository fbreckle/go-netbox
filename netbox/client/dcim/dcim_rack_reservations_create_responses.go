...
func (o *DcimRackReservationsCreateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *DcimRackReservationsCreateCreated) Error() string {
	...
	return fmt.Sprintf("[POST /dcim/rack-reservations/][%d] dcimRackReservationsCreateCreated %s", 201, payload)
}
...
func (o *DcimRackReservationsCreateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /dcim/rack-reservations/][%d] dcim_rack_reservations_create default %s", o._statusCode, payload)
}
...
func (o *DcimRackReservationsCreateDefault) GetPayload() any {
	return o.Payload
}
