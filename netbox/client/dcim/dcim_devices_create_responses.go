...
func (o *DcimDevicesCreateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *DcimDevicesCreateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /dcim/devices/][%d] dcim_devices_create default %s", o._statusCode, payload)
}
...
func (o *DcimDevicesCreateDefault) GetPayload() any {
	return o.Payload
}
