...
func NewDcimInventoryItemRolesPartialUpdateParams() *DcimInventoryItemRolesPartialUpdateParams {
	return NewDcimInventoryItemRolesPartialUpdateParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [DcimInventoryItemRolesPartialUpdateParams].
...
func (o *DcimInventoryItemRolesPartialUpdateParams) WithData(data *models.WritableInventoryItemRole) *DcimInventoryItemRolesPartialUpdateParams {
	o.SetData(data)
	return o
}

// SetData adds the data to the dcim inventory item roles partial update params.
func (o *DcimInventoryItemRolesPartialUpdateParams) SetData(data *models.WritableInventoryItemRole) {
	o.Data = data
}
