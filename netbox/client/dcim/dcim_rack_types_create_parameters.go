...
func NewDcimRackTypesCreateParams() *DcimRackTypesCreateParams {
	return NewDcimRackTypesCreateParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [DcimRackTypesCreateParams].
...
func (o *DcimRackTypesCreateParams) WithData(data *models.WritableRackType) *DcimRackTypesCreateParams {
	o.SetData(data)
	return o
}

// SetData adds the data to the dcim rack types create params.
func (o *DcimRackTypesCreateParams) SetData(data *models.WritableRackType) {
	o.Data = data
}
