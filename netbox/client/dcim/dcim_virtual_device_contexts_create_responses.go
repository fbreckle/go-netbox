...
func (o *DcimVirtualDeviceContextsCreateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *DcimVirtualDeviceContextsCreateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /dcim/virtual-device-contexts/][%d] dcim_virtual_device_contexts_create default %s", o._statusCode, payload)
}
...
func (o *DcimVirtualDeviceContextsCreateDefault) GetPayload() any {
	return o.Payload
}
