...
func (o *DcimCableTerminationsListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *DcimCableTerminationsListDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /dcim/cable-terminations/][%d] dcim_cable_terminations_list default %s", o._statusCode, payload)
}
...
func (o *DcimCableTerminationsListDefault) GetPayload() any {
	return o.Payload
}
