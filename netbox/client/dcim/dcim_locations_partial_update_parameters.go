...
func NewDcimLocationsPartialUpdateParams() *DcimLocationsPartialUpdateParams {
	return NewDcimLocationsPartialUpdateParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [DcimLocationsPartialUpdateParams].
