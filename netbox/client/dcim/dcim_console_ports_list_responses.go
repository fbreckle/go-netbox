...
func (o *DcimConsolePortsListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *DcimConsolePortsListOK) Error() string {
	...
	return fmt.Sprintf("[GET /dcim/console-ports/][%d] dcimConsolePortsListOK %s", 200, payload)
}
...
func (o *DcimConsolePortsListDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /dcim/console-ports/][%d] dcim_console_ports_list default %s", o._statusCode, payload)
}
...
func (o *DcimConsolePortsListDefault) GetPayload() any {
	return o.Payload
}
