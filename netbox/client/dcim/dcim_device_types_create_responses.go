...
func (o *DcimDeviceTypesCreateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *DcimDeviceTypesCreateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /dcim/device-types/][%d] dcim_device_types_create default %s", o._statusCode, payload)
}
...
func (o *DcimDeviceTypesCreateDefault) GetPayload() any {
	return o.Payload
}
