...
func NewDcimInventoryItemRolesCreateParams() *DcimInventoryItemRolesCreateParams {
	return NewDcimInventoryItemRolesCreateParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [DcimInventoryItemRolesCreateParams].
...
func (o *DcimInventoryItemRolesCreateParams) WithData(data *models.WritableInventoryItemRole) *DcimInventoryItemRolesCreateParams {
	o.SetData(data)
	return o
}

// SetData adds the data to the dcim inventory item roles create params.
func (o *DcimInventoryItemRolesCreateParams) SetData(data *models.WritableInventoryItemRole) {
	o.Data = data
}
