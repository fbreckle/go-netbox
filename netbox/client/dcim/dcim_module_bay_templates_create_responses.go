...
func (o *DcimModuleBayTemplatesCreateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *DcimModuleBayTemplatesCreateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /dcim/module-bay-templates/][%d] dcim_module_bay_templates_create default %s", o._statusCode, payload)
}
...
func (o *DcimModuleBayTemplatesCreateDefault) GetPayload() any {
	return o.Payload
}
