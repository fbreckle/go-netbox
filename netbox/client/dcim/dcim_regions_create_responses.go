...
func (o *DcimRegionsCreateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *DcimRegionsCreateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /dcim/regions/][%d] dcim_regions_create default %s", o._statusCode, payload)
}
...
func (o *DcimRegionsCreateDefault) GetPayload() any {
	return o.Payload
}
