...
func (o *DcimLocationsPartialUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *DcimLocationsPartialUpdateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PATCH /dcim/locations/{id}/][%d] dcim_locations_partial_update default %s", o._statusCode, payload)
}
...
func (o *DcimLocationsPartialUpdateDefault) GetPayload() any {
	return o.Payload
}
