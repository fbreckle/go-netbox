...
func (o *DcimInterfaceTemplatesUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *DcimInterfaceTemplatesUpdateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /dcim/interface-templates/{id}/][%d] dcim_interface_templates_update default %s", o._statusCode, payload)
}
...
func (o *DcimInterfaceTemplatesUpdateDefault) GetPayload() any {
	return o.Payload
}
