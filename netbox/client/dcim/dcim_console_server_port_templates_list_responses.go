...
func (o *DcimConsoleServerPortTemplatesListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *DcimConsoleServerPortTemplatesListOK) Error() string {
	...
	return fmt.Sprintf("[GET /dcim/console-server-port-templates/][%d] dcimConsoleServerPortTemplatesListOK %s", 200, payload)
}
...
func (o *DcimConsoleServerPortTemplatesListDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /dcim/console-server-port-templates/][%d] dcim_console_server_port_templates_list default %s", o._statusCode, payload)
}
...
func (o *DcimConsoleServerPortTemplatesListDefault) GetPayload() any {
	return o.Payload
}
