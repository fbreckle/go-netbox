...
func (o *DcimConsolePortsUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *DcimConsolePortsUpdateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /dcim/console-ports/{id}/][%d] dcim_console_ports_update default %s", o._statusCode, payload)
}
...
func (o *DcimConsolePortsUpdateDefault) GetPayload() any {
	return o.Payload
}
