...
func (o *DcimInventoryItemTemplatesPartialUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *DcimInventoryItemTemplatesPartialUpdateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PATCH /dcim/inventory-item-templates/{id}/][%d] dcim_inventory_item_templates_partial_update default %s", o._statusCode, payload)
}
...
func (o *DcimInventoryItemTemplatesPartialUpdateDefault) GetPayload() any {
	return o.Payload
}
