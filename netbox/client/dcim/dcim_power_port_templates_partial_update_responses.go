...
func (o *DcimPowerPortTemplatesPartialUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *DcimPowerPortTemplatesPartialUpdateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PATCH /dcim/power-port-templates/{id}/][%d] dcim_power_port_templates_partial_update default %s", o._statusCode, payload)
}
...
func (o *DcimPowerPortTemplatesPartialUpdateDefault) GetPayload() any {
	return o.Payload
}
