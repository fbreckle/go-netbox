...
func (o *DcimPowerPanelsUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *DcimPowerPanelsUpdateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /dcim/power-panels/{id}/][%d] dcim_power_panels_update default %s", o._statusCode, payload)
}
...
func (o *DcimPowerPanelsUpdateDefault) GetPayload() any {
	return o.Payload
}
