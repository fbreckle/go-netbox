...
func (o *DcimPowerOutletsUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *DcimPowerOutletsUpdateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /dcim/power-outlets/{id}/][%d] dcim_power_outlets_update default %s", o._statusCode, payload)
}
...
func (o *DcimPowerOutletsUpdateDefault) GetPayload() any {
	return o.Payload
}
