...
func (o *DcimConsoleServerPortTemplatesUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *DcimConsoleServerPortTemplatesUpdateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /dcim/console-server-port-templates/{id}/][%d] dcim_console_server_port_templates_update default %s", o._statusCode, payload)
}
...
func (o *DcimConsoleServerPortTemplatesUpdateDefault) GetPayload() any {
	return o.Payload
}
