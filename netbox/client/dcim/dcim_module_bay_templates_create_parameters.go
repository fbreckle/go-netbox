...
func NewDcimModuleBayTemplatesCreateParams() *DcimModuleBayTemplatesCreateParams {
	return NewDcimModuleBayTemplatesCreateParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [DcimModuleBayTemplatesCreateParams].
