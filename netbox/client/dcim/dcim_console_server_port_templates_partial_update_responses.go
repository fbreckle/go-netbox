...
func (o *DcimConsoleServerPortTemplatesPartialUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *DcimConsoleServerPortTemplatesPartialUpdateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PATCH /dcim/console-server-port-templates/{id}/][%d] dcim_console_server_port_templates_partial_update default %s", o._statusCode, payload)
}
...
func (o *DcimConsoleServerPortTemplatesPartialUpdateDefault) GetPayload() any {
	return o.Payload
}
