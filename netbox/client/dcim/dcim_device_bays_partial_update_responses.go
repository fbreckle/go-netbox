...
func (o *DcimDeviceBaysPartialUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *DcimDeviceBaysPartialUpdateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PATCH /dcim/device-bays/{id}/][%d] dcim_device_bays_partial_update default %s", o._statusCode, payload)
}
...
func (o *DcimDeviceBaysPartialUpdateDefault) GetPayload() any {
	return o.Payload
}
