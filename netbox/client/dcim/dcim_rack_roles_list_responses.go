...
func (o *DcimRackRolesListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *DcimRackRolesListDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /dcim/rack-roles/][%d] dcim_rack_roles_list default %s", o._statusCode, payload)
}
...
func (o *DcimRackRolesListDefault) GetPayload() any {
	return o.Payload
}
