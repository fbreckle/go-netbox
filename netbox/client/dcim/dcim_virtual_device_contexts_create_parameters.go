...
func NewDcimVirtualDeviceContextsCreateParams() *DcimVirtualDeviceContextsCreateParams {
	return NewDcimVirtualDeviceContextsCreateParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [DcimVirtualDeviceContextsCreateParams].
