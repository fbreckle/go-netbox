...
func (o *DcimFrontPortTemplatesListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *DcimFrontPortTemplatesListDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /dcim/front-port-templates/][%d] dcim_front_port_templates_list default %s", o._statusCode, payload)
}
...
func (o *DcimFrontPortTemplatesListDefault) GetPayload() any {
	return o.Payload
}
