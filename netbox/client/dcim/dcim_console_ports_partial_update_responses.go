...
func (o *DcimConsolePortsPartialUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *DcimConsolePortsPartialUpdateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PATCH /dcim/console-ports/{id}/][%d] dcim_console_ports_partial_update default %s", o._statusCode, payload)
}
...
func (o *DcimConsolePortsPartialUpdateDefault) GetPayload() any {
	return o.Payload
}
