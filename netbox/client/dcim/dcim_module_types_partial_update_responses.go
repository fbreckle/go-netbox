...
func (o *DcimModuleTypesPartialUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *DcimModuleTypesPartialUpdateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PATCH /dcim/module-types/{id}/][%d] dcim_module_types_partial_update default %s", o._statusCode, payload)
}
...
func (o *DcimModuleTypesPartialUpdateDefault) GetPayload() any {
	return o.Payload
}
