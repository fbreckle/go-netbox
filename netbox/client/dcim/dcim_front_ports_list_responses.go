...
func (o *DcimFrontPortsListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
// Code gets the status code for the dcim front ports list o k response
func (o *DcimFrontPortsListOK) Code() int {
	return 200
}

func (o *DcimFrontPortsListOK) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /dcim/front-ports/][%d] dcimFrontPortsListOK %s", 200, payload)
}
...
func (o *DcimFrontPortsListDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /dcim/front-ports/][%d] dcim_front_ports_list default %s", o._statusCode, payload)
}
...
func (o *DcimFrontPortsListDefault) GetPayload() any {
	return o.Payload
}
