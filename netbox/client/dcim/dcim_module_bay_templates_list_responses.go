...
func (o *DcimModuleBayTemplatesListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *DcimModuleBayTemplatesListDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /dcim/module-bay-templates/][%d] dcim_module_bay_templates_list default %s", o._statusCode, payload)
}
...
func (o *DcimModuleBayTemplatesListDefault) GetPayload() any {
	return o.Payload
}
