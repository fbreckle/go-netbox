...
func (o *DcimLocationsCreateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *DcimLocationsCreateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /dcim/locations/][%d] dcim_locations_create default %s", o._statusCode, payload)
}
...
func (o *DcimLocationsCreateDefault) GetPayload() any {
	return o.Payload
}
