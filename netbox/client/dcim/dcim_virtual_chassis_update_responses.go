...
func (o *DcimVirtualChassisUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *DcimVirtualChassisUpdateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /dcim/virtual-chassis/{id}/][%d] dcim_virtual_chassis_update default %s", o._statusCode, payload)
}
...
func (o *DcimVirtualChassisUpdateDefault) GetPayload() any {
	return o.Payload
}
