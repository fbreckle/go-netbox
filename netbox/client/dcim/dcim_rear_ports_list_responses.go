...
func (o *DcimRearPortsListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
// Code gets the status code for the dcim rear ports list o k response
func (o *DcimRearPortsListOK) Code() int {
	return 200
}

func (o *DcimRearPortsListOK) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /dcim/rear-ports/][%d] dcimRearPortsListOK %s", 200, payload)
}
...
func (o *DcimRearPortsListDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /dcim/rear-ports/][%d] dcim_rear_ports_list default %s", o._statusCode, payload)
}
...
func (o *DcimRearPortsListDefault) GetPayload() any {
	return o.Payload
}
