...
func (o *DcimDeviceBayTemplatesListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *DcimDeviceBayTemplatesListDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /dcim/device-bay-templates/][%d] dcim_device_bay_templates_list default %s", o._statusCode, payload)
}
...
func (o *DcimDeviceBayTemplatesListDefault) GetPayload() any {
	return o.Payload
}
