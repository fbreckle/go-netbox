...
func NewDcimFrontPortTemplatesUpdateParams() *DcimFrontPortTemplatesUpdateParams {
	return NewDcimFrontPortTemplatesUpdateParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [DcimFrontPortTemplatesUpdateParams].
