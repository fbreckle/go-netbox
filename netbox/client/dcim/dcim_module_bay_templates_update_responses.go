...
func (o *DcimModuleBayTemplatesUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *DcimModuleBayTemplatesUpdateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /dcim/module-bay-templates/{id}/][%d] dcim_module_bay_templates_update default %s", o._statusCode, payload)
}
...
func (o *DcimModuleBayTemplatesUpdateDefault) GetPayload() any {
	return o.Payload
}
