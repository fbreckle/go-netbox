...
func (o *DcimPowerOutletTemplatesUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *DcimPowerOutletTemplatesUpdateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /dcim/power-outlet-templates/{id}/][%d] dcim_power_outlet_templates_update default %s", o._statusCode, payload)
}
...
func (o *DcimPowerOutletTemplatesUpdateDefault) GetPayload() any {
	return o.Payload
}
