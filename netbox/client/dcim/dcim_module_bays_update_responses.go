...
func (o *DcimModuleBaysUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
// Code gets the status code for the dcim module bays update o k response
func (o *DcimModuleBaysUpdateOK) Code() int {
	return 200
}
...
func (o *DcimModuleBaysUpdateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /dcim/module-bays/{id}/][%d] dcim_module_bays_update default %s", o._statusCode, payload)
}
...
func (o *DcimModuleBaysUpdateDefault) GetPayload() any {
	return o.Payload
}
