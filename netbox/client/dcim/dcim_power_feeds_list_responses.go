...
func (o *DcimPowerFeedsListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
// Code gets the status code for the dcim power feeds list o k response
func (o *DcimPowerFeedsListOK) Code() int {
	return 200
}

func (o *DcimPowerFeedsListOK) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /dcim/power-feeds/][%d] dcimPowerFeedsListOK %s", 200, payload)
}
...
func (o *DcimPowerFeedsListDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /dcim/power-feeds/][%d] dcim_power_feeds_list default %s", o._statusCode, payload)
}
...
func (o *DcimPowerFeedsListDefault) GetPayload() any {
	return o.Payload
}
