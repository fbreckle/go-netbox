...
func (o *DcimPowerPanelsListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *DcimPowerPanelsListDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /dcim/power-panels/][%d] dcim_power_panels_list default %s", o._statusCode, payload)
}
...
func (o *DcimPowerPanelsListDefault) GetPayload() any {
	return o.Payload
}
