...
func (o *DcimPowerPortsListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *DcimPowerPortsListOK) Error() string {
	...
	return fmt.Sprintf("[GET /dcim/power-ports/][%d] dcimPowerPortsListOK %s", 200, payload)
}
...
func (o *DcimPowerPortsListDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /dcim/power-ports/][%d] dcim_power_ports_list default %s", o._statusCode, payload)
}
...
func (o *DcimPowerPortsListDefault) GetPayload() any {
	return o.Payload
}
