...
func (o *DcimInventoryItemRolesUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *DcimInventoryItemRolesUpdateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /dcim/inventory-item-roles/{id}/][%d] dcim_inventory_item_roles_update default %s", o._statusCode, payload)
}
...
func (o *DcimInventoryItemRolesUpdateDefault) GetPayload() any {
	return o.Payload
}
