...
func (o *DcimVirtualChassisListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *DcimVirtualChassisListDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /dcim/virtual-chassis/][%d] dcim_virtual_chassis_list default %s", o._statusCode, payload)
}
...
func (o *DcimVirtualChassisListDefault) GetPayload() any {
	return o.Payload
}
