...
func (o *DcimModuleTypesCreateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *DcimModuleTypesCreateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /dcim/module-types/][%d] dcim_module_types_create default %s", o._statusCode, payload)
}
...
func (o *DcimModuleTypesCreateDefault) GetPayload() any {
	return o.Payload
}
