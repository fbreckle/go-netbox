...
func (o *DcimFrontPortTemplatesPartialUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *DcimFrontPortTemplatesPartialUpdateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PATCH /dcim/front-port-templates/{id}/][%d] dcim_front_port_templates_partial_update default %s", o._statusCode, payload)
}
...
func (o *DcimFrontPortTemplatesPartialUpdateDefault) GetPayload() any {
	return o.Payload
}
