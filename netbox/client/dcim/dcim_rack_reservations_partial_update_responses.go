...
func (o *DcimRackReservationsPartialUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *DcimRackReservationsPartialUpdateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PATCH /dcim/rack-reservations/{id}/][%d] dcim_rack_reservations_partial_update default %s", o._statusCode, payload)
}
...
func (o *DcimRackReservationsPartialUpdateDefault) GetPayload() any {
	return o.Payload
}
