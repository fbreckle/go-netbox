...
func (o *DcimDevicesUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *DcimDevicesUpdateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /dcim/devices/{id}/][%d] dcim_devices_update default %s", o._statusCode, payload)
}
...
func (o *DcimDevicesUpdateDefault) GetPayload() any {
	return o.Payload
}
