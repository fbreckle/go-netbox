...
func (o *DcimPowerOutletTemplatesPartialUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *DcimPowerOutletTemplatesPartialUpdateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PATCH /dcim/power-outlet-templates/{id}/][%d] dcim_power_outlet_templates_partial_update default %s", o._statusCode, payload)
}
...
func (o *DcimPowerOutletTemplatesPartialUpdateDefault) GetPayload() any {
	return o.Payload
}
