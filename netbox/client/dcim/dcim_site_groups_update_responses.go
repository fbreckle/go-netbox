...
func (o *DcimSiteGroupsUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
// Code gets the status code for the dcim site groups update o k response
func (o *DcimSiteGroupsUpdateOK) Code() int {
	return 200
}

func (o *DcimSiteGroupsUpdateOK) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /dcim/site-groups/{id}/][%d] dcimSiteGroupsUpdateOK %s", 200, payload)
}
...
func (o *DcimSiteGroupsUpdateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /dcim/site-groups/{id}/][%d] dcim_site_groups_update default %s", o._statusCode, payload)
}
...
func (o *DcimSiteGroupsUpdateDefault) GetPayload() any {
	return o.Payload
}
