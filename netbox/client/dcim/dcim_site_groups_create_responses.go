...
func (o *DcimSiteGroupsCreateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *DcimSiteGroupsCreateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /dcim/site-groups/][%d] dcim_site_groups_create default %s", o._statusCode, payload)
}
...
func (o *DcimSiteGroupsCreateDefault) GetPayload() any {
	return o.Payload
}
