...
func (o *DcimConsolePortTemplatesPartialUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
// Code gets the status code for the dcim console port templates partial update o k response
func (o *DcimConsolePortTemplatesPartialUpdateOK) Code() int {
	return 200
}
...
func (o *DcimConsolePortTemplatesPartialUpdateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PATCH /dcim/console-port-templates/{id}/][%d] dcim_console_port_templates_partial_update default %s", o._statusCode, payload)
}
...
func (o *DcimConsolePortTemplatesPartialUpdateDefault) GetPayload() any {
	return o.Payload
}
