...
func (o *DcimPowerOutletsPartialUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *DcimPowerOutletsPartialUpdateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PATCH /dcim/power-outlets/{id}/][%d] dcim_power_outlets_partial_update default %s", o._statusCode, payload)
}
...
func (o *DcimPowerOutletsPartialUpdateDefault) GetPayload() any {
	return o.Payload
}
