...
func (o *DcimRearPortTemplatesListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
// Code gets the status code for the dcim rear port templates list o k response
func (o *DcimRearPortTemplatesListOK) Code() int {
	return 200
}

func (o *DcimRearPortTemplatesListOK) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /dcim/rear-port-templates/][%d] dcimRearPortTemplatesListOK %s", 200, payload)
}
...
func (o *DcimRearPortTemplatesListDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /dcim/rear-port-templates/][%d] dcim_rear_port_templates_list default %s", o._statusCode, payload)
}
...
func (o *DcimRearPortTemplatesListDefault) GetPayload() any {
	return o.Payload
}
