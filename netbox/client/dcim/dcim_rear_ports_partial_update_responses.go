...
func (o *DcimRearPortsPartialUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *DcimRearPortsPartialUpdateOK) Error() string {
	...
	return fmt.Sprintf("[PATCH /dcim/rear-ports/{id}/][%d] dcimRearPortsPartialUpdateOK %s", 200, payload)
}
...
func (o *DcimRearPortsPartialUpdateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PATCH /dcim/rear-ports/{id}/][%d] dcim_rear_ports_partial_update default %s", o._statusCode, payload)
}
...
func (o *DcimRearPortsPartialUpdateDefault) GetPayload() any {
	return o.Payload
}
