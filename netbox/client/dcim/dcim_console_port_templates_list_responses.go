...
func (o *DcimConsolePortTemplatesListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *DcimConsolePortTemplatesListOK) Error() string {
	...
	return fmt.Sprintf("[GET /dcim/console-port-templates/][%d] dcimConsolePortTemplatesListOK %s", 200, payload)
}
...
func (o *DcimConsolePortTemplatesListDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /dcim/console-port-templates/][%d] dcim_console_port_templates_list default %s", o._statusCode, payload)
}
...
func (o *DcimConsolePortTemplatesListDefault) GetPayload() any {
	return o.Payload
}
