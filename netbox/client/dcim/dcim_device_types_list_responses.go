...
func (o *DcimDeviceTypesListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *DcimDeviceTypesListDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /dcim/device-types/][%d] dcim_device_types_list default %s", o._statusCode, payload)
}
...
func (o *DcimDeviceTypesListDefault) GetPayload() any {
	return o.Payload
}
