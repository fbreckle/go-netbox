...
func (o *DcimRearPortTemplatesCreateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *DcimRearPortTemplatesCreateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /dcim/rear-port-templates/][%d] dcim_rear_port_templates_create default %s", o._statusCode, payload)
}
...
func (o *DcimRearPortTemplatesCreateDefault) GetPayload() any {
	return o.Payload
}
