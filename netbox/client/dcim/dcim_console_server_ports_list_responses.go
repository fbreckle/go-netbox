...
func (o *DcimConsoleServerPortsListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *DcimConsoleServerPortsListOK) Error() string {
	...
	return fmt.Sprintf("[GET /dcim/console-server-ports/][%d] dcimConsoleServerPortsListOK %s", 200, payload)
}
...
func (o *DcimConsoleServerPortsListDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /dcim/console-server-ports/][%d] dcim_console_server_ports_list default %s", o._statusCode, payload)
}
...
func (o *DcimConsoleServerPortsListDefault) GetPayload() any {
	return o.Payload
}
