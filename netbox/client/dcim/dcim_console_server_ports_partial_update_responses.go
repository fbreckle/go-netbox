...
func (o *DcimConsoleServerPortsPartialUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *DcimConsoleServerPortsPartialUpdateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PATCH /dcim/console-server-ports/{id}/][%d] dcim_console_server_ports_partial_update default %s", o._statusCode, payload)
}
...
func (o *DcimConsoleServerPortsPartialUpdateDefault) GetPayload() any {
	return o.Payload
}
