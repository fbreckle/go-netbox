...
func (o *DcimDeviceRolesListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *DcimDeviceRolesListDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /dcim/device-roles/][%d] dcim_device_roles_list default %s", o._statusCode, payload)
}
...
func (o *DcimDeviceRolesListDefault) GetPayload() any {
	return o.Payload
}
