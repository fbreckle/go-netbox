...
func (o *DcimRackRolesUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *DcimRackRolesUpdateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /dcim/rack-roles/{id}/][%d] dcim_rack_roles_update default %s", o._statusCode, payload)
}
...
func (o *DcimRackRolesUpdateDefault) GetPayload() any {
	return o.Payload
}
