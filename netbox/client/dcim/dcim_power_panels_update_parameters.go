...
func NewDcimPowerPanelsUpdateParams() *DcimPowerPanelsUpdateParams {
	return NewDcimPowerPanelsUpdateParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [DcimPowerPanelsUpdateParams].
