...
func NewDcimDeviceTypesUpdateParams() *DcimDeviceTypesUpdateParams {
	return NewDcimDeviceTypesUpdateParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [DcimDeviceTypesUpdateParams].
