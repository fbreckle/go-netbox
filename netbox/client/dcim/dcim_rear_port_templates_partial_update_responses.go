...
func (o *DcimRearPortTemplatesPartialUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *DcimRearPortTemplatesPartialUpdateOK) Error() string {
	...
	return fmt.Sprintf("[PATCH /dcim/rear-port-templates/{id}/][%d] dcimRearPortTemplatesPartialUpdateOK %s", 200, payload)
}
...
func (o *DcimRearPortTemplatesPartialUpdateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PATCH /dcim/rear-port-templates/{id}/][%d] dcim_rear_port_templates_partial_update default %s", o._statusCode, payload)
}
...
func (o *DcimRearPortTemplatesPartialUpdateDefault) GetPayload() any {
	return o.Payload
}
