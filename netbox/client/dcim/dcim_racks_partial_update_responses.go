...
func (o *DcimRacksPartialUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *DcimRacksPartialUpdateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PATCH /dcim/racks/{id}/][%d] dcim_racks_partial_update default %s", o._statusCode, payload)
}
...
func (o *DcimRacksPartialUpdateDefault) GetPayload() any {
	return o.Payload
}
