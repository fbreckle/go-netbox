...
func (o *DcimPowerFeedsUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *DcimPowerFeedsUpdateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /dcim/power-feeds/{id}/][%d] dcim_power_feeds_update default %s", o._statusCode, payload)
}
...
func (o *DcimPowerFeedsUpdateDefault) GetPayload() any {
	return o.Payload
}
