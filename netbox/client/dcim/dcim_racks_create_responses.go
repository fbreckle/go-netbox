...
func (o *DcimRacksCreateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *DcimRacksCreateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /dcim/racks/][%d] dcim_racks_create default %s", o._statusCode, payload)
}
...
func (o *DcimRacksCreateDefault) GetPayload() any {
	return o.Payload
}
