...
func (o *DcimPowerFeedsCreateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *DcimPowerFeedsCreateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /dcim/power-feeds/][%d] dcim_power_feeds_create default %s", o._statusCode, payload)
}
...
func (o *DcimPowerFeedsCreateDefault) GetPayload() any {
	return o.Payload
}
