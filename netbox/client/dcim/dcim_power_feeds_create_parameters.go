...
func NewDcimPowerFeedsCreateParams() *DcimPowerFeedsCreateParams {
	return NewDcimPowerFeedsCreateParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [DcimPowerFeedsCreateParams].
