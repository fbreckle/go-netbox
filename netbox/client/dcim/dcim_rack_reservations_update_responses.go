...
func (o *DcimRackReservationsUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *DcimRackReservationsUpdateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /dcim/rack-reservations/{id}/][%d] dcim_rack_reservations_update default %s", o._statusCode, payload)
}
...
func (o *DcimRackReservationsUpdateDefault) GetPayload() any {
	return o.Payload
}
