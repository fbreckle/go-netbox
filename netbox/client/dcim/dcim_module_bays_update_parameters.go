...
func NewDcimModuleBaysUpdateParams() *DcimModuleBaysUpdateParams {
	return NewDcimModuleBaysUpdateParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [DcimModuleBaysUpdateParams].
