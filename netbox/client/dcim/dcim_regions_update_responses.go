...
func (o *DcimRegionsUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *DcimRegionsUpdateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /dcim/regions/{id}/][%d] dcim_regions_update default %s", o._statusCode, payload)
}
...
func (o *DcimRegionsUpdateDefault) GetPayload() any {
	return o.Payload
}
