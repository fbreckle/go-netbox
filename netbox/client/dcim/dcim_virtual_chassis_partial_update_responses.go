...
func (o *DcimVirtualChassisPartialUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *DcimVirtualChassisPartialUpdateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PATCH /dcim/virtual-chassis/{id}/][%d] dcim_virtual_chassis_partial_update default %s", o._statusCode, payload)
}
...
func (o *DcimVirtualChassisPartialUpdateDefault) GetPayload() any {
	return o.Payload
}
