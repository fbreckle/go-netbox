...
func NewDcimConsolePortTemplatesPartialUpdateParams() *DcimConsolePortTemplatesPartialUpdateParams {
	return NewDcimConsolePortTemplatesPartialUpdateParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [DcimConsolePortTemplatesPartialUpdateParams].
