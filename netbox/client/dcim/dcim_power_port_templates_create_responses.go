...
func (o *DcimPowerPortTemplatesCreateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *DcimPowerPortTemplatesCreateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /dcim/power-port-templates/][%d] dcim_power_port_templates_create default %s", o._statusCode, payload)
}
...
func (o *DcimPowerPortTemplatesCreateDefault) GetPayload() any {
	return o.Payload
}
