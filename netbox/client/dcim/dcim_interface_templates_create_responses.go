...
func (o *DcimInterfaceTemplatesCreateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *DcimInterfaceTemplatesCreateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /dcim/interface-templates/][%d] dcim_interface_templates_create default %s", o._statusCode, payload)
}
...
func (o *DcimInterfaceTemplatesCreateDefault) GetPayload() any {
	return o.Payload
}
