...
func NewDcimRackRolesPartialUpdateParams() *DcimRackRolesPartialUpdateParams {
	return NewDcimRackRolesPartialUpdateParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [DcimRackRolesPartialUpdateParams].
...
func (o *DcimRackRolesPartialUpdateParams) WithData(data *models.WritableRackRole) *DcimRackRolesPartialUpdateParams {
	o.SetData(data)
	return o
}

// SetData adds the data to the dcim rack roles partial update params.
func (o *DcimRackRolesPartialUpdateParams) SetData(data *models.WritableRackRole) {
	o.Data = data
}
