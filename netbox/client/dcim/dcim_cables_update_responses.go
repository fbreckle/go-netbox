...
func (o *DcimCablesUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *DcimCablesUpdateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /dcim/cables/{id}/][%d] dcim_cables_update default %s", o._statusCode, payload)
}
...
func (o *DcimCablesUpdateDefault) GetPayload() any {
	return o.Payload
}
