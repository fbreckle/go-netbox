...
func (o *DcimVirtualChassisCreateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *DcimVirtualChassisCreateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /dcim/virtual-chassis/][%d] dcim_virtual_chassis_create default %s", o._statusCode, payload)
}
...
func (o *DcimVirtualChassisCreateDefault) GetPayload() any {
	return o.Payload
}
