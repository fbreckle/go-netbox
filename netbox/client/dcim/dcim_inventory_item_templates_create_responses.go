...
func (o *DcimInventoryItemTemplatesCreateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *DcimInventoryItemTemplatesCreateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /dcim/inventory-item-templates/][%d] dcim_inventory_item_templates_create default %s", o._statusCode, payload)
}
...
func (o *DcimInventoryItemTemplatesCreateDefault) GetPayload() any {
	return o.Payload
}
