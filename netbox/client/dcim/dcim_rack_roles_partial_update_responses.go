...
func (o *DcimRackRolesPartialUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *DcimRackRolesPartialUpdateOK) Error() string {
	...
	return fmt.Sprintf("[PATCH /dcim/rack-roles/{id}/][%d] dcimRackRolesPartialUpdateOK %s", 200, payload)
}
...
func (o *DcimRackRolesPartialUpdateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PATCH /dcim/rack-roles/{id}/][%d] dcim_rack_roles_partial_update default %s", o._statusCode, payload)
}
...
func (o *DcimRackRolesPartialUpdateDefault) GetPayload() any {
	return o.Payload
}
