...
func NewDcimPowerFeedsPartialUpdateParams() *DcimPowerFeedsPartialUpdateParams {
	return NewDcimPowerFeedsPartialUpdateParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [DcimPowerFeedsPartialUpdateParams].
