...
func (o *DcimCablesCreateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *DcimCablesCreateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /dcim/cables/][%d] dcim_cables_create default %s", o._statusCode, payload)
}
...
func (o *DcimCablesCreateDefault) GetPayload() any {
	return o.Payload
}
