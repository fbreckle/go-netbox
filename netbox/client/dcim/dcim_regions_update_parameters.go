...
func NewDcimRegionsUpdateParams() *DcimRegionsUpdateParams {
	return NewDcimRegionsUpdateParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [DcimRegionsUpdateParams].
