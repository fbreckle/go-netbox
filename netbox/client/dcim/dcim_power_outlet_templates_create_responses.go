...
func (o *DcimPowerOutletTemplatesCreateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *DcimPowerOutletTemplatesCreateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /dcim/power-outlet-templates/][%d] dcim_power_outlet_templates_create default %s", o._statusCode, payload)
}
...
func (o *DcimPowerOutletTemplatesCreateDefault) GetPayload() any {
	return o.Payload
}
