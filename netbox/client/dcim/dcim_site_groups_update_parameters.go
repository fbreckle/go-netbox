...
func NewDcimSiteGroupsUpdateParams() *DcimSiteGroupsUpdateParams {
	return NewDcimSiteGroupsUpdateParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [DcimSiteGroupsUpdateParams].
