...
func (o *DcimPowerOutletsListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *DcimPowerOutletsListDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /dcim/power-outlets/][%d] dcim_power_outlets_list default %s", o._statusCode, payload)
}
...
func (o *DcimPowerOutletsListDefault) GetPayload() any {
	return o.Payload
}
