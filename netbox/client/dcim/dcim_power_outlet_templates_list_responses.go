...
func (o *DcimPowerOutletTemplatesListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
// Code gets the status code for the dcim power outlet templates list o k response
func (o *DcimPowerOutletTemplatesListOK) Code() int {
	return 200
}

func (o *DcimPowerOutletTemplatesListOK) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /dcim/power-outlet-templates/][%d] dcimPowerOutletTemplatesListOK %s", 200, payload)
}
...
func (o *DcimPowerOutletTemplatesListDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /dcim/power-outlet-templates/][%d] dcim_power_outlet_templates_list default %s", o._statusCode, payload)
}
...
func (o *DcimPowerOutletTemplatesListDefault) GetPayload() any {
	return o.Payload
}
