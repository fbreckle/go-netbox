...
func (o *DcimSiteGroupsPartialUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *DcimSiteGroupsPartialUpdateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PATCH /dcim/site-groups/{id}/][%d] dcim_site_groups_partial_update default %s", o._statusCode, payload)
}
...
func (o *DcimSiteGroupsPartialUpdateDefault) GetPayload() any {
	return o.Payload
}
