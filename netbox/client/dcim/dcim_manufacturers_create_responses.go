...
func (o *DcimManufacturersCreateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *DcimManufacturersCreateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /dcim/manufacturers/][%d] dcim_manufacturers_create default %s", o._statusCode, payload)
}
...
func (o *DcimManufacturersCreateDefault) GetPayload() any {
	return o.Payload
}
