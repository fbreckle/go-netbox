...
func (o *DcimModulesCreateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *DcimModulesCreateDefault) GetPayload() any {
	return o.Payload
}
