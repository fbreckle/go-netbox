...
func (o *DcimLocationsListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
// Code gets the status code for the dcim locations list o k response
func (o *DcimLocationsListOK) Code() int {
	return 200
}

func (o *DcimLocationsListOK) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /dcim/locations/][%d] dcimLocationsListOK %s", 200, payload)
}
...
func (o *DcimLocationsListDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /dcim/locations/][%d] dcim_locations_list default %s", o._statusCode, payload)
}
...
func (o *DcimLocationsListDefault) GetPayload() any {
	return o.Payload
}
