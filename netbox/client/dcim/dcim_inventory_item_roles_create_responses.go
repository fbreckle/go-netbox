...
func (o *DcimInventoryItemRolesCreateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *DcimInventoryItemRolesCreateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /dcim/inventory-item-roles/][%d] dcim_inventory_item_roles_create default %s", o._statusCode, payload)
}
...
func (o *DcimInventoryItemRolesCreateDefault) GetPayload() any {
	return o.Payload
}
