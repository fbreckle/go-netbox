...
func (o *DcimModuleBayTemplatesPartialUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *DcimModuleBayTemplatesPartialUpdateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PATCH /dcim/module-bay-templates/{id}/][%d] dcim_module_bay_templates_partial_update default %s", o._statusCode, payload)
}
...
func (o *DcimModuleBayTemplatesPartialUpdateDefault) GetPayload() any {
	return o.Payload
}
