...
func NewDcimInterfaceTemplatesCreateParams() *DcimInterfaceTemplatesCreateParams {
	return NewDcimInterfaceTemplatesCreateParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [DcimInterfaceTemplatesCreateParams].
