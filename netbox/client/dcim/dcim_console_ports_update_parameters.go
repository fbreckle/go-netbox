...
func NewDcimConsolePortsUpdateParams() *DcimConsolePortsUpdateParams {
	return NewDcimConsolePortsUpdateParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [DcimConsolePortsUpdateParams].
