...
func NewDcimDeviceBaysCreateParams() *DcimDeviceBaysCreateParams {
	return NewDcimDeviceBaysCreateParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [DcimDeviceBaysCreateParams].
