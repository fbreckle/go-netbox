...
func (o *DcimConsolePortsCreateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *DcimConsolePortsCreateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /dcim/console-ports/][%d] dcim_console_ports_create default %s", o._statusCode, payload)
}
...
func (o *DcimConsolePortsCreateDefault) GetPayload() any {
	return o.Payload
}
