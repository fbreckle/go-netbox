...
func (o *DcimFrontPortsPartialUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *DcimFrontPortsPartialUpdateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PATCH /dcim/front-ports/{id}/][%d] dcim_front_ports_partial_update default %s", o._statusCode, payload)
}
...
func (o *DcimFrontPortsPartialUpdateDefault) GetPayload() any {
	return o.Payload
}
