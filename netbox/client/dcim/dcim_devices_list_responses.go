...
func (o *DcimDevicesListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
// Code gets the status code for the dcim devices list o k response
func (o *DcimDevicesListOK) Code() int {
	return 200
}

func (o *DcimDevicesListOK) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /dcim/devices/][%d] dcimDevicesListOK %s", 200, payload)
}
...
func (o *DcimDevicesListDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /dcim/devices/][%d] dcim_devices_list default %s", o._statusCode, payload)
}
...
func (o *DcimDevicesListDefault) GetPayload() any {
	return o.Payload
}
