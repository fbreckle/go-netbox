...
func (o *DcimRackReservationsListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *DcimRackReservationsListDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /dcim/rack-reservations/][%d] dcim_rack_reservations_list default %s", o._statusCode, payload)
}
...
func (o *DcimRackReservationsListDefault) GetPayload() any {
	return o.Payload
}
