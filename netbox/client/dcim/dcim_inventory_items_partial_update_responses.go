...
func (o *DcimInventoryItemsPartialUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *DcimInventoryItemsPartialUpdateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PATCH /dcim/inventory-items/{id}/][%d] dcim_inventory_items_partial_update default %s", o._statusCode, payload)
}
...
func (o *DcimInventoryItemsPartialUpdateDefault) GetPayload() any {
	return o.Payload
}
