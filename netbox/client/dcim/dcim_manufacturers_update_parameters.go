...
func NewDcimManufacturersUpdateParams() *DcimManufacturersUpdateParams {
	return NewDcimManufacturersUpdateParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [DcimManufacturersUpdateParams].
...
func (o *DcimManufacturersUpdateParams) WithData(data *models.WritableManufacturer) *DcimManufacturersUpdateParams {
	o.SetData(data)
	return o
}

// SetData adds the data to the dcim manufacturers update params.
func (o *DcimManufacturersUpdateParams) SetData(data *models.WritableManufacturer) {
	o.Data = data
}
