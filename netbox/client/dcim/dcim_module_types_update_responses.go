...
func (o *DcimModuleTypesUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *DcimModuleTypesUpdateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /dcim/module-types/{id}/][%d] dcim_module_types_update default %s", o._statusCode, payload)
}
...
func (o *DcimModuleTypesUpdateDefault) GetPayload() any {
	return o.Payload
}
