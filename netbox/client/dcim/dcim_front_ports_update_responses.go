...
func (o *DcimFrontPortsUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *DcimFrontPortsUpdateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /dcim/front-ports/{id}/][%d] dcim_front_ports_update default %s", o._statusCode, payload)
}
...
func (o *DcimFrontPortsUpdateDefault) GetPayload() any {
	return o.Payload
}
