...
func (o *DcimModuleTypesListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
// Code gets the status code for the dcim module types list o k response
func (o *DcimModuleTypesListOK) Code() int {
	return 200
}

func (o *DcimModuleTypesListOK) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /dcim/module-types/][%d] dcimModuleTypesListOK %s", 200, payload)
}
...
func (o *DcimModuleTypesListDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /dcim/module-types/][%d] dcim_module_types_list default %s", o._statusCode, payload)
}
...
func (o *DcimModuleTypesListDefault) GetPayload() any {
	return o.Payload
}
