...
func (o *DcimRearPortTemplatesUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *DcimRearPortTemplatesUpdateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /dcim/rear-port-templates/{id}/][%d] dcim_rear_port_templates_update default %s", o._statusCode, payload)
}
...
func (o *DcimRearPortTemplatesUpdateDefault) GetPayload() any {
	return o.Payload
}
