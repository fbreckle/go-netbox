...
func NewDcimRackGroupsUpdateParams() *DcimRackGroupsUpdateParams {
	return NewDcimRackGroupsUpdateParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [DcimRackGroupsUpdateParams].
...
func (o *DcimRackGroupsUpdateParams) WithDefaults() *DcimRackGroupsUpdateParams {
	o.SetDefaults()
	return o
}
