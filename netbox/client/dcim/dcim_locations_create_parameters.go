...
func NewDcimLocationsCreateParams() *DcimLocationsCreateParams {
	return NewDcimLocationsCreateParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [DcimLocationsCreateParams].
