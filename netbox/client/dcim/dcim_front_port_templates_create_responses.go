...
func (o *DcimFrontPortTemplatesCreateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *DcimFrontPortTemplatesCreateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /dcim/front-port-templates/][%d] dcim_front_port_templates_create default %s", o._statusCode, payload)
}
...
func (o *DcimFrontPortTemplatesCreateDefault) GetPayload() any {
	return o.Payload
}
