...
func (o *DcimInterfacesListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *DcimInterfacesListDefault) GetPayload() any {
	return o.Payload
}
