...
func NewDcimInventoryItemTemplatesUpdateParams() *DcimInventoryItemTemplatesUpdateParams {
	return NewDcimInventoryItemTemplatesUpdateParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [DcimInventoryItemTemplatesUpdateParams].
