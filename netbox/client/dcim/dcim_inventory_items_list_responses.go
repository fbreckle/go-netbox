...
func (o *DcimInventoryItemsListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *DcimInventoryItemsListDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /dcim/inventory-items/][%d] dcim_inventory_items_list default %s", o._statusCode, payload)
}
...
func (o *DcimInventoryItemsListDefault) GetPayload() any {
	return o.Payload
}
