...
func (o *DcimRackRolesCreateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *DcimRackRolesCreateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /dcim/rack-roles/][%d] dcim_rack_roles_create default %s", o._statusCode, payload)
}
...
func (o *DcimRackRolesCreateDefault) GetPayload() any {
	return o.Payload
}
