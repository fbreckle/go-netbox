...
func NewDcimSitesPartialUpdateParams() *DcimSitesPartialUpdateParams {
	return NewDcimSitesPartialUpdateParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [DcimSitesPartialUpdateParams].
