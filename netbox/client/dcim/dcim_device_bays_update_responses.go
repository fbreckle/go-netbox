...
func (o *DcimDeviceBaysUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *DcimDeviceBaysUpdateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /dcim/device-bays/{id}/][%d] dcim_device_bays_update default %s", o._statusCode, payload)
}
...
func (o *DcimDeviceBaysUpdateDefault) GetPayload() any {
	return o.Payload
}
