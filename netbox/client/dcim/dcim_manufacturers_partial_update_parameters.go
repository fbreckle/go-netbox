...
func NewDcimManufacturersPartialUpdateParams() *DcimManufacturersPartialUpdateParams {
	return NewDcimManufacturersPartialUpdateParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [DcimManufacturersPartialUpdateParams].
...
func (o *DcimManufacturersPartialUpdateParams) WithData(data *models.WritableManufacturer) *DcimManufacturersPartialUpdateParams {
	o.SetData(data)
	return o
}

// SetData adds the data to the dcim manufacturers partial update params.
func (o *DcimManufacturersPartialUpdateParams) SetData(data *models.WritableManufacturer) {
	o.Data = data
}
