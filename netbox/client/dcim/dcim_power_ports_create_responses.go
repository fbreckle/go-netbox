...
func (o *DcimPowerPortsCreateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *DcimPowerPortsCreateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /dcim/power-ports/][%d] dcim_power_ports_create default %s", o._statusCode, payload)
}
...
func (o *DcimPowerPortsCreateDefault) GetPayload() any {
	return o.Payload
}
