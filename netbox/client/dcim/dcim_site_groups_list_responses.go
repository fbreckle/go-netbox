...
func (o *DcimSiteGroupsListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *DcimSiteGroupsListDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /dcim/site-groups/][%d] dcim_site_groups_list default %s", o._statusCode, payload)
}
...
func (o *DcimSiteGroupsListDefault) GetPayload() any {
	return o.Payload
}
