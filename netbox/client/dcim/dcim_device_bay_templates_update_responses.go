...
func (o *DcimDeviceBayTemplatesUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *DcimDeviceBayTemplatesUpdateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /dcim/device-bay-templates/{id}/][%d] dcim_device_bay_templates_update default %s", o._statusCode, payload)
}
...
func (o *DcimDeviceBayTemplatesUpdateDefault) GetPayload() any {
	return o.Payload
}
