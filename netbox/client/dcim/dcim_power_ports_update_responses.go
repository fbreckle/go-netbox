...
func (o *DcimPowerPortsUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *DcimPowerPortsUpdateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /dcim/power-ports/{id}/][%d] dcim_power_ports_update default %s", o._statusCode, payload)
}
...
func (o *DcimPowerPortsUpdateDefault) GetPayload() any {
	return o.Payload
}
