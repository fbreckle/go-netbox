...
func (o *DcimMacAddressesUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *DcimMacAddressesUpdateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /dcim/mac-addresses/{id}/][%d] dcim_mac_addresses_update default %s", o._statusCode, payload)
}
...
func (o *DcimMacAddressesUpdateDefault) GetPayload() any {
	return o.Payload
}
