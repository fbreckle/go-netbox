...
func (o *DcimDeviceBayTemplatesCreateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *DcimDeviceBayTemplatesCreateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /dcim/device-bay-templates/][%d] dcim_device_bay_templates_create default %s", o._statusCode, payload)
}
...
func (o *DcimDeviceBayTemplatesCreateDefault) GetPayload() any {
	return o.Payload
}
