...
func (o *DcimFrontPortsCreateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *DcimFrontPortsCreateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /dcim/front-ports/][%d] dcim_front_ports_create default %s", o._statusCode, payload)
}
...
func (o *DcimFrontPortsCreateDefault) GetPayload() any {
	return o.Payload
}
