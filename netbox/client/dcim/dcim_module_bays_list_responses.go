...
func (o *DcimModuleBaysListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
// Code gets the status code for the dcim module bays list o k response
func (o *DcimModuleBaysListOK) Code() int {
	return 200
}

func (o *DcimModuleBaysListOK) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /dcim/module-bays/][%d] dcimModuleBaysListOK %s", 200, payload)
}
...
func (o *DcimModuleBaysListDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /dcim/module-bays/][%d] dcim_module_bays_list default %s", o._statusCode, payload)
}
...
func (o *DcimModuleBaysListDefault) GetPayload() any {
	return o.Payload
}
