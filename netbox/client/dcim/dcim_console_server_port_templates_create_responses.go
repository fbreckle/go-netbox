...
func (o *DcimConsoleServerPortTemplatesCreateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *DcimConsoleServerPortTemplatesCreateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /dcim/console-server-port-templates/][%d] dcim_console_server_port_templates_create default %s", o._statusCode, payload)
}
...
func (o *DcimConsoleServerPortTemplatesCreateDefault) GetPayload() any {
	return o.Payload
}
