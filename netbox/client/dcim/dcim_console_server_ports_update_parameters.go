...
func NewDcimConsoleServerPortsUpdateParams() *DcimConsoleServerPortsUpdateParams {
	return NewDcimConsoleServerPortsUpdateParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [DcimConsoleServerPortsUpdateParams].
