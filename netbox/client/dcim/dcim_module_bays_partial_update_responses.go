...
func (o *DcimModuleBaysPartialUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *DcimModuleBaysPartialUpdateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PATCH /dcim/module-bays/{id}/][%d] dcim_module_bays_partial_update default %s", o._statusCode, payload)
}
...
func (o *DcimModuleBaysPartialUpdateDefault) GetPayload() any {
	return o.Payload
}
