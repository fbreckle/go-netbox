...
func (o *DcimPowerPortsPartialUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *DcimPowerPortsPartialUpdateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PATCH /dcim/power-ports/{id}/][%d] dcim_power_ports_partial_update default %s", o._statusCode, payload)
}
...
func (o *DcimPowerPortsPartialUpdateDefault) GetPayload() any {
	return o.Payload
}
