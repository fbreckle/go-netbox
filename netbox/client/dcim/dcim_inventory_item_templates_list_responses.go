...
func (o *DcimInventoryItemTemplatesListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *DcimInventoryItemTemplatesListDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /dcim/inventory-item-templates/][%d] dcim_inventory_item_templates_list default %s", o._statusCode, payload)
}
...
func (o *DcimInventoryItemTemplatesListDefault) GetPayload() any {
	return o.Payload
}
