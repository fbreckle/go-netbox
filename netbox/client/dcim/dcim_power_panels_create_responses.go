...
func (o *DcimPowerPanelsCreateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *DcimPowerPanelsCreateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /dcim/power-panels/][%d] dcim_power_panels_create default %s", o._statusCode, payload)
}
...
func (o *DcimPowerPanelsCreateDefault) GetPayload() any {
	return o.Payload
}
