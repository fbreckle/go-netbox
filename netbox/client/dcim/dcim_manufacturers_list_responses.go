...
func (o *DcimManufacturersListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *DcimManufacturersListDefault) GetPayload() any {
	return o.Payload
}
