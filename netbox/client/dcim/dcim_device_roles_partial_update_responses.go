...
func (o *DcimDeviceRolesPartialUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *DcimDeviceRolesPartialUpdateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PATCH /dcim/device-roles/{id}/][%d] dcim_device_roles_partial_update default %s", o._statusCode, payload)
}
...
func (o *DcimDeviceRolesPartialUpdateDefault) GetPayload() any {
	return o.Payload
}
