...
func (o *DcimRearPortsUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *DcimRearPortsUpdateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /dcim/rear-ports/{id}/][%d] dcim_rear_ports_update default %s", o._statusCode, payload)
}
...
func (o *DcimRearPortsUpdateDefault) GetPayload() any {
	return o.Payload
}
