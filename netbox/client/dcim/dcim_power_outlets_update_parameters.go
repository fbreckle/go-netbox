...
func NewDcimPowerOutletsUpdateParams() *DcimPowerOutletsUpdateParams {
	return NewDcimPowerOutletsUpdateParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [DcimPowerOutletsUpdateParams].
