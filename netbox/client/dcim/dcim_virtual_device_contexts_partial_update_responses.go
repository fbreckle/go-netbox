...
func (o *DcimVirtualDeviceContextsPartialUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *DcimVirtualDeviceContextsPartialUpdateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PATCH /dcim/virtual-device-contexts/{id}/][%d] dcim_virtual_device_contexts_partial_update default %s", o._statusCode, payload)
}
...
func (o *DcimVirtualDeviceContextsPartialUpdateDefault) GetPayload() any {
	return o.Payload
}
