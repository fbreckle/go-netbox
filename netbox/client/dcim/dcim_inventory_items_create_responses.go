...
func (o *DcimInventoryItemsCreateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *DcimInventoryItemsCreateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /dcim/inventory-items/][%d] dcim_inventory_items_create default %s", o._statusCode, payload)
}
...
func (o *DcimInventoryItemsCreateDefault) GetPayload() any {
	return o.Payload
}
