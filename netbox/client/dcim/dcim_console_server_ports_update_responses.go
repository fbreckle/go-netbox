...
func (o *DcimConsoleServerPortsUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *DcimConsoleServerPortsUpdateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /dcim/console-server-ports/{id}/][%d] dcim_console_server_ports_update default %s", o._statusCode, payload)
}
...
func (o *DcimConsoleServerPortsUpdateDefault) GetPayload() any {
	return o.Payload
}
