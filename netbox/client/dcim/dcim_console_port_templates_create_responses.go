...
func (o *DcimConsolePortTemplatesCreateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *DcimConsolePortTemplatesCreateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /dcim/console-port-templates/][%d] dcim_console_port_templates_create default %s", o._statusCode, payload)
}
...
func (o *DcimConsolePortTemplatesCreateDefault) GetPayload() any {
	return o.Payload
}
