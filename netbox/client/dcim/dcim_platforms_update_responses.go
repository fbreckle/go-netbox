...
func (o *DcimPlatformsUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *DcimPlatformsUpdateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /dcim/platforms/{id}/][%d] dcim_platforms_update default %s", o._statusCode, payload)
}
...
func (o *DcimPlatformsUpdateDefault) GetPayload() any {
	return o.Payload
}
