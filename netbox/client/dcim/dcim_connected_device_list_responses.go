...
func (o *DcimConnectedDeviceListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *DcimConnectedDeviceListDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /dcim/connected-device/][%d] dcim_connected_device_list default %s", o._statusCode, payload)
}
...
func (o *DcimConnectedDeviceListDefault) GetPayload() any {
	return o.Payload
}
