...
func (o *DcimFrontPortTemplatesUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *DcimFrontPortTemplatesUpdateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /dcim/front-port-templates/{id}/][%d] dcim_front_port_templates_update default %s", o._statusCode, payload)
}
...
func (o *DcimFrontPortTemplatesUpdateDefault) GetPayload() any {
	return o.Payload
}
