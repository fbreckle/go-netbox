...
func (o *DcimDeviceTypesPartialUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *DcimDeviceTypesPartialUpdateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PATCH /dcim/device-types/{id}/][%d] dcim_device_types_partial_update default %s", o._statusCode, payload)
}
...
func (o *DcimDeviceTypesPartialUpdateDefault) GetPayload() any {
	return o.Payload
}
