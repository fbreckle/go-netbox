...
func (o *DcimConsoleServerPortsCreateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *DcimConsoleServerPortsCreateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /dcim/console-server-ports/][%d] dcim_console_server_ports_create default %s", o._statusCode, payload)
}
...
func (o *DcimConsoleServerPortsCreateDefault) GetPayload() any {
	return o.Payload
}
