...
func NewDcimDeviceBayTemplatesCreateParams() *DcimDeviceBayTemplatesCreateParams {
	return NewDcimDeviceBayTemplatesCreateParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [DcimDeviceBayTemplatesCreateParams].
