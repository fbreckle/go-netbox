...
func (o *UsersGroupsPartialUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *UsersGroupsPartialUpdateDefault) GetPayload() any {
	return o.Payload
}
