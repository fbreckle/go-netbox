...
func NewUsersTokensPartialUpdateParams() *UsersTokensPartialUpdateParams {
	return NewUsersTokensPartialUpdateParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [UsersTokensPartialUpdateParams].
