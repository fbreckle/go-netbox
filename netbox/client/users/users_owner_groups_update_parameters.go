...
func NewUsersOwnerGroupsUpdateParams() *UsersOwnerGroupsUpdateParams {
	return NewUsersOwnerGroupsUpdateParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [UsersOwnerGroupsUpdateParams].
...
func (o *UsersOwnerGroupsUpdateParams) WithData(data *models.WritableOwnerGroup) *UsersOwnerGroupsUpdateParams {
	o.SetData(data)
	return o
}

// SetData adds the data to the users owner groups update params.
func (o *UsersOwnerGroupsUpdateParams) SetData(data *models.WritableOwnerGroup) {
	o.Data = data
}
