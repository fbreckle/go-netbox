...
func (o *UsersOwnersListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *UsersOwnersListDefault) GetPayload() any {
	return o.Payload
}
