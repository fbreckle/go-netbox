...
func (o *UsersTokensPartialUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *UsersTokensPartialUpdateDefault) GetPayload() any {
	return o.Payload
}
