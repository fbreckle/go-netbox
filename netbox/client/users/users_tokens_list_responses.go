...
func (o *UsersTokensListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *UsersTokensListDefault) GetPayload() any {
	return o.Payload
}
