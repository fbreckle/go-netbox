...
func NewUsersTokensUpdateParams() *UsersTokensUpdateParams {
	return NewUsersTokensUpdateParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [UsersTokensUpdateParams].
