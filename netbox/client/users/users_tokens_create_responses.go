...
func (o *UsersTokensCreateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *UsersTokensCreateDefault) GetPayload() any {
	return o.Payload
}
