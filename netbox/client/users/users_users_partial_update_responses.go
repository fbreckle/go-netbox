...
func (o *UsersUsersPartialUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *UsersUsersPartialUpdateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PATCH /users/users/{id}/][%d] users_users_partial_update default %s", o._statusCode, payload)
}
...
func (o *UsersUsersPartialUpdateDefault) GetPayload() any {
	return o.Payload
}
