...
func NewUsersPermissionsCreateParams() *UsersPermissionsCreateParams {
	return NewUsersPermissionsCreateParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [UsersPermissionsCreateParams].
