...
func (o *UsersPermissionsPartialUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *UsersPermissionsPartialUpdateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PATCH /users/permissions/{id}/][%d] users_permissions_partial_update default %s", o._statusCode, payload)
}
...
func (o *UsersPermissionsPartialUpdateDefault) GetPayload() any {
	return o.Payload
}
