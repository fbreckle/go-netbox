...
func (o *UsersTokensProvisionCreateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *UsersTokensProvisionCreateCreated) Error() string {
	...
	return fmt.Sprintf("[POST /users/tokens/provision/][%d] usersTokensProvisionCreateCreated %s", 201, payload)
}
...
func (o *UsersTokensProvisionCreateCreated) GetPayload() *models.TokenProvision {
	return o.Payload
}
...
func (o *UsersTokensProvisionCreateCreated) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models.TokenProvision)
...
func (o *UsersTokensProvisionCreateDefault) GetPayload() any {
	return o.Payload
}
