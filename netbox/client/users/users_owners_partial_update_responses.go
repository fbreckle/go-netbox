...
func (o *UsersOwnersPartialUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *UsersOwnersPartialUpdateDefault) GetPayload() any {
	return o.Payload
}
