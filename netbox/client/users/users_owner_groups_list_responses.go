...
func (o *UsersOwnerGroupsListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *UsersOwnerGroupsListDefault) GetPayload() any {
	return o.Payload
}
...
// Validate validates this users owner groups list o k body
...
// ContextValidate validate this users owner groups list o k body based on the context it is used
