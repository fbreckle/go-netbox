...
func NewUsersGroupsUpdateParams() *UsersGroupsUpdateParams {
	return NewUsersGroupsUpdateParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [UsersGroupsUpdateParams].
...
func (o *UsersGroupsUpdateParams) WithData(data *models.WritableGroup) *UsersGroupsUpdateParams {
	o.SetData(data)
	return o
}

// SetData adds the data to the users groups update params.
func (o *UsersGroupsUpdateParams) SetData(data *models.WritableGroup) {
	o.Data = data
}
