...
func (o *UsersPermissionsUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *UsersPermissionsUpdateDefault) GetPayload() any {
	return o.Payload
}
