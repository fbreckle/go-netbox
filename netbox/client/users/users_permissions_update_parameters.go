...
func NewUsersPermissionsUpdateParams() *UsersPermissionsUpdateParams {
	return NewUsersPermissionsUpdateParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [UsersPermissionsUpdateParams].
