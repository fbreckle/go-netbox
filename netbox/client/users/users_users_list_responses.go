...
func (o *UsersUsersListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *UsersUsersListDefault) GetPayload() any {
	return o.Payload
}
