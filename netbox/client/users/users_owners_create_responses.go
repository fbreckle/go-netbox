...
func (o *UsersOwnersCreateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *UsersOwnersCreateDefault) GetPayload() any {
	return o.Payload
}
