...
func (o *UsersOwnerGroupsPartialUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *UsersOwnerGroupsPartialUpdateDefault) GetPayload() any {
	return o.Payload
}
